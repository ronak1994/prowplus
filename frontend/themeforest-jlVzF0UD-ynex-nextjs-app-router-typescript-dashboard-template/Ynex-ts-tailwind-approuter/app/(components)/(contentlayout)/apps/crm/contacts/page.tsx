                    ...
                    <div className="box custom-box">
                        <div className="box-header flex items-center justify-between flex-wrap gap-4">
                            ...
                            <div className="flexflex-wrap gap-2">
                                <Link href="#!" scroll={false} className="hs-dropdown-toggle ti-btn ti-btn-primary-full !py-1 !px-2 !text-[0.75rem] me-2" data-hs-overlay="#todo-compose"><i className="ri-add-line font-semibold align-middle"></i>Create Contact
                                </Link>
                                <button type="button" className="ti-btn ti-btn-success !py-1 !px-2 !text-[0.75rem] me-2">Export As CSV</button>
                                <div className="hs-dropdown ti-dropdown">
                                    <Link href="#!" scroll={false} className="ti-btn ti-btn-light !py-1 !px-2 !text-[0.75rem] !m-0 btn-wave waves-effect waves-light" aria-expanded="false">
                                            ...
                                            <tr className="border border-defaultborder crm-contact" key={Math.random()}>
                                                ...
                                                <td>
                                                    <div className="flex items-center gap-2">
                                                        ...
                                                        <div>
                                                            <Link href="#offcanvasExample" aria-controls="offcanvasExample" data-hs-overlay="#hs-overlay-contacts"><span className="block font-semibold">{idx.name}</span></Link>
                                    ...
                                    <div className="form-group">
                                        <div className="input-group !flex-nowrap">
                                            ...
                                            //  placeholder={"Choose date"} 
                                             className="ti-form-input ltr:rounded-l-none rtl:rounded-r-none focus:z-10" showIcon selected={startDate} onChange={(date) => setStartDate(date as Date)} />
                                        </div>
                                    </div>
                                </div>
                                <div className="xl:col-span-6 col-span-12">
