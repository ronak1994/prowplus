            ...
            <div className="grid grid-cols-12 gap-6">
                <div className="xl:col-span-12 col-span-12">
                    <div className="box custom-box">
                                            ...
                                            <tr className="border border-defaultborder crm-contact min-w-full" key={Math.random()}>
                                                ...
                                                <td>
                                                    <div className="btn-list">
                                                        <Link aria-label="anchor" href="#!" scroll={false} className="ti-btn ti-btn-sm ti-btn-warning me-2"><i className="ri-eye-line"></i></Link>
                        ...
                        <div className="box-footer !border-t opacity-0">
