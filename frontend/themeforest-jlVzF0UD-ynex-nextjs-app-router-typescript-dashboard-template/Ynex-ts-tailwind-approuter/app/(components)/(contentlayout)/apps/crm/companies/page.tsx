                    ...
                    <div className="box custom-box">
                        <div className="box-header justify-between">
                            ...
                            <div className="flex flex-wrap gap-2 mt-2 md:mt-0">
                                <Link href="#!" scroll={false} className="hs-dropdown-toggle ti-btn ti-btn-primary-full !py-1 !px-2 !text-[0.75rem]" data-hs-overlay="#todo-compose"><i className="ri-add-line font-semibold align-middle"></i>Add Company
                                </Link>
                                            ...
                                            <tr className="border border-defaultborder crm-contact" key={Math.random()}>
                                                ...
                                                <td>
                                                    <div className="flex items-center gap-2">
                                                        ...
                                                        <div>
                                                            <Link href="#offcanvasExample" aria-controls="offcanvasExample" data-hs-overlay="#hs-overlay-contacts">{idx.text1}</Link>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
