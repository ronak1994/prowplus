                        ...
                        <div className="box-body deals-content">
                            <div className="flex items-center flex-wrap gap-2 justify-between">
                                ...
                                <div className="flex flex-wrap gap-2">
                                    <Link href="#!" scroll={false} className="hs-dropdown-toggle ti-btn ti-btn-primary-full !py-1 !px-2 !text-[0.75rem]" data-hs-overlay="#todo-compose"><i className="ri-add-line font-semibold align-middle"></i>New Deal
                                    </Link>
                                    <button type="button" className="ti-btn ti-btn-success !py-1 !px-2 !text-[0.75rem] btn-wave">Export As CSV</button>
                                    <div className="hs-dropdown ti-dropdown">
                                        <Link href="#!" scroll={false} className="ti-btn ti-btn-light !py-1 !px-2 !text-[0.75rem] btn-wave" aria-expanded="false">
                                            Sort By<i className="ri-arrow-down-s-line align-middle ms-1 inline-block"></i>
                                        </Link>
                                        <ul className="hs-dropdown-menu ti-dropdown-menu hidden" role="menu">
                                            <li><Link className="ti-dropdown-item" href="#!" scroll={false}>Newest</Link></li>
                                            <li><Link className="ti-dropdown-item" href="#!" scroll={false}>Date Added</Link></li>
                ...
                <div className="xxl:col-span-2 col-span-12" ref={firstContainerRef} id="leads-discovered">
                    <div className="box custom-box">
                        <div className="box-body deals-content">
                            ...
                            <div className="deal-description">
                                <div className="my-1">
                                    <Link href="#!" scroll={false} className="company-name">Spruko Technologies</Link>
                                </div>
                    ...
                    <div className="box custom-box">
                        <div className="box-body deals-content">
                            ...
                            <div className="deal-description">
                                <div className="my-1">
                                    <Link href="#!" scroll={false} className="company-name">Acme Corporation LTD</Link>
                                </div>
                ...
                <div className="xxl:col-span-2 col-span-12" ref={secondContainerRef} id="leads-qualified">
                    <div className="box custom-box">
                        <div className="box-body deals-content">
                            ...
                            <div className="deal-description">
                                <div className="my-1">
                                    <Link href="#!" scroll={false} className="company-name">Initech Info</Link>
                                </div>
                    ...
                    <div className="box custom-box">
                        <div className="box-body deals-content">
                            ...
                            <div className="deal-description">
                                <div className="my-1">
                                    <Link href="#!" scroll={false} className="company-name">Soylent Corp</Link>
                                </div>
                    ...
                    <div className="box custom-box">
                        <div className="box-body deals-content">
                            ...
                            <div className="deal-description">
                                <div className="my-1">
                                    <Link href="#!" scroll={false} className="company-name">Hooli Technologies</Link>
                                </div>
                ...
                <div className="xxl:col-span-2 col-span-12" ref={thirdContainerRef} id="contact-initiated">
                    <div className="box custom-box">
                        <div className="box-body deals-content">
                            ...
                            <div className="deal-description">
                                <div className="my-1">
                                    <Link href="#!" scroll={false} className="company-name">Spice Infotech</Link>
                                </div>
                ...
                <div className="xxl:col-span-2 col-span-12" ref={fourthContainerRef} id="needs-identified">
                    <div className="box custom-box">
                        <div className="box-body deals-content">
                            ...
                            <div className="deal-description">
                                <div className="my-1">
                                    <Link href="#!" scroll={false} className="company-name">Massive Dynamic</Link>
                                </div>
                    ...
                    <div className="box custom-box">
                        <div className="box-body deals-content">
                            ...
                            <div className="deal-description">
                                <div className="my-1">
                                    <Link href="#!" scroll={false} className="company-name">Logitech ecostics</Link>
                                </div>
                    ...
                    <div className="box custom-box">
                        <div className="box-body deals-content">
                            ...
                            <div className="deal-description">
                                <div className="my-1">
                                    <Link href="#!" scroll={false} className="company-name">Globex Corp</Link>
                                </div>
                    ...
                    <div className="box custom-box">
                        <div className="box-body deals-content">
                            ...
                            <div className="deal-description">
                                <div className="my-1">
                                    <Link href="#!" scroll={false} className="company-name">CrystalClear Consulting</Link>
                                </div>
                ...
                <div className="xxl:col-span-2 col-span-12" ref={fifthContainerRef} id="negotiation">
                    <div className="box custom-box">
                        <div className="box-body deals-content">
                            ...
                            <div className="deal-description">
                                <div className="my-1">
                                    <Link href="#!" scroll={false} className="company-name">GlobalConnect</Link>
                                </div>
                    ...
                    <div className="box custom-box">
                        <div className="box-body deals-content">
                            ...
                            <div className="deal-description">
                                <div className="my-1">
                                    <Link href="#!" scroll={false} className="company-name">AlphaTech Solutions</Link>
                                </div>
                    ...
                    <div className="box custom-box">
                        <div className="box-body deals-content">
                            ...
                            <div className="deal-description">
                                <div className="my-1">
                                    <Link href="#!" scroll={false} className="company-name">RedRock Industries</Link>
                                </div>
                    ...
                    <div className="box custom-box">
                        <div className="box-body deals-content">
                            ...
                            <div className="deal-description">
                                <div className="my-1">
                                    <Link href="#!" scroll={false} className="company-name">CoreTech Solutions</Link>
                                </div>
                    ...
                    <div className="box custom-box">
                        <div className="box-body deals-content">
                            ...
                            <div className="deal-description">
                                <div className="my-1">
                                    <Link href="#!" scroll={false} className="company-name">TechPro Services</Link>
                                </div>
                ...
                <div className="xxl:col-span-2 col-span-12" ref={sixthContainerRef} id="deal-finalized">
                    <div className="box custom-box">
                        <div className="box-body deals-content">
                            ...
                            <div className="deal-description">
                                <div className="my-1">
                                    <Link href="#!" scroll={false} className="company-name">BlueSky Industries</Link>
                                </div>
                    ...
                    <div className="box custom-box">
                        <div className="box-body deals-content">
                            ...
                            <div className="deal-description">
                                <div className="my-1">
                                    <Link href="#!" scroll={false} className="company-name">BrightStar Solutions</Link>
                                </div>
