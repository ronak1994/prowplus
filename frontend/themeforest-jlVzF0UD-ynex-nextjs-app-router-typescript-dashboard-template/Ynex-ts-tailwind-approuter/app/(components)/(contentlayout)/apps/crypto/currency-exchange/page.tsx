"use client"
import {  CurrencyOptions1, CurrencyOptions2 } from '@/shared/data/apps/crypto/currencydata'
                ...
                <div className="xl:col-span-3 col-span-12">
                    <div className="box custom-box overflow-hidden">
                        ...
                        <div id="btc-currency-chart" className="mt-1 w-full">
                            <ReactApexChart options={Currencydata.CurrencyBTC.options} series={Currencydata.CurrencyBTC.series} type="area" height={60} width={"100%"} />
                        </div>
                    </div>
                </div>
                <div className="xl:col-span-3 col-span-12">
                    <div className="box custom-box overflow-hidden">
                        ...
                        <div id="eth-currency-chart" className="mt-1 w-full">
                            <ReactApexChart options={Currencydata.CurrencyETH.options} series={Currencydata.CurrencyETH.series} type="area" height={60} width={"100%"} />
                        </div>
                    </div>
                </div>
                <div className="xl:col-span-3 col-span-12">
                    <div className="box custom-box overflow-hidden">
                        ...
                        <div id="dash-currency-chart" className="mt-1 w-full">
                            <ReactApexChart options={Currencydata.CurrencyDASH.options} series={Currencydata.CurrencyDASH.series} type="area" height={60} width={"100%"} />
                        </div>
                    </div>
                </div>
                <div className="xl:col-span-3 col-span-12">
                    <div className="box custom-box overflow-hidden">
                        ...
                        <div id="ltc-currency-chart" className="mt-1 w-full">
                            <ReactApexChart options={Currencydata.CurrencyLTC.options} series={Currencydata.CurrencyLTC.series} type="area" height={60} width={"100%"} />
                        </div>
                    </div>
                </div>
                <div className="xl:col-span-3 col-span-12">
                    <div className="box custom-box overflow-hidden">
                        ...
                        <div id="xrs-currency-chart" className="mt-1 w-full">
                            <ReactApexChart options={Currencydata.CurrencyXRS.options} series={Currencydata.CurrencyXRS.series} type="area" height={60} width={"100%"} />
                        </div>
                    </div>
                </div>
                <div className="xl:col-span-3 col-span-12">
                    <div className="box custom-box overflow-hidden">
                        ...
                        <div id="glm-currency-chart" className="mt-1 w-full">
                            <ReactApexChart options={Currencydata.CurrencyGLM.options} series={Currencydata.CurrencyGLM.series} type="area" height={60} width={"100%"} />
                        </div>
                    </div>
                </div>
                <div className="xl:col-span-3 col-span-12">
                    <div className="box custom-box overflow-hidden">
                        ...
                        <div id="monero-currency-chart" className="mt-1 w-full">
                            <ReactApexChart options={Currencydata.CurrencyMonero.options} series={Currencydata.CurrencyMonero.series} type="area" height={60} width={"100%"} />
                        </div>
                    </div>
                </div>
                <div className="xl:col-span-3 col-span-12">
                    <div className="box custom-box overflow-hidden">
                        ...
                        <div id="eos-currency-chart" className="mt-1 w-full">
                            <ReactApexChart options={Currencydata.CurrencyEOS.options} series={Currencydata.CurrencyEOS.series} type="area" width={"100%"} height={60} />
                        </div>
                    </div>
                </div>
                <div className="xl:col-span-12 col-span-12">
