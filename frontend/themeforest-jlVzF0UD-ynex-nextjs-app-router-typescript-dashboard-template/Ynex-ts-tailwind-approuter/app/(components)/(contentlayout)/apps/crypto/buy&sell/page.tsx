                            ...
                            <div className="box-body crypto-data">
                                <div>
                                    <div className="input-group mb-4 sm:flex block flex-nowrap crypto-buy-sell">
                                        <input type="text" className="form-control crypto-buy-sell-input border-e-0 !border-s form-control-sm" aria-label="crypto buy select" placeholder="Select Currency" />
                                        <Select name="colors" options={Data1} className="" placeholder="BTC"
                                            menuPlacement='auto' classNamePrefix="Select2"
                                        />
                                    </div>
                                    <div className="input-group mb-4 sm:flex block flex-nowrap crypto-buy-sell">
                                        <input type="text" className="form-control crypto-buy-sell-input border-e-0 !border-s form-control-sm" aria-label="crypto buy select" placeholder="36,335.00" />
                        ...
                        <div className="box custom-box">
                            ...
                            <div className="box-body">
                                <div className="tab-pane border-0 !p-0" id="sell-crypto" role="tabpanel"
                                    ...
                                    <div className="input-group mb-4 sm:flex block flex-nowrap crypto-buy-sell">
                                        <input type="text" className="form-control crypto-buy-sell-input border-e-0 !border-s" aria-label="crypto buy select" placeholder="36,335.00" />
                                        <Select name="colors" options={Data2} className="" placeholder="USD"
                                            menuPlacement='auto' classNamePrefix="Select2"
                                        />
                                    </div>
                                ...
                                <div className="grid grid-cols-12 gap-6">
                                    <div className="xl:col-span-8 col-span-12 pe-0 border-e border-dashed dark:border-defaultborder/10">
                                        ...
                                        <div id="buy_sell-statistics" className="px-3">
                                            <ReactApexChart options={Buyselldata.SellStatistics.options} series={Buyselldata.SellStatistics.series} type="line" height={300} width={"100%"} />
                                        </div>
                                    </div>
