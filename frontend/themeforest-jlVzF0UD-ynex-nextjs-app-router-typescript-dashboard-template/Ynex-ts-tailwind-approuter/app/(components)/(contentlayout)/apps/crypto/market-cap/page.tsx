...
import * as Marketcapdata from "@/shared/data/apps/crypto/marcketcapdata";
                    ...
                    <div className="box custom-box">
                        ...
                        <div className="box-footer !p-0">
                            <div className="list-group border-0">
                                <Link href="#!" scroll={false} className="py-3 !px-[1.25rem] flex flex-col items-start border-t-0 border-x-0 !border-b dark:border-defaultborder/10 ">
                                ...
                                <Link href="#!" scroll={false} className="py-3 !px-[1.25rem] flex flex-col items-start border-t-0 border-x-0 ">
                    ...
                    <div className="box custom-box">
                        ...
                        <div className="box-footer !p-0">
                            <div className="list-group border-0">
                                ...
                                <Link href="#!" scroll={false} className="py-3 px-[1.25rem] flex flex-col items-start border-topacity-0 border-start-0 border-end-0 ">
                                    <div className="flex w-full justify-between items-center">
                    ...
                    <div className="box custom-box">
                        ...
                        <div className="box-footer !p-0">
                            <div className="list-group">
                                ...
                                <Link href="#!" scroll={false} className="py-3 px-[1.25rem] flex flex-col items-start border-t-0 border-x-0 !border-b-0 ">
                                    <div className="flex w-full justify-between items-center">
                                        <p className="tx-14 mb-0 font-weight-semibold text-dark">Market Rank</p>
                                        <p className="text-dark mb-0 tx-15">
                        ...
                        <div className="box-header justify-between">
                            ...
                            <div className="flex flex-wrap gap-2">
                                ...
                                <div className="hs-dropdown ti-dropdown">
                                    <Link href="#!" scroll={false} className="ti-btn ti-btn-primary-full !py-1 !px-2 !text-[0.75rem]" aria-expanded="false">
                                        Sort By<i className="ri-arrow-down-s-line align-middle ms-1 inline-block"></i>
                                    </Link>
                                    <ul className="hs-dropdown-menu ti-dropdown-menu hidden" role="menu">
                                        <li><Link className="ti-dropdown-item" href="#!" scroll={false}>Market Cap</Link></li>
                                        <li><Link className="ti-dropdown-item" href="#!" scroll={false}>Price</Link></li>
                                        <li><Link className="ti-dropdown-item" href="#!" scroll={false}>Trading Volume</Link></li>
                                        <li><Link className="ti-dropdown-item" href="#!" scroll={false}>Price Change (24h)</Link></li>
                                        <li><Link className="ti-dropdown-item" href="#!" scroll={false}>Rank</Link></li>
                                        <li><Link className="ti-dropdown-item" href="#!" scroll={false}>A - Z</Link></li>
                                        <li><Link className="ti-dropdown-item" href="#!" scroll={false}>All-Time High (ATH)</Link></li>
                                    </ul>
                                </div>
                                <div>
                                    ...
                                    <tbody>
                                        <tr className="border border-defaultborder">
                                            <td className="text-center">
                                                <Link aria-label="anchor" href="#!" scroll={false}><i className="ri-star-line text-[1rem] text-[#8c9097] dark:text-white/50"></i></Link>
                                            </td>
                                            <td>1</td>
                                            <td>
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <div className="font-semibold"><Link href="#!" scroll={false}>Bitcoin (BTC)</Link></div>
                                                </div>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <Link href="#!" scroll={false}>
                                                    ...
                                                    <div className="progress-stacked progress-xs w-[75%] mb-4 flex">
                                                        <div className="progress-bar !bg-success opacity-[0.5] w-[88%]" role="progressbar"
                                                            aria-valuenow={88} aria-valuemin={0} aria-valuemax={100}></div>
                                                        <div className="progress-bar !rounded-s-none !rounded-e-full !bg-danger opacity-[0.5] w-[12%]" role="progressbar"
                                        ...
                                        <tr className="border border-defaultborder">
                                            ...
                                            <td>
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <div className="font-semibold"><Link href="#!" scroll={false}>Etherium (ETH)</Link></div>
                                                </div>
                                            </td>
                                            <td>
                                        ...
                                        <tr className="border border-defaultborder">
                                            <td className="text-center">
                                                <Link aria-label="anchor" href="#!" scroll={false}><i className="ri-star-line text-[1rem] text-[#8c9097] dark:text-white/50"></i></Link></td>
                                            <td>3</td>
                                            <td>
                                                <div className="flex items-center gap-2">
                                                    <div className="leading-none">
                                                    ...
                                                    <div className="font-semibold"><Link href="#!" scroll={false}>Golem (GLM)</Link></div>
                                                </div>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <Link href="#!" scroll={false}>
                                                    ...
                                                    <div className="progress-stacked  progress-xs w-[75%] mb-4 flex"> 
                                                        <div className="progress-bar !rounded-full !bg-success opacity-[0.5] w-full" role="progressbar"
                                        ...
                                        <tr className="border border-defaultborder">
                                            ...
                                            <td>
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <div className="font-semibold"><Link href="#!" scroll={false}>Dash (DASH)</Link></div>
                                                </div>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <Link href="#!" scroll={false}>
                                                    ...
                                                    <div className="progress-stacked  progress-xs w-[75%] mb-4 flex">
                                                        <div className="progress-bar !bg-success opacity-[0.5] w-[56%]" role="progressbar"
                                                            aria-valuenow={56} aria-valuemin={0} aria-valuemax={100}></div>
                                                        <div className="progress-bar !rounded-s-none !rounded-e-full !rounded-full !bg-danger opacity-[0.5] w-[44%]" role="progressbar"
                                        ...
                                        <tr className="border border-defaultborder">
                                            ...
                                            <td>
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <div className="font-semibold"><Link href="#!" scroll={false}>Litecoin (LTC)</Link></div>
                                                </div>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <Link href="#!" scroll={false}>
                                                    ...
                                                    <div className="progress-stacked  progress-xs w-[75%] mb-4 flex">
                                                        <div className="progress-bar !bg-success !rounded-full opacity-[0.5] w-full" role="progressbar"
                                                            aria-valuenow={100} aria-valuemin={0} aria-valuemax={100}></div>
                                                    </div>
                                                </Link>
                                            </td>
                                        ...
                                        <tr className="border border-defaultborder">
                                            ...
                                            <td>
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <div className="font-semibold"><Link href="#!" scroll={false}>Ripple (XRP)</Link></div>
                                                </div>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <Link href="#!" scroll={false}>
                                                    ...
                                                    <div className="progress-stacked  progress-xs w-[75%] mb-4 flex">
                                                        <div className="progress-bar !bg-success opacity-[0.5] w-[52%]" role="progressbar"
                                                            aria-valuenow={52} aria-valuemin={0} aria-valuemax={100}></div>
                                                        <div className="progress-bar !rounded-s-none !rounded-e-full !bg-danger opacity-[0.5] w-[48%]" role="progressbar"
                                        ...
                                        <tr className="border border-defaultborder">
                                            ...
                                            <td>
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <div className="font-semibold"><Link href="#!" scroll={false}>EOS</Link></div>
                                                </div>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <Link href="#!" scroll={false}>
                                                    ...
                                                    <div className="progress-stacked  progress-xs w-[75%] mb-4 flex">
                                                        <div className="progress-bar !bg-success opacity-[0.5] w-[10%]" role="progressbar"
                                                            aria-valuenow={10} aria-valuemin={0} aria-valuemax={100}></div>
                                                        <div className="progress-bar !rounded-s-none !rounded-e-full  !bg-danger opacity-[0.5] w-[90%]" role="progressbar"
                                        ...
                                        <tr className="border border-defaultborder">
                                            ...
                                            <td>
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <div className="font-semibold"><Link href="#!" scroll={false}>Bytecoin (BCN)</Link></div>
                                                </div>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <Link href="#!" scroll={false}>
                                                    ...
                                                    <div className="progress-stacked  progress-xs w-[75%] mb-4 flex">
                                                        <div className="progress-bar !bg-success opacity-[0.5] w-[99%]" role="progressbar"
                                                            aria-valuenow={99} aria-valuemin={0} aria-valuemax={100}></div>
                                                        <div className="progress-bar !rounded-s-none !rounded-e-full  !bg-danger opacity-[0.5] w-[1%]" role="progressbar"
                                        ...
                                        <tr className="border border-defaultborder">
                                            ...
                                            <td>
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <div className="font-semibold"><Link href="#!" scroll={false}>IOTA</Link></div>
                                                </div>
                                            </td>
                                            <td>
                                        ...
                                        <tr className="border border-defaultborder">
                                            ...
                                            <td>
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <div className="font-semibold"><Link href="#!" scroll={false}>Monero</Link></div>
                                                </div>
                                            </td>
                                            <td>
                        ...
                        <div className="box-footer !border-t-0">
                            <nav aria-label="Page navigation">
                                <ul className="ti-pagination  mb-0 justify-end">
                                    ...
                                    <li className="page-item"><Link className="page-link active px-3 py-[0.375rem]" href="#!" scroll={false}>2</Link></li>
