"use client"
import { Tabledata } from '@/shared/data/apps/crypto/transactiondata'
...
import * as Transactiondata from "@/shared/data/apps/crypto/transactiondata";
...
const Transactions = () => {
    ...
    const myfunction = (InputData: string) => {
        let filteredData = originalData.slice(); // Make a copy of original data
                        ...
                        <div className="box-header justify-between">
                            ...
                            <div className="flex flex-wrap gap-2">
                                ...
                                <div className="ti-dropdown hs-dropdown">
                                    <Link href="#!" scroll={false} className="ti-btn ti-btn-primary-full !py-1 !px-2 !text-[0.75rem] waves-effect waves-light" aria-expanded="false">
                                        Sort By<i className="ri-arrow-down-s-line align-middle ms-1 inline-block"></i>
                                    </Link>
                                    <ul className="hs-dropdown-menu ti-dropdown-menu hidden" role="menu">
                                        <li><Link className="ti-dropdown-item" href="#!" scroll={false}>New</Link></li>
                                        <li><Link className="ti-dropdown-item" href="#!" scroll={false}>This Week</Link></li>
                                        <li><Link className="ti-dropdown-item" href="#!" scroll={false}>This Month</Link></li>
                                        <li><Link className="ti-dropdown-item" href="#!" scroll={false}>This Year</Link></li>
                                    </ul>
                                </div>
                                <div>
                        ...
                        <div className="box-footer">
                            <nav aria-label="Page navigation">
                                <ul className="ti-pagination sm:ltr:float-right sm:rtl:float-left justify-center mb-4">
                                    ...
                                    <li className="page-item"><Link className="page-link px-3 py-[0.375rem] active" href="#!" scroll={false}>1</Link></li>
                        ...
                        <div className="box custom-box">
                            <div className="box-body !p-0">
                                ...
                                <div className="p-6 pb-2">
                                    ...
                                    <div id="transactions">
                                        <ReactApexChart options={Transactiondata.TransactionsStatistics.options} series={Transactiondata.TransactionsStatistics.series} type="bar" width={"100%"} height={210} />
                                    </div>
                                </div>
                            </div>
                        </div>
