                    ...
                    <div className="box  overflow-hidden">
                        <div className="box-header justify-between">
                            ...
                            <div className="flex flex-wrap gap-2">
                                <Link href="/apps/jobs/job-post/"  className="ti-btn ti-btn-primary-full !py-1 !px-2 !text-[0.75rem]">
                                ...
                                <div className="hs-dropdown ti-dropdown">
                                    ...
                                    <ul className="hs-dropdown-menu ti-dropdown-menu hidden" role="menu">
                                        <li><Link className="ti-dropdown-item" href="#!" scroll={false}>Posted Date</Link></li>
                                        <li><Link className="ti-dropdown-item" href="#!" scroll={false}>Status</Link></li>
                                        <li><Link className="ti-dropdown-item" href="#!" scroll={false}>Department</Link></li>
                                        <li><Link className="ti-dropdown-item" href="#!" scroll={false}>Job Type</Link></li>
                                        <li><Link className="ti-dropdown-item" href="#!" scroll={false}>Newest</Link></li>
                                        <li><Link className="ti-dropdown-item" href="#!" scroll={false}>Oldest</Link></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <tr className="border-t hover:bg-gray-200 dark:hover:bg-light" key={Math.random()}>
                                                ...
                                                <td>
                                                    <div className="flex">
                                                        ...
                                                        <div className="ms-2">
                                                            <p className="font-semibold mb-0 flex items-center"><Link href="/apps/jobs/job-details/">{idx.class}</Link></p>
                                                ...
                                                <td>
                                                    <Link aria-label="anchor" href="/apps/jobs/job-details/" className="ti-btn ti-btn-icon ti-btn-sm ti-btn-primary  me-2">
                                                        <i className="ri-eye-line"></i>
                                                    </Link>
                                                    <Link aria-label="anchor" href="#!" scroll={false} className="ti-btn ti-btn-icon ti-btn-sm ti-btn-info  me-2">
                                                        <i className="ri-edit-line"></i>
                                                    </Link>
                                                    <Link aria-label="anchor" href="#!" scroll={false} className="ti-btn ti-btn-icon ti-btn-sm ti-btn-danger">
                                ...
                                <div className="ms-auto">
                                    <nav aria-label="Page navigation">
                                        <ul className="ti-pagination  mb-0">
                                            ...
                                            <li className="page-item"><Link className="page-link px-3 py-[0.375rem]" href="#!" scroll={false}>4</Link></li>
                                            <li className="page-item"><Link className="page-link px-3 py-[0.375rem]" href="#!" scroll={false}>5</Link></li>
