                                ...
                                <div className="sm:flex items-center sm:flex-wrap justify-between gap-2">
                                    <div className="md:flex">
                                        ...
                                        <div className="sm:ms-4">
                                            <h4 className="font-bold mb-0 sm:flex items-center"><Link href="#!" scroll={false}> Brenda Simpson <i className="bi bi-check-circle-fill text-success text-[1rem]" title="Verified candidate"></i></Link></h4>
                                            <Link href="#!" scroll={false} className="font-semibold"><i className="bi bi-briefcase me-1"></i> Software Developer</Link>
                                            ...
                                            <div className="popular-tags">
                                                <Link href="#!" scroll={false} className="badge  me-2 !rounded-full bg-info/10  text-info mb-2"><i className="bi bi-moon-stars me-1"></i>Full Time</Link>
                                                <Link href="#!" scroll={false} className="badge !rounded-full bg-danger/10 text-danger mb-2"><i className="bi bi-clock me-1"></i> Immediate Joinee</Link>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="btn-list flex">
                                        <Link href="#!" scroll={false} className="ti-btn  ti-btn-primary-full dark:border-defaulttextcolor/10 me-2 whitespace-nowrap"><i className="bi bi-download me-1"></i> Download CV</Link>
                                        <Link aria-label="anchor" href="#!" scroll={false} className="ti-btn ti-btn-icon ti-btn-primary me-2">
                ...
                <div className="grid grid-cols-12 gap-6">
                            ...
                            <div className="box-body">
                                <div className="sm:grid grid-cols-12 items-center">
                                    ...
                                    <div className="lg:col-span-6 col-span-6 text-end">
                                        <Link href="#!" scroll={false} className="ti-btn ti-btn-success-full dark:border-defaultborder/10 ti-btn-lg">
                                    ...
                                    <div className="box custom-box">
                                        <div className="box-body">
                                            ...
                                            <div className="sm:flex mb-3 items-center">
                                                ...
                                                <div className="ms-2">
                                                    <h5 className="font-semibold mb-0 sm:flex items-center"><Link href="#!" scroll={false}> Brenda Simpson <i className="bi bi-check-circle-fill text-success text-[1rem]" title="Verified candidate"></i></Link></h5>
                                                    <div className="sm:flex gap-2">
                                            ...
                                            <div className="popular-tags">
                                                <Link href="#!" scroll={false} className="badge me-2 !rounded-full bg-light !text-defaulttextcolor"><i className="bi bi-mortarboard text-[#8c9097] dark:text-white/50 me-1"></i> Graduate</Link>
                                                <Link href="#!" scroll={false} className="badge  me-2 !rounded-full bg-light !text-defaulttextcolor"><i className="bi bi-moon-stars text-[#8c9097] dark:text-white/50 me-1"></i> sm:flexible-shift</Link>
                                                <Link href="#!" scroll={false} className="badge  me-2 !rounded-full bg-light !text-defaulttextcolor"><i className="bi bi-clock text-[#8c9097] dark:text-white/50 me-1"></i> Immediate Joinee</Link>
                                                <Link href="#!" scroll={false} className="badge !rounded-full bg-light !text-defaulttextcolor"><i className="bi bi-broadcast text-[#8c9097] dark:text-white/50 me-1"></i> Good at English</Link>
                                            </div>
                                        </div>
                                        <div className="box-footer">
                                            <div className="sm:flex items-center gap-3">
                                                ...
                                                <div className="popular-tags sm:flex-grow">
                                                    <Link href="#!" scroll={false} className="badge  me-2 !rounded-full bg-light !text-defaulttextcolor">HTML</Link>
                                                    <Link href="#!" scroll={false} className="badge  me-2 !rounded-full bg-light !text-defaulttextcolor">CSS</Link>
                                                    <Link href="#!" scroll={false} className="badge  me-2 !rounded-full bg-light !text-defaulttextcolor">Javascript</Link>
                                                    <Link href="#!" scroll={false} className="badge  me-2 !rounded-full bg-light !text-defaulttextcolor">Angular</Link>
                                                    <Link href="#!" scroll={false} className="badge !rounded-full bg-primary/10 text-primary"><i className="bi bi-plus"></i> More</Link>
                                                </div>
                                                <div>
                                                    <Link href="#!" scroll={false} className="badge  me-2 badge-md !rounded-full bg-info/10 text-info" title="1 year bond accepted"><i className="bi bi-hand-thumbs-up me-1"></i>1 year bond accepted</Link>
                                    ...
                                    <div className="box custom-box">
                                        <div className="box-body">
                                            ...
                                            <div className="sm:flex mb-3 items-center">
                                                ...
                                                <div className="ms-2">
                                                    <h5 className="font-semibold mb-0 sm:flex items-center"><Link href="#!" scroll={false}> Dwayne Stort <i className="bi bi-check-circle-fill text-success text-[1rem]" title="Verified candidate"></i></Link></h5>
                                                    <div className="sm:flex gap-2">
                                            ...
                                            <div className="popular-tags">
                                                <Link href="#!" scroll={false} className="badge  me-2 !rounded-full bg-light !text-defaulttextcolor"><i className="bi bi-mortarboard text-[#8c9097] dark:text-white/50 me-1"></i> Post Graduate</Link>
                                                <Link href="#!" scroll={false} className="badge  me-2 !rounded-full bg-light !text-defaulttextcolor"><i className="bi bi-moon-stars text-[#8c9097] dark:text-white/50 me-1"></i> sm:flexible-shift</Link>
                                                <Link href="#!" scroll={false} className="badge  me-2 !rounded-full bg-light !text-defaulttextcolor"><i className="bi bi-clock text-[#8c9097] dark:text-white/50 me-1"></i> Within 10 Days</Link>
                                                <Link href="#!" scroll={false} className="badge !rounded-full bg-light !text-defaulttextcolor"><i className="bi bi-broadcast text-[#8c9097] dark:text-white/50 me-1"></i> Good at English</Link>
                                            </div>
                                        </div>
                                        <div className="box-footer">
                                            <div className="sm:flex items-center gap-3">
                                                <h6 className="mb-0 font-semibold">Skills :</h6>
                                                <div className="popular-tags sm:flex-grow">
                                                    <Link href="#!" scroll={false} className="badge  me-1 !rounded-full bg-light !text-defaulttextcolor">React</Link>
                                                    <Link href="#!" scroll={false} className="badge me-1 !rounded-full bg-light !text-defaulttextcolor">Javascript</Link>
                                                    <Link href="#!" scroll={false} className="badge me-1 !rounded-full bg-light !text-defaulttextcolor">React Navtive</Link>
                                                    <Link href="#!" scroll={false} className="badge !rounded-full bg-primary/10 text-primary"><i className="bi bi-plus"></i> More</Link>
                                                </div>
                                                <div>
                                                    <Link href="#!" scroll={false} className="badge badge-md !rounded-full bg-info/10 text-info" title="1 year bond accepted"><i className="bi bi-hand-thumbs-up me-1"></i>2 years bond accepted</Link>
                                    ...
                                    <div className="box custom-box">
                                        <div className="box-body">
                                            ...
                                            <div className="sm:flex mb-3 items-center">
                                                ...
                                                <div className="ms-2">
                                                    <h5 className="font-semibold mb-0 sm:flex items-center"><Link href="#!" scroll={false}> Jasmine Kova <i className="bi bi-check-circle-fill text-success text-[1rem]" title="Verified candidate"></i></Link></h5>
                                                    <div className="sm:flex gap-2">
                                            ...
                                            <div className="popular-tags">
                                                <Link href="#!" scroll={false} className="badge  me-2 !rounded-full bg-light !text-defaulttextcolor"><i className="bi bi-mortarboard text-[#8c9097] dark:text-white/50 me-1"></i> MBA</Link>
                                                <Link href="#!" scroll={false} className="badge  me-2 !rounded-full bg-light !text-defaulttextcolor"><i className="bi bi-moon-stars text-[#8c9097] dark:text-white/50 me-1"></i> Day-shift</Link>
                                                <Link href="#!" scroll={false} className="badge  me-2 !rounded-full bg-light !text-defaulttextcolor"><i className="bi bi-clock text-[#8c9097] dark:text-white/50 me-1"></i> Within 30 Days</Link>
                                                <Link href="#!" scroll={false} className="badge !rounded-full bg-light !text-defaulttextcolor"><i className="bi bi-broadcast text-[#8c9097] dark:text-white/50 me-1"></i> Avg at English</Link>
                                            </div>
                                        </div>
                                        <div className="box-footer">
                                            <div className="sm:flex items-center gap-3">
                                                <h6 className="mb-0 font-semibold">Skills :</h6>
                                                <div className="popular-tags sm:flex-grow">
                                                    <Link href="#!" scroll={false} className="badge  me-2 !rounded-full bg-light !text-defaulttextcolor">Python</Link>
                                                    <Link href="#!" scroll={false} className="badge  me-2 !rounded-full bg-light !text-defaulttextcolor">Java</Link>
                                                    <Link href="#!" scroll={false} className="badge  me-2 !rounded-full bg-light !text-defaulttextcolor">React</Link>
                                                    <Link href="#!" scroll={false} className="badge !rounded-full bg-primary/10 text-primary"><i className="bi bi-plus"></i> More</Link>
                                                </div>
                                                <div>
                    ...
                    <div className="xl:col-span-4 col-span-12">
                        <div className="box custom-box">
                            ...
                            <div className="box-body">
                                <div className="popular-tags">
                                    <Link href="#!" scroll={false} className="badge me-1 !rounded-full bg-light !text-defaulttextcolor">HTML</Link>
                                    <Link href="#!" scroll={false} className="badge me-1 !rounded-full bg-light !text-defaulttextcolor">CSS</Link>
                                    <Link href="#!" scroll={false} className="badge me-1 !rounded-full bg-light !text-defaulttextcolor">Javascript</Link>
                                    <Link href="#!" scroll={false} className="badge me-1 !rounded-full bg-light !text-defaulttextcolor">Angular</Link>
                                    <Link href="#!" scroll={false} className="badge !rounded-full bg-light !text-defaulttextcolor">React</Link>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="box-body">
                                <div className="">
                                    ...
                                    <label className="form-check-label">
                                        By Subscribing you accept to <Link href="#!" scroll={false} className="text-success ms-1"><u>privacy policy</u></Link>
                                    </label>
                                </div>
                            </div>
                        </div>
