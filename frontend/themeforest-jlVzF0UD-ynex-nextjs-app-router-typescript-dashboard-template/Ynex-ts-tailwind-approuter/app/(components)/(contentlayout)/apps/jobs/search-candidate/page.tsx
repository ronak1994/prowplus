                ...
                <div className="grid grid-cols-12 gap-6">
                            ...
                            <div className="box-body !p-0">
                                <div className="!p-6 border-b dark:border-defaultborder/10">
                                    ...
                                    <div className="px-2 py-3 pb-0">
                                        ...
                                        <Link className="ecommerce-more-link text-success hs-collapse-toggle inline-flex items-center gap-x-2"
                                            href="#!" scroll={false} id="hs-show-hide-categeories"
                                ...
                                <div className="p-4">
                                    ...
                                    <div className="px-2 py-3 pb-0">
                                        ...
                                        <Link className="ecommerce-more-link text-success hs-collapse-toggle inline-flex items-center gap-x-2"
                                            href="#!" scroll={false} id="hs-show-hide-skills"
                    ...
                    <div className="xxl:col-span-9 xl:col-span-8 col-span-12">
                                ...
                                <div className="sm:flex items-center">
                                    ...
                                    <div className="btn-group hs-dropdown ti-dropdown">
                                        ...
                                        <ul className="hs-dropdown-menu ti-dropdown-menu hidden">
                                            <li><Link className="ti-dropdown-item" href="#!" scroll={false}>Premium</Link></li>
                                            <li><Link className="ti-dropdown-item" href="#!" scroll={false}>Newest</Link></li>
                                            <li><Link className="ti-dropdown-item" href="#!" scroll={false}>Most Relevant</Link></li>
                                            <li><Link className="ti-dropdown-item" href="#!" scroll={false}>Fresher</Link></li>
                                            <li><Link className="ti-dropdown-item" href="#!" scroll={false}>Experienced</Link></li>
                                            <li><Link className="ti-dropdown-item" href="#!" scroll={false}>Bond Agreement</Link></li>
                                            <li><Link className="ti-dropdown-item" href="#!" scroll={false}>Flexible Shift</Link></li>
                                            <li><Link className="ti-dropdown-item" href="#!" scroll={false}>Day Shift</Link></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="box custom-box">
                            <div className="box-body">
                                ...
                                <div className="flex mb-3 items-center flex-wrap" >
                                    ...
                                    <div className="ms-2">
                                        <h5 className="font-semibold mb-0 flex items-center"><Link href="/apps/jobs/candidate-details/"> Brenda Simpson <i className="bi bi-check-circle-fill text-success text-base" title="Verified candidate"></i></Link></h5>
                                        ...
                                        <div className="flex items-center text-xs text-[#8c9097] dark:text-white/50">
                                            ...
                                            <Link href="#!" scroll={false} className="ms-1 min-w-fit text-[#8c9097] dark:text-white/50">
                                                <span>(142)</span>
                                                <span>Ratings</span>
                                            </Link>
                                        </div>
                                ...
                                <div className="popular-tags mb-4">
                                    <Link href="#!" scroll={false} className="badge !rounded-full bg-light me-1 text-default"><i className="bi bi-mortarboard text-[#8c9097] dark:text-white/50 me-1"></i> Graduate</Link>
                                    <Link href="#!" scroll={false} className="badge !rounded-full bg-light me-1 text-default"><i className="bi bi-moon-stars text-[#8c9097] dark:text-white/50 me-1"></i> flexible-shift</Link>
                                    <Link href="#!" scroll={false} className="badge !rounded-full bg-light me-1 text-default"><i className="bi bi-clock text-[#8c9097] dark:text-white/50 me-1"></i> Immediate Joinee</Link>
                                    <Link href="#!" scroll={false} className="badge !rounded-full bg-light me-1 text-default"><i className="bi bi-broadcast text-[#8c9097] dark:text-white/50 me-1"></i> Good at English</Link>
                                </div>
                            ...
                            <div className="box-footer">
                                <div className="sm:flex items-center gap-3">
                                    ...
                                    <div className="popular-tags flex-grow">
                                        <Link href="#!" scroll={false} className="badge !rounded-full bg-light me-1 text-default">HTML</Link>
                                        <Link href="#!" scroll={false} className="badge !rounded-full bg-light me-1 text-default">CSS</Link>
                                        <Link href="#!" scroll={false} className="badge !rounded-full bg-light me-1 text-default">Javascript</Link>
                                        <Link href="#!" scroll={false} className="badge !rounded-full bg-primary/10 text-primary">More</Link>
                                    </div>
                                    <div>
                                        <div className="hs-tooltip ti-main-tooltip">
                                            <Link href="#!" scroll={false} className="hs-tooltip-toggle badge badge-md !rounded-full bg-info/10 me-1 text-info">
                                        ...
                                        <Link href="#!" scroll={false} className="badge badge-md !rounded-full bg-primary/10 text-primary"><i className="bi bi-briefcase me-1"></i>Exp : 2 Years</Link>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className="box custom-box">
                            <div className="box-body">
                                ...
                                <div className="flex mb-3 items-center flex-wrap">
                                    ...
                                    <div className="ms-2">
                                        <h5 className="font-semibold mb-0 flex items-center"><Link href="/apps/jobs/candidate-details/"> Dwayne Stort <i className="bi bi-check-circle-fill text-success text-base" title="Verified candidate"></i></Link></h5>
                                        <div className="sm:flex gap-2">
                                        ...
                                        <div className="flex items-center text-xs text-[#8c9097] dark:text-white/50">
                                            ...
                                            <Link href="#!" scroll={false} className="mb-0 ms-1 min-w-fit text-[#8c9097] dark:text-white/50">
                                                <span>(35)</span>
                                                <span>Ratings</span>
                                            </Link>
                                        </div>
                                ...
                                <div className="popular-tags mb-4">
                                    <Link href="#!" scroll={false} className="badge !rounded-full bg-light me-1 text-defaulttextcolor"><i className="bi bi-mortarboard text-[#8c9097] dark:text-white/50 me-1"></i> Post Graduate</Link>
                                    <Link href="#!" scroll={false} className="badge !rounded-full bg-light me-1 text-defaulttextcolor"><i className="bi bi-moon-stars text-[#8c9097] dark:text-white/50 me-1"></i> flexible-shift</Link>
                                    <Link href="#!" scroll={false} className="badge !rounded-full bg-light me-1 text-defaulttextcolor"><i className="bi bi-clock text-[#8c9097] dark:text-white/50 me-1"></i> Within 10 Days</Link>
                                    <Link href="#!" scroll={false} className="badge !rounded-full bg-light me-1 text-defaulttextcolor"><i className="bi bi-broadcast text-[#8c9097] dark:text-white/50 me-1"></i> Good at English</Link>
                                </div>
                                <div className="flex items-center">
                            ...
                            <div className="box-footer">
                                <div className="sm:flex items-center gap-3">
                                    <h6 className="mb-0 font-semibold">Skills :</h6>
                                    <div className="popular-tags flex-grow">
                                        <Link href="#!" scroll={false} className="badge !rounded-full bg-light me-1 text-defaulttextcolor">React</Link>
                                        <Link href="#!" scroll={false} className="badge !rounded-full bg-light me-1 text-defaulttextcolor">React Native</Link>
                                        <Link href="#!" scroll={false} className="badge !rounded-full bg-primary/10 text-primary">More</Link>
                                    </div>
                                    <div>
                                        <div className="hs-tooltip ti-main-tooltip">
                                        ...
                                        <Link href="#!" scroll={false} className="badge badge-md !rounded-full bg-primary/10 text-primary"><i className="bi bi-briefcase me-1"></i>Exp : 4 Years</Link>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className="box custom-box">
                            <div className="box-body">
                                ...
                                <div className="sm:flex mb-3 items-center">
                                    ...
                                    <div className="ms-2">
                                        <h5 className="font-semibold mb-0 flex items-center"><Link href="/apps/jobs/candidate-details/"> Jasmine Kova <i className="bi bi-check-circle-fill text-success text-base" title="Verified candidate"></i></Link></h5>
                                ...
                                <div className="popular-tags mb-4">
                                    <Link href="#!" scroll={false} className="badge !rounded-full bg-light me-1 text-defaulttextcolor"><i className="bi bi-mortarboard text-[#8c9097] dark:text-white/50 me-1"></i> MBA</Link>
                                    <Link href="#!" scroll={false} className="badge !rounded-full bg-light me-1 text-defaulttextcolor"><i className="bi bi-moon-stars text-[#8c9097] dark:text-white/50 me-1"></i> Day-shift</Link>
                                    <Link href="#!" scroll={false} className="badge !rounded-full bg-light me-1 text-defaulttextcolor"><i className="bi bi-clock text-[#8c9097] dark:text-white/50 me-1"></i> Within 30 Days</Link>
                                    <Link href="#!" scroll={false} className="badge !rounded-full bg-light me-1 text-defaulttextcolor"><i className="bi bi-broadcast text-[#8c9097] dark:text-white/50 me-1"></i> Avg at English</Link>
                                </div>
                                <div className="flex items-center">
                            ...
                            <div className="box-footer">
                                <div className="sm:flex items-center gap-3">
                                    <h6 className="mb-0 font-semibold">Skills :</h6>
                                    <div className="popular-tags flex-grow">
                                        <Link href="#!" scroll={false} className="badge !rounded-full bg-light me-1 text-default">Python</Link>
                                        <Link href="#!" scroll={false} className="badge !rounded-full bg-light me-1 text-default">Java</Link>
                                        <Link href="#!" scroll={false} className="badge !rounded-full bg-light me-1 text-default">React</Link>
                                        <Link href="#!" scroll={false} className="badge !rounded-full bg-primary/10 text-primary">More</Link>
                                    </div>
                                    <div>
                                        <Link href="#!" scroll={false} className="badge badge-md !rounded-full bg-primary/10 text-primary"><i className="bi bi-briefcase me-1"></i>Exp : 5 Years</Link>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className="box custom-box">
                            <div className="box-body">
                                ...
                                <div className="sm:flex mb-3 items-center">
                                    ...
                                    <div className="ms-2">
                                        <h5 className="font-semibold mb-0 flex items-center"><Link href="/apps/jobs/candidate-details/"> Kiara Advain <i className="bi bi-check-circle-fill text-success text-base" title="Verified candidate"></i></Link></h5>
                                        <div className="flex gap-2">
                            ...
                            <div className="box-footer">
                                <div className="sm:flex items-center gap-3">
                                    ...
                                    <div className="popular-tags flex-grow">
                                        <Link href="#!" scroll={false} className="badge !rounded-full bg-light me-1 text-default">Java</Link>
                                        <Link href="#!" scroll={false} className="badge !rounded-full bg-light me-1 text-default">Core Java</Link>
                                        <Link href="#!" scroll={false} className="badge !rounded-full bg-primary/10 text-primary">More</Link>
                                    </div>
                                    <div>
                                        <div className="hs-tooltip ti-main-tooltip">
                                        ...
                                        <Link href="#!" scroll={false} className="badge badge-md !rounded-full bg-primary/10 text-primary"><i className="bi bi-briefcase me-1"></i>Fresher</Link>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className="box custom-box">
                            <div className="box-body">
                                ...
                                <div className="sm:flex mb-3 items-center">
                                    ...
                                    <div className="ms-2">
                                        <h5 className="font-semibold mb-0 flex items-center"><Link href="/apps/jobs/candidate-details/"> Json Taylor <i className="bi bi-check-circle-fill text-success text-base" title="Verified candidate"></i></Link></h5>
                                        <div className="sm:flex gap-2">
                                ...
                                <div className="popular-tags mb-4">
                                    <Link href="#!" scroll={false} className="badge !rounded-full bg-light me-1 text-defaulttextcolor"><i className="bi bi-mortarboard text-[#8c9097] dark:text-white/50 me-1"></i> MCA</Link>
                                    <Link href="#!" scroll={false} className="badge !rounded-full bg-light me-1 text-defaulttextcolor"><i className="bi bi-moon-stars text-[#8c9097] dark:text-white/50 me-1"></i> flexible-shift</Link>
                                    <Link href="#!" scroll={false} className="badge !rounded-full bg-light me-1 text-defaulttextcolor"><i className="bi bi-clock text-[#8c9097] dark:text-white/50 me-1"></i> Within 15 Days</Link>
                                    <Link href="#!" scroll={false} className="badge !rounded-full bg-light me-1 text-defaulttextcolor"><i className="bi bi-broadcast text-[#8c9097] dark:text-white/50 me-1"></i> Fluent at English</Link>
                                </div>
                                <div className="sm:flex items-center">
                                    <p className="mb-0 flex-grow"><span className="text-[#8c9097] dark:text-white/50">Package (Yearly) :</span> <span className="font-semibold" title="Current"> $3,600</span> - <span className="font-semibold" title="Expected"> $4,700</span> </p>
                                    <p className="mb-0"><span className="text-[#8c9097] dark:text-white/50"> Languages :</span> <span className="font-semibold"> English, Telugu</span></p>
                            ...
                            <div className="box-footer">
                                <div className="sm:flex items-center gap-3">
                                    <h6 className="mb-0 font-semibold">Skills :</h6>
                                    <div className="popular-tags flex-grow">
                                        <Link href="#!" scroll={false} className="badge !rounded-full bg-light me-1 text-defaulttextcolor">Angular</Link>
                                        <Link href="#!" scroll={false} className="badge !rounded-full bg-light me-1 text-defaulttextcolor">Advanced Java</Link>
                                        <Link href="#!" scroll={false} className="badge !rounded-full bg-primary/10 text-primary">More</Link>
                                    </div>
                                    <div>
                                        <div className="hs-tooltip ti-main-tooltip">
                        ...
                        <div className="box custom-box">
                            <div className="box-body">
                                ...
                                <div className="sm:flex mb-3 items-center">
                                    ...
                                    <div className="ms-2">
                                        <h5 className="font-semibold mb-0 flex items-center"><Link href="/apps/jobs/candidate-details/"> Diego Sanch <i className="bi bi-check-circle-fill text-success text-base" title="Verified candidate"></i></Link></h5>
                                        <div className="sm:flex gap-2">
                            ...
                            <div className="box-footer">
                                <div className="sm:flex items-center gap-3">
                                    <h6 className="mb-0 font-semibold">Skills :</h6>
                                    <div className="popular-tags flex-grow">
                                        <Link href="#!" scroll={false} className="badge !rounded-full bg-light me-1 text-defaulttextcolor">AWS Lambda</Link>
                                        <Link href="#!" scroll={false} className="badge !rounded-full bg-light me-1 text-defaulttextcolor">Athena</Link>
                                        <Link href="#!" scroll={false} className="badge !rounded-full bg-light me-1 text-defaulttextcolor">Linux</Link>
                                        <Link href="#!" scroll={false} className="badge !rounded-full bg-primary/10 text-primary">More</Link>
                                    </div>
                                    <div>
                                        <Link href="#!" scroll={false} className="badge badge-md !rounded-full bg-primary/10 text-primary"><i className="bi bi-briefcase me-1"></i>Fresher</Link>
                        ...
                        <ul className="ti-pagination mb-4 justify-end">
                            ...
                            <li className="page-item active"><Link className="page-link px-3 py-[0.375rem]" href="#!" scroll={false}>1</Link></li>
                            <li className="page-item"><Link className="page-link px-3 py-[0.375rem]" href="#!" scroll={false}>2</Link></li>
                            <li className="page-item"><Link className="page-link px-3 py-[0.375rem]" href="#!" scroll={false}>3</Link></li>
                            <li className="page-item">
                                <Link className="page-link px-3 py-[0.375rem] text-primary" href="#!" scroll={false}>
                                    next
                                </Link>
                            </li>
                        </ul>
