                            ...
                            <div className="box-body !p-0">
                                <div className="p-4 border-b dark:border-defaultborder/10">
                                    ...
                                    <div className="px-0 py-4 pb-0">
                                        ...
                                        <Link className="ecommerce-more-link text-success hs-collapse-toggle inline-flex items-center gap-x-2"
                                            href="#!" scroll={false} id="hs-show-hide-industry"
                                ...
                                <div className="p-4 border-b dark:border-defaultborder/10">
                                    ...
                                    <div className="px-0 py-4 pb-0">
                                        ...
                                        <Link className="ecommerce-more-link text-success hs-collapse-toggle inline-flex items-center gap-x-2"
                                            href="#!" scroll={false} id="hs-show-hide-location"
                        ...
                        <div className="box custom-box">
                            <div className="box-body">
                                ...
                                <div className="flex items-center flex-wrap gap-2">
                                    ...
                                    <div className="ms-2">
                                        <h5 className="font-semibold mb-0 flex items-center"><Link href="/pages/profile/"> Spotech Technical Solutions <i className="bi bi-check-circle-fill text-success text-base" title="Verified company"></i></Link></h5>
                                        <div className="flex gap-2">
                                            <Link href="#!" scroll={false}><i className="bi bi-geo-alt text-[0.6875rem]"></i> Kondapur, Hyderabad, </Link>
                            ...
                            <div className="box-footer">
                                <div className="flex items-center flex-wrap gap-2">
                                    <div className="flex-grow">
                                        <Link href="#!" scroll={false} className="badge  me-2 badge-md !rounded-full bg-info/10 text-info" title="No of employees"><i className="bi bi-people me-1"></i>No. of Emp : 345</Link>
                                        <Link href="#!" scroll={false} className="badge badge-md !rounded-full bg-primary/10 text-primary"><i className="bi bi-briefcase me-1"></i>Vacancies : 50</Link>
                                    </div>
                                    <Link href="#!" scroll={false} className="ti-btn btn-wave ti-btn-primary-full">
                        ...
                        <div className="box custom-box">
                            <div className="box-body">
                                ...
                                <div className="flex items-center flex-wrap gap-2">
                                    ...
                                    <div className="ms-2">
                                        <h5 className="font-semibold mb-0 flex items-center"><Link href="/pages/profile/"> G Technical Solutions <i className="bi bi-check-circle-fill text-success text-base" title="Verified company"></i></Link></h5>
                                        <div className="flex gap-2">
                                            <Link href="#!" scroll={false}><i className="bi bi-geo-alt text-[0.6875rem]"></i> Gachibowli, Hyderabad, </Link>
                        ...
                        <div className="box custom-box">
                            <div className="box-body">
                                ...
                                <div className="flex items-center flex-wrap gap-2">
                                    ...
                                    <div className="ms-2">
                                        <h5 className="font-semibold mb-0 flex items-center"><Link href="/pages/profile/"> Diego Technical Solutions <i className="bi bi-check-circle-fill text-success text-base" title="Verified company"></i></Link></h5>
                                        <div className="flex gap-2">
                                            <Link href="#!" scroll={false}><i className="bi bi-geo-alt text-[0.6875rem]"></i> Gachibowli, Chennai, </Link>
                        ...
                        <div className="box custom-box">
                            <div className="box-body">
                                ...
                                <div className="flex items-center flex-wrap gap-2">
                                    ...
                                    <div className="ms-2">
                                        <h5 className="font-semibold mb-0 flex items-center"><Link href="/pages/profile/"> Spoteck Solutions Pvt Ltd <i className="bi bi-check-circle-fill text-success text-base" title="Verified company"></i></Link></h5>
                                        <div className="flex gap-2">
                                            <Link href="#!" scroll={false}><i className="bi bi-geo-alt text-[0.6875rem]"></i> Gachibowli, Banglore, </Link>
                        ...
                        <div className="box custom-box">
                            <div className="box-body">
                                ...
                                <div className="flex items-center flex-wrap gap-2">
                                    ...
                                    <div className="ms-2">
                                        <h5 className="font-semibold mb-0 flex items-center"><Link href="/pages/profile/"> Vehement Capital Partners <i className="bi bi-check-circle-fill text-success text-base" title="Verified company"></i></Link></h5>
                        ...
                        <div className="box custom-box">
                            <div className="box-body">
                                ...
                                <div className="flex items-center flex-wrap gap-2">
                                    ...
                                    <div className="ms-2">
                                        <h5 className="font-semibold mb-0 flex items-center"><Link href="/pages/profile/"> Wonka Industries <i className="bi bi-check-circle-fill text-success text-base" title="Verified company"></i></Link></h5>
                                        <div className="flex gap-2">
                                            <Link href="#!" scroll={false}><i className="bi bi-geo-alt text-[0.6875rem]"></i> Kukatpally, Hyderabad, </Link>
