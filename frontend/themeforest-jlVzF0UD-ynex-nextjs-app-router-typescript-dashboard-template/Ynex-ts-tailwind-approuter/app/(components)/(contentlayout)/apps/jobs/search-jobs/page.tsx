            ...
            <div className="container">
                                    ...
                                    <div className="lg:col-span-4 col-span-12 text-end">
                                        <div className="btn-group hs-dropdown ti-dropdown">
                                            ...
                                            <ul className="hs-dropdown-menu ti-dropdown-menu hidden !text-end">
                                                <li><Link className="ti-dropdown-item !text-start" href="#!" scroll={false}>Featured</Link></li>
                                                <li><Link className="ti-dropdown-item !text-start" href="#!" scroll={false}>Newest</Link></li>
                                                <li><Link className="ti-dropdown-item !text-start" href="#!" scroll={false}>Most Relevant</Link></li>
                                                <li><Link className="ti-dropdown-item !text-start" href="#!" scroll={false}>Best Rated</Link></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                ...
                <div className="grid grid-cols-12 gap-6">
                            ...
                            <div className="box-body">
                                <div className="">
                                    ...
                                    <label className="form-check-label">
                                        By Subscribing you accept <Link href="#!" scroll={false} className="text-success"><u className='ms-1'> privacy policy </u></Link>
                                    </label>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="xxl:col-span-9 lg:col-span-7 col-span-12">
                        <div className="box custom-box featured-jobs">
                            <div className="box-body">
                                ...
                                <div className="flex mb-4 flex-wrap gap-2 items-center">
                                    ...
                                    <div>
                                        <h5 className="font-semibold mb-0 flex items-center"><Link href="#!" scroll={false}> HTML Developer - Fresher</Link></h5>
                                ...
                                <div className="popular-tags mb-4">
                                    ...
                                    <Link href="#!" scroll={false} className="badge  me-2 !rounded-full bg-light !text-defaulttextcolor"><i className="bi bi-briefcase text-muted me-1"></i> 13 Openings</Link>
                                    ...
                                    <Link href="#!" scroll={false} className="badge  me-2 !rounded-full bg-light !text-defaulttextcolor"><i className="bi bi-clock text-muted me-1"></i> Min - 2Years</Link>
                                    <Link href="#!" scroll={false} className="badge  me-2 !rounded-full bg-light !text-defaulttextcolor"><i className="bi bi-moon-stars text-muted me-1"></i> flexible-shift</Link>
                                </div>
                                <div className="flex justify-between">
                                    <h6 className="font-semibold mb-0">$25,000 - $35,000</h6>
                                    <Link href="#!" scroll={false} className="text-primary font-semibold text-[.875rem] inline-flex items-center">
                        ...
                        <div className="box custom-box featured-jobs">
                            <div className="box-body">
                                ...
                                <div className="flex mb-4 flex-wrap gap-2 items-center">
                                    ...
                                    <div>
                                        <h5 className="font-semibold mb-0 flex items-center"><Link href="#!" scroll={false}> React Lead Developer</Link></h5>
                        ...
                        <div className="box custom-box featured-jobs">
                            <div className="box-body">
                                <div className="btn-list ltr:float-right rtl:float-left  space-x-1">
                                    <div className="hs-tooltip ti-main-tooltip">
                                        <button type="button" className="hs-tooltip-toggle avatar avatar-sm !rounded-full bg-light !text-defaulttextcolor">
                                            <span><i className="bi bi-heart"></i></span>
                                            <span
                                ...
                                <div className="flex mb-4 flex-wrap gap-2 items-center">
                                    ...
                                    <div>
                                        <h5 className="font-semibold mb-0 flex items-center"><Link href="#!" scroll={false}> Vuejs Frontend Developer</Link></h5>
                        ...
                        <div className="box custom-box featured-jobs">
                            <div className="box-body">
                                ...
                                <div className="flex mb-4 flex-wrap gap-2 items-center">
                                    ...
                                    <div>
                                        <h5 className="font-semibold mb-0 flex items-center"><Link href="#!" scroll={false}> Wordpress Developer - Remote</Link></h5>
