                ...
                <div className="xxl:col-span-9 xl:col-span-8 col-span-12">
                    <div className="box custom-box">
                        ...
                        <div className="box-footer text-end">
                            <Link href="#!" scroll={false} className="ti-btn ti-btn-primary-full btn-wave waves-effect waves-light">Create NFT</Link>
                        </div>
                    </div>
                </div>
                            ...
                            <div className="box custom-box !mb-0 !shadow-none border dark:border-defaultborder/10">
                                ...
                                <div className="flex items-center justify-between nft-like-section w-full px-3">
                                    <div className="flex-fill">
                                        <button aria-label="button" type="button" className="ti-btn ti-btn-icon ti-btn-sm bg-success text-white hover:bg-success hover:text-white !rounded-full ti-btn-wave">
                                ...
                                <div className="box-body">
                                    ...
                                    <p className="text-[0.9375rem] font-semibold mb-2"><Link href="#!" scroll={false}>Digital Dreamscape</Link></p>
