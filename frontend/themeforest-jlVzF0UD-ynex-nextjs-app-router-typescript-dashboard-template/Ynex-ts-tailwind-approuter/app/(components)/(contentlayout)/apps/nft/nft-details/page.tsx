...
const Nftdetails = () => {
    ...
    return (
        <Fragment>
            ...
            <Pageheader currentpage="NFT Details" activepage="NFT" mainpage="NFT Details" />
            <div className="container">
                <div className="box custom-box overflow-hidden">
                    <div className="box-body">
                        <span className="nft-details-auction-time shadow rtl:rotate-[315deg]">24hrs : 32mins : 11sec</span>
                        <div className="grid grid-cols-12 md:gap-x-[3rem]">
                            <div className="xl:col-span-4 col-span-12">
                                <div className="md:mb-[3rem] mb-4">
                                    <Swiper
                                        loop={true}
                                        spaceBetween={10}
                                        navigation={true}
                                    ...
                                    <div className="grid mt-4">
                                        <button type="button" className="ti-btn ti-btn-primary-full btn-wave">Place a bid</button>
                                    </div>
                                </div>
                                                        ...
                                                        <Link href="#!" scroll={false}>
                                                            <div className="flex items-start">
                                                                ...
                                                                <div className="flex-grow">
                                                                    ...
                                                                    <p className="mb-0">
                                                                        <span className="badge bg-success !text-white">13.2k<i className="ri-heart-3-fill align-middle ms-1"></i></span>
                                                        ...
                                                        <Link href="#!" scroll={false}>
                                                            <div className="flex items-start">
                                                                ...
                                                                <div className="flex-grow">
                                                                    ...
                                                                    <p className="mb-0">
                                                                        <span className="badge bg-success !text-white">5.2k<i className="ri-heart-3-fill align-middle ms-1"></i></span>
                                                        ...
                                                        <Link href="#!" scroll={false}>
                                                            <div className="flex items-start">
                                                                ...
                                                                <div className="flex-grow">
                                                                    ...
                                                                    <p className="mb-0">
                                                                        <span className="badge bg-success !text-white">2.4k<i className="ri-heart-3-fill align-middle ms-1"></i></span>
                                                        ...
                                                        <Link href="#!" scroll={false}>
                                                            <div className="flex items-start">
                                                                ...
                                                                <div className="flex-grow">
                                                                    ...
                                                                    <p className="mb-0">
                                                                        <span className="badge bg-success !text-white">1.8k<i className="ri-heart-3-fill align-middle ms-1"></i></span>
                                                        ...
                                                        <Link href="#!" scroll={false}>
                                                            <div className="flex items-start">
                                                                ...
                                                                <div className="flex-grow">
                                                                    ...
                                                                    <p className="mb-0">
                                                                        <span className="badge bg-success !text-white">12.9k<i className="ri-heart-3-fill align-middle ms-1"></i></span>
                                                        ...
                                                        <Link href="#!" scroll={false}>
                                                            <div className="flex items-start">
                                                                ...
                                                                <div className="flex-grow">
                                                                    ...
                                                                    <p className="mb-0">
                                                                        <span className="badge bg-success !text-white">4.5k<i className="ri-heart-3-fill align-middle ms-1"></i></span>
                            ...
                            <div className="xl:col-span-8 col-span-12">
                                <div className="xxl:mt-0 mt-4">
                                    <p className="text-[1.125rem] font-semibold mb-0">Digital Dream Space - NFT Digital Art</p>
                                    <p className="text-[1.125rem] mb-4">
                                        <i className="ri-heart-3-fill text-danger align-middle"></i>
                                        <span className="font-semibold text-[#8c9097] dark:text-white/50"><Link className="text-info text-[0.875rem] ms-2" href="#!" scroll={false}>(2.4k Likes)</Link></span>
                                    </p>
                                    <div className="grid grid-cols-12 mb-6">
                                        <div className="xxl:col-span-3 xl:col-span-12 col-span-12">
                                            ...
                                            <p className="mb-1"><span className="h3"><span className="avatar avatar-sm avatar-rounded p-1 bg-light"><img src="../../../assets/images/crypto-currencies/regular/Ethereum.svg" alt="" /></span>1.299<sup className="text-[0.875rem]">.00</sup></span><span className="ms-3 badge bg-danger/10 text-danger">50% Off</span></p>
                                        ...
                                        <div className="xxl:col-span-5 xl:col-span-6 lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12 xxl:mt-0 mt-4">
                                            <p className="mb-2 text-[.9375rem] font-semibold">Published</p>
                                            <span className="block font-semibold">24, Jul 2023 - 12:45PM</span>
                                        </div>
                                    </div>
                                    <div className="mb-4">
                                        ...
                                        <div className="grid grid-cols-12 sm:gap-x-6 justify-center">
                                            <div className="xxl:col-span-4 xl:col-span-4 lg:col-span-4 md:col-span-4 sm:col-span-4 col-span-12">
                                                <div className="ecommerce-assurance">
                                                    ...
                                                    <p className="text-[0.875rem] font-semibold mb-0">Featured NFT</p>
                                                </div>
                                            </div>
                                    ...
                                    <div className="mb-0">
                                        ...
                                        <div className="grid grid-cols-12 sm:gap-6">
                                            <div className="xxl:col-span-4 xl:col-span-12 lg:col-span-12 md:col-span-12 sm:col-span-12 col-span-12">
                                                <div className="flex items-start mb-4">
                                                    ...
                                                    <div className="leading-none">
                                                        ...
                                                        <p className="mb-0 text-[#8c9097] dark:text-white/50 text-[.6875rem]">Based on (23) ratings</p>
                                                    </div>
                                                </div>
                                                <div className="flex items-center mb-4">
                                                    <div className="text-[0.75rem] me-2 font-semibold">5</div>
                                                    <i className="ri-star-fill text-[0.625rem] me-1"></i>
                                                    <div className="progress progress-xs flex-grow">
                                                        <div className="progress-bar !bg-success !text-white w-[55%]" role="progressbar" aria-valuenow={55} aria-valuemin={0} aria-valuemax={100}>
                                                        </div>
                                                    </div>
                                                    <div className="text-[#8c9097] dark:text-white/50 ms-2 text-[0.75rem]">(10)</div>
                                                </div>
                                                <div className="flex items-center mb-4">
                                                    <div className="text-[0.75rem] me-2 font-semibold">4 </div>
                                                    <i className="ri-star-fill text-[0.625rem] me-1"></i>
                                                    <div className="progress progress-xs flex-grow">
                                                        <div className="progress-bar !bg-success !text-white w-[22%]"  role="progressbar" aria-valuenow={22} aria-valuemin={0} aria-valuemax={100}>
                                                        </div>
                                                    </div>
                                                    <div className="text-[#8c9097] dark:text-white/50 ms-2 text-[0.75rem]">(6)</div>
                                                </div>
                                                <div className="flex items-center mb-4">
                                                    <div className="text-[0.75rem] me-2 font-semibold">3 </div>
                                                    <i className="ri-star-fill text-[0.625rem] me-1"></i>
                                                    <div className="progress progress-xs flex-grow">
                                                        <div className="progress-bar !bg-success !text-white w-[8%]" role="progressbar" aria-valuenow={8} aria-valuemin={0} aria-valuemax={100}>
                                                        </div>
                                                    </div>
                                                    <div className="text-[#8c9097] dark:text-white/50 ms-2 text-[0.75rem]">(4)</div>
                                                </div>
                                                <div className="flex items-center mb-4">
                                                    <div className="text-[0.75rem] me-2 font-semibold">2 </div>
                                                    <i className="ri-star-fill text-[0.625rem] me-1"></i>
                                                    <div className="progress progress-xs flex-grow">
                                                        <div className="progress-bar !bg-warning w-[9%]" role="progressbar" aria-valuenow={9} aria-valuemin={0} aria-valuemax={100}>
                                                        </div>
                                                    </div>
                                                    <div className="text-[#8c9097] dark:text-white/50 ms-2 text-[0.75rem]">(1)</div>
                                                </div>
                                                <div className="flex items-center">
                                                    <div className="text-[0.75rem] me-2 font-semibold">1 </div>
                                                    <i className="ri-star-fill text-[0.625rem] me-1"></i>
                                                    <div className="progress progress-xs flex-grow">
                                                        <div className="progress-bar !bg-danger w-[6%]" role="progressbar" aria-valuenow={6} aria-valuemin={0} aria-valuemax={100}>
                                                        </div>
                                                    </div>
                                                    <div className="text-[#8c9097] dark:text-white/50 ms-2 text-[0.75rem]">(1)</div>
                                                </div>
                                            ...
                                            <div className="xxl:col-span-8 xl:col-span-12 lg:col-span-12 md:col-span-12 sm:col-span-12 col-span-12 xxl:mt-0 mt-4">
                                                <div className="border dark:border-defaultborder/10 p-4">
                                                    <div className="sm:flex block items-start mb-4">
                                                        <div className="flex flex-grow">
                                                            ...
                                                            <div className="leading-none me-2">
                                                                ...
                                                                <div className="mb-1">
                                                                    <i className="ri-star-fill  text-warning align-middle text-[0.75rem]"></i>
                                                                    <i className="ri-star-fill  text-warning align-middle text-[0.75rem]"></i>
                                                                    <i className="ri-star-fill  text-warning align-middle text-[0.75rem]"></i>
                                                                    <i className="ri-star-fill  text-warning align-middle text-[0.75rem]"></i>
                                                                    <i className="ri-star-line text-warning align-middle text-[0.75rem]"></i>
                                                                </div>
                                                                <div className="text-[.6875rem] text-[#8c9097] dark:text-white/50">
                                                    ...
                                                    <div className="product-images sm:!ps-4 !ps-0">
                                                        <div className="grid grid-cols-12 sm:gap-6">
                                                            ...
                                                            <div className="xl:col-span-6 col-span-12 flex items-end sm:justify-end sm:mt-0 mt-2 flex-wrap">
                                                                <button type="button" className="ti-btn !py-1 !px-2 !text-[0.75rem] ti-btn-light me-2">Report abuse</button>
                                                                <button aria-label="button" type="button" className="ti-btn ti-btn-sm ti-btn-primary me-2">
                                                                    <i className="ri-thumb-up-line"></i>
                                                                </button>
                                                                <button aria-label="button" type="button" className="ti-btn ti-btn-sm ti-btn-primary">
