                        ...
                        <div className="box-body">
                            <div className="flex items-center justify-between flex-wrap gap-2">
                                <nav className="flex flex-wrap gap-x-2" aria-label="Tabs" role="tablist">
                                    <Link href="#!" scroll={false} className="hs-tab-active:bg-primary/10 hs-tab-active:text-primary  py-[0.4rem] px-2  text-sm font-medium text-center rounded-sm hover:text-primary active" id="nft-all-item" data-hs-tab="#nft-all" aria-controls="nft-all">
                                        All
                                    </Link>
                                    <Link href="#!" scroll={false} className="hs-tab-active:bg-primary/10 hs-tab-active:text-primary  py-[0.4rem] px-2 text-sm font-medium text-center  rounded-sm hover:text-primary " id="nft-art-item" data-hs-tab="#nft-art" aria-controls="nft-art">
                                        Art
                                    </Link>
                                    <Link href="#!" scroll={false} className="hs-tab-active:bg-primary/10 hs-tab-active:text-primary  py-[0.4rem] px-2 text-sm font-medium text-center  rounded-sm hover:text-primary " id="nft-gaming-item" data-hs-tab="#nft-gaming" aria-controls="nft-gaming">
                                        Gaming
                                    </Link>
                                    <Link href="#!" scroll={false} className="hs-tab-active:bg-primary/10 hs-tab-active:text-primary  py-[0.4rem] px-2 text-sm font-medium text-center  rounded-sm hover:text-primary " id="nft-domain-item" data-hs-tab="#nft-domain" aria-controls="nft-domain">
                                        Domain
                                    </Link>
                                    <Link href="#!" scroll={false} className="hs-tab-active:bg-primary/10 hs-tab-active:text-primary  py-[0.4rem] px-2 text-sm font-medium text-center  rounded-sm hover:text-primary " id="nft-music-item" data-hs-tab="#nft-music" aria-controls="nft-music">
                                        Music
                                    </Link>
                                    <Link href="#!" scroll={false} className="hs-tab-active:bg-primary/10 hs-tab-active:text-primary  py-[0.4rem] px-2 text-sm font-medium text-center  rounded-sm hover:text-primary " id="nft-reaestate-item" data-hs-tab="#nft-realestate" aria-controls="nft-realetste">
                                        Real Estate
                                    </Link>
                                    <Link href="#!" scroll={false} className="hs-tab-active:bg-primary/10 hs-tab-active:text-primary  py-[0.4rem] px-2 text-sm font-medium text-center  rounded-sm hover:text-primary " id="nft-sports-item" data-hs-tab="#nft-sports" aria-controls="nft-sports">
                                        Sports
                                    </Link>
                                    <Link href="#!" scroll={false} className="hs-tab-active:bg-primary/10 hs-tab-active:text-primary  py-[0.4rem] px-2 text-sm font-medium text-center  rounded-sm hover:text-primary " id="nft-fashion-item" data-hs-tab="#nft-fashion" aria-controls="nft-fashion">
                                        Fashion
                                    </Link>
                                    <Link href="#!" scroll={false} className="hs-tab-active:bg-primary/10 hs-tab-active:text-primary  py-[0.4rem] px-2 text-sm font-medium text-center  rounded-sm hover:text-primary " id="nft-avatars-item" data-hs-tab="#nft-avatars" aria-controls="nft-avatars">
                                        Avatars
                                    </Link>
                                    <Link href="#!" scroll={false} className="hs-tab-active:bg-primary/10 hs-tab-active:text-primary  py-[0.4rem] px-2 text-sm font-medium text-center  rounded-sm hover:text-primary " id="nft-memes-item" data-hs-tab="#nft-memes" aria-controls="nft-memes">
                                        Memes
                                    </Link>
                                </nav>
                                <div className="btn-list">
                                    ...
                                    <div className="hs-dropdown ti-dropdown">
                                        <Link href="#!" scroll={false} className="ti-btn !py-1 !px-2 !text-[0.75rem] ti-btn-primary-full" aria-expanded="false">
                                            Sort By<i className="ri-arrow-down-s-line align-middle ms-1 inline-block"></i>
                                        </Link>
                                        <ul className="hs-dropdown-menu ti-dropdown-menu hidden" role="menu">
                                            <li><Link className="ti-dropdown-item" href="#!" scroll={false}>New Collection</Link></li>
                                            <li><Link className="ti-dropdown-item" href="#!" scroll={false}>High - Low</Link></li>
                                            <li><Link className="ti-dropdown-item" href="#!" scroll={false}>Low - High</Link></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div className="xxl:col-span-2 xl:col-span-3 lg:col-span-4 md:col-span-4 sm:col-span-6 col-span-12" key={Math.random()}>
                                        <div className="box custom-box">
                                            ...
                                            <div className="box-body">
                                                ...
                                                <p className="text-[.9375rem] font-semibold mb-2"><Link href="#!" scroll={false}>{idx.heading}</Link></p>
                                ...
                                <div className="xxl:col-span-2 xl:col-span-3 lg:col-span-4 md:col-span-4 sm:col-span-6 col-span-12">
                                    <div className="box custom-box">
                                        ...
                                        <div className="box-body">
                                            ...
                                            <p className="text-[.9375rem] font-semibold mb-2"><Link href="#!" scroll={false}>Surreal Synthesis</Link></p>
                                            <div className="flex flex-wrap align-itesm-center justify-between mb-4">
                                                <div className="font-semibold">
                                                    Highest Bid -
                                                </div>
                                ...
                                <div className="xxl:col-span-2 xl:col-span-3 lg:col-span-4 md:col-span-4 sm:col-span-6 col-span-12">
                                    <div className="box custom-box">
                                        ...
                                        <div className="box-body">
                                            ...
                                            <p className="text-[.9375rem] font-semibold mb-2"><Link href="#!" scroll={false}>Pixel Prism</Link></p>
                                            <div className="flex flex-wrap align-itesm-center justify-between mb-4">
                                                <div className="font-semibold">
                                                    Highest Bid -
                                                </div>
                                ...
                                <div className="xxl:col-span-2 xl:col-span-3 lg:col-span-4 md:col-span-4 sm:col-span-6 col-span-12">
                                    <div className="box custom-box">
                                        ...
                                        <div className="box-body">
                                            ...
                                            <p className="text-[.9375rem] font-semibold mb-2"><Link href="#!" scroll={false}>Meta-Morphosis</Link></p>
                                            <div className="flex flex-wrap align-itesm-center justify-between mb-4">
                                                <div className="font-semibold">
                                                    Highest Bid -
                                                </div>
                                ...
                                <div className="xxl:col-span-2 xl:col-span-3 lg:col-span-4 md:col-span-4 sm:col-span-6 col-span-12">
                                    <div className="box custom-box">
                                        ...
                                        <div className="box-body">
                                            ...
                                            <p className="text-[.9375rem] font-semibold mb-2"><Link href="#!" scroll={false}>Digital Dreamscape</Link></p>
                                            <div className="flex flex-wrap align-itesm-center justify-between mb-4">
                                                <div className="font-semibold">
                                                    Highest Bid -
                                                </div>
                                ...
                                <div className="xxl:col-span-2 xl:col-span-3 lg:col-span-4 md:col-span-4 sm:col-span-6 col-span-12">
                                    <div className="box custom-box">
                                        ...
                                        <div className="box-body">
                                            ...
                                            <p className="text-[.9375rem] font-semibold mb-2"><Link href="#!" scroll={false}>Chromatic Chaos</Link></p>
                                            <div className="flex flex-wrap align-itesm-center justify-between mb-4">
                                                <div className="font-semibold">
                                                    Highest Bid -
                                                </div>
