                                ...
                                <div className="box custom-box">
                                    <div className="box-body !p-4">
                                        <div className="mb-4 overflow-hidden relative">
                                            ...
                                            <Link href="#!" scroll={false} className="nft-btn" aria-label="Like"><i className="ti ti-heart"></i></Link>
                                        ...
                                        <div className="flex justify-between items-start mb-4 flex-wrap">
                                            <div className="inline-flex items-start relative">
                                                <Link aria-label="anchor" href="/pages/profile/" className="stretched-link"></Link>
                                                <div className="me-2">
                                        ...
                                        <div className="text-[.9375rem] font-semibold mb-2"><Link href="#!" scroll={false}>{idx.heading}</Link></div>
                                        <div className="flex items-end flex-wrap gap-2">
                                            ...
                                            <Link href="#!" scroll={false} className="ti-btn ti-btn-primary btn-wave">Place Bid</Link>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="box custom-box overflow-hidden">
                                <div className="box-header justify-between">
                                    ...
                                    <div className="hs-dropdown ti-dropdown">
                                        <Link href="#!" scroll={false} className="p-2 text-[.75rem] text-[#8c9097] dark:text-white/50" aria-expanded="false">
                                            Today<i className="ri-arrow-down-s-line align-middle ms-1 inline-block"></i>
                                        </Link>
                                        <ul className="hs-dropdown-menu ti-dropdown-menu hidden" role="menu">
                                            <li><Link className="ti-dropdown-item" href="#!" scroll={false}>Today</Link></li>
                                            <li><Link className="ti-dropdown-item" href="#!" scroll={false}>This Week</Link></li>
                                            <li><Link className="ti-dropdown-item" href="#!" scroll={false}>Last Week</Link></li>
                                        </ul>
                                    </div>
                                </div>
                                <div className="box-body !p-0">
                                    <ul className="list-group list-group-flush">
                                        <li className="list-group-item !border-t-0 !border-e-0 !border-s-0">
                                            <div className="flex gap-4 items-center flex-wrap">
                                                ...
                                                <div>
                                                    <div className="mb-1"><Link href="#!" scroll={false} className="font-semibold">DreamSpace</Link><span className="text-[.75rem] text-[#8c9097] dark:text-white/50 ms-2">24 mins ago</span></div>
                                                    <div className="text-[.8125rem]">Purchsed from you by <Link className="underline" href="#!" scroll={false}>Mitchell</Link> for <span className="text-success font-semibold text-[.75rem]">0.57ETH</span>.</div>
                                                </div>
                                            </div>
                                        </li>
                                        ...
                                        <li className="list-group-item !border-e-0 !border-s-0">
                                            <div className="flex gap-4 items-center">
                                                ...
                                                <div>
                                                    ...
                                                    <div className="text-[.8125rem]">You showed interest in purchasing <Link href="#!" scroll={false} className="text-[.75rem] text-warning font-semibold">NeoNebulae</Link>.</div>
                                                </div>
                                            </div>
                                        </li>
                                        <li className="list-group-item !border-b-0 !border-e-0 !border-s-0">
                                            <div className="flex gap-4 items-center ">
                                                ...
                                                <div>
                                                    ...
                                                    <div className="text-[.8125rem]">Purchased from <Link href="#!" scroll={false} className="underline">Cyber Canvas</Link> for <span className="font-semibold text-[.75rem] text-pink">1.345ETH</span>.</div>
                                                </div>
                                            </div>
                                        </li>
                                    </ul>
