    ...
    return (
        <div>
                                ...
                                <tbody>
                                    {Table1data.map((idx) => (
                                        <tr className="border-b border-defaultborder" key={Math.random()}>
                                            ...
                                            <td><span className={`badge bg-${idx.color} text-${idx.color1}`}>{idx.text}</span></td>
                                            <td>{idx.mail}</td>
                                            <td>
                                                <div className="hstack gap-2 flex-wrap">
                                                    <Link aria-label="anchor" href="#!" scroll={false} className="text-info text-[.875rem] leading-none me-1"><i
                                                        className="ri-edit-line"></i></Link>
                                                    <Link aria-label="anchor" href="#!" scroll={false} className="text-danger text-[.875rem] leading-none"><i
            ...
            <div className="grid grid-cols-12 gap-6">
                ...
                <div className="xl:col-span-4 col-span-12">
                    <Showcode title="Bordered Success" customCardClass="custom box" code={tabledata4}>
                        <div className="table-responsive">
            ...
            <div className="grid grid-cols-12 gap-6">
                <div className="xl:col-span-6 col-span-12">
                    <Showcode title="Table Without Borders" customCardClass="custom box" code={tabledata6}>
                        <div className="table-responsive">
            ...
            <div className="grid grid-cols-12 gap-6">
                <div className="xl:col-span-6 col-span-12">
                    <Showcode title="Hoverable Rows" code={tabledata16} customCardClass="custom box">
                        <div className="table-responsive">
                            <table className="table whitespace-nowrap table-hover min-w-full ti-custom-table-hover">
                                ...
                                <tbody>
                                    <tr className="border-b border-defaultborder ">
                                        ...
                                        <td>
                                            <div className="progress progress-xs">
                                                <div className="progress-bar bg-primary w-[52%]" role="progressbar" aria-valuenow={52} aria-valuemin={0}
                                                    aria-valuemax={100}>
                                                </div>
                                            </div>
                                        </td>
                                    ...
                                    <tr className="border-b border-defaultborder ">
                                        ...
                                        <td>
                                            <div className="progress progress-xs">
                                                <div className="progress-bar bg-primary w-2/5"  role="progressbar" aria-valuenow={40} aria-valuemin={0}
                                                    aria-valuemax={100}>
                                                </div>
                                            </div>
                                        </td>
                                    ...
                                    <tr className="border-b border-defaultborder ">
                                        ...
                                        <td>
                                            <div className="progress progress-xs">
                                                <div className="progress-bar bg-primary w-[17%]" role="progressbar" aria-valuenow={17} aria-valuemin={0}
                                                    aria-valuemax={100}>
                                                </div>
                                            </div>
                                        </td>
                                    ...
                                    <tr className="border-b border-defaultborder ">
                                        ...
                                        <td>
                                            <div className="progress progress-xs">
                                                <div className="progress-bar bg-primary w-[72%]" role="progressbar" aria-valuenow={72} aria-valuemin={0}
                                                    aria-valuemax={100}>
                                                </div>
                                            </div>
                                        </td>
            ...
            <div className="grid grid-cols-12 gap-6">
                ...
                <div className="xl:col-span-6 col-span-12">
                    <Showcode title="Table Head Secondary" code={tabledata22} customCardClass="custom box">
                        <div className="table-responsive ">
                            <table className="table whitespace-nowrap min-w-full">
            ...
            <div className="grid grid-cols-12 gap-6">
                ...
                <div className="xl:col-span-4 col-span-12">
                    <Showcode title="Table With Top Caption" code={tabledata26} customCardClass="custom box">
                        <div className="table-responsive">
                            <table className="table whitespace-nowrap caption-top w-full">
                            ...
                            <table className="table whitespace-nowrap table-sm min-w-full">
                                ...
                                <tbody>
                                    <tr className="border-b border-defaultborder">
                                        ...
                                        <td>
                                            <div className="hstack flex gap-3 text-[.9375rem]">
                                                <Link aria-label="anchor" href="#!" scroll={false} className="ti-btn ti-btn-icon ti-btn-sm ti-btn-light"><i className="ri-download-2-line"></i></Link>
                                                <Link aria-label="anchor" href="#!" scroll={false} className="ti-btn ti-btn-icon ti-btn-sm ti-btn-light"><i className="ri-edit-line"></i></Link>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr className="border-b border-defaultborder">
                                    ...
                                    <tr className="border-b border-defaultborder">
                                        ...
                                        <td>
                                            <div className="avatar-list-stacked">
                                                ...
                                                <Link className="avatar avatar-sm bg-primary text-white avatar-rounded" href="#!" scroll={false}>
                                                    +4
                                                </Link>
                                            </div>
                                        </td>
                                        <td>
                                            <div className="progress progress-xs">
                                                <div className="progress-bar bg-primary w-[52%]" role="progressbar" aria-valuenow={52} aria-valuemin={0} aria-valuemax={100}>
                                                </div>
                                            </div>
                                        </td>
                                        <td>$10,984.29</td>
                                        <td>
                                            <div className="hstack flex gap-3 text-[.9375rem]">
                                                <Link aria-label="anchor" href="#!" scroll={false} className="ti-btn ti-btn-icon ti-btn-sm ti-btn-success-full"><i className="ri-download-2-line"></i></Link>
                                                <Link aria-label="anchor" href="#!" scroll={false} className="ti-btn ti-btn-icon ti-btn-sm ti-btn-info-full"><i className="ri-edit-line"></i></Link>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr className="border-b border-defaultborder">
                                        <th scope="row"><input className="form-check-input" type="checkbox"  defaultValue="" aria-label="..." /></th>
                                        <td>
                                            <div className="flex items-center">
                                                <span className="avatar avatar-xs me-2 online avatar-rounded">
                                                    <img src="../../assets/images/faces/12.jpg" alt="img" />
                                        ...
                                        <td>
                                            <div className="progress progress-xs">
                                                <div className="progress-bar bg-primary w-[91%]" role="progressbar" aria-valuenow={91} aria-valuemin={0} aria-valuemax={100}>
                                                </div>
                                            </div>
                                        </td>
                                        <td>$1.4billion</td>
