                        ...
                        <div className="box">
                            ...
                            <div className="box-body">
                              <nav className="sm:flex space-x-6 rtl:space-x-reverse">
                                <Link className="px-1 inline-flex items-center gap-2 text-sm whitespace-nowrap text-primary hover:text-primary" href="#!" scroll={false}>
                                  Link
                                </Link>
                                <Link className="px-1 inline-flex items-center gap-2 text-sm font-medium whitespace-nowrap text-primary hover:text-primary" href="#!" scroll={false} aria-current="page">
                                  Active
                                </Link>
                                <Link className="px-1 inline-flex items-center gap-2 text-sm whitespace-nowrap text-primary hover:text-primary" href="#!" scroll={false}>
                                  Link
                                </Link>
                                <Link className="px-1 inline-flex items-center gap-2 text-sm whitespace-nowrap text-gray-400 pointer-events-none dark:text-white/50" href="#!" scroll={false}>
                                  Disabled
                                </Link>
                              </nav>
                            </div>
                        ...
                        <div className="box">
                            ...
                            <div className="box-body">
                              <ul className="list-disc space-x-6 rtl:space-x-reverse">
                                <li className="inline-block"><a className="px-1 inline-flex items-center gap-2 text-sm whitespace-nowrap text-primary hover:text-primary" href="#!">
                                  Link
                                </a></li>
                                <li className="inline-block"><a className="px-1 inline-flex items-center gap-2 text-sm font-medium whitespace-nowrap text-primary hover:text-primary" href="#!" aria-current="page">
                                  Active
                                </a></li>
                                <li className="inline-block"><a className="px-1 inline-flex items-center gap-2 text-sm whitespace-nowrap text-primary hover:text-primary" href="#!">
                                  Link
                                </a></li>
                                <li className="inline-block"><a className="px-1 inline-flex items-center gap-2 text-sm whitespace-nowrap text-gray-400 pointer-events-none dark:text-white/50" href="#!">
                                  Disabled
                                </a></li>
                              </ul>
                            </div>
                ...
                <div className="grid grid-cols-12 gap-x-6">
                          ...
                          <div className="box-body">
                            <div className="flex">
                              <div className="border-e border-gray-200 dark:border-white/10">
                                <nav className="flex flex-col space-y-2 whitespace-nowrap" aria-label="Tabs" data-hs-tabs-vertical="true" role="tablist">
                                  <button type="button" className="hs-tab-active:bg-white hs-tab-active:border-e-transparent  hs-tab-active:text-primary dark:hs-tab-active:bg-transparent !dark:hs-tab-active:border-e-gray-800 dark:hs-tab-active:text-primary -me-px py-2 px-3 inline-flex items-center gap-2 bg-gray-50 text-sm font-medium text-center border text-defaulttextcolor  rounded-s-sm hover:text-primary dark:bg-black/20 dark:border-white/10 dark:text-[#8c9097] dark:text-white/50 dark:hover:text-gray-300 active" id="hs-tab-js-vertical-item-1" data-hs-tab="#hs-tab-js-vertical-1" aria-controls="hs-tab-js-vertical-1">
                                    Tab 1
                                  </button>
                          ...
                          <div className="box-body">
                            <div className="border-b-2 border-gray-200 dark:border-white/10">
                              <nav className="-mb-0.5 flex space-x-6 rtl:space-x-reverse" role="tablist">
                                <Link className="hs-tab-active:font-semibold hs-tab-active:border-primary hs-tab-active:text-primary py-4 px-1 inline-flex items-center gap-2 border-b-[3px] border-transparent text-sm whitespace-nowrap text-defaulttextcolor  dark:text-[#8c9097] dark:text-white/50 hover:text-primary active" href="#!" scroll={false} id="underline-item-1" data-hs-tab="#underline-1" aria-controls="underline-1">
                                  Tab 1
                                </Link>
                                <Link className="hs-tab-active:font-semibold hs-tab-active:border-primary hs-tab-active:text-primary py-4 px-1 inline-flex items-center gap-2 border-b-[3px] border-transparent text-sm whitespace-nowrap text-defaulttextcolor  dark:text-[#8c9097] dark:text-white/50 hover:text-primary" href="#!" scroll={false} id="underline-item-2" data-hs-tab="#underline-2" aria-controls="underline-2">
                                  Tab 2
                                </Link>
                                <Link className="hs-tab-active:font-semibold hs-tab-active:border-primary hs-tab-active:text-primary py-4 px-1 inline-flex items-center gap-2 border-b-[3px] border-transparent text-sm whitespace-nowrap text-defaulttextcolor  dark:text-[#8c9097] dark:text-white/50 hover:text-primary" href="#!" scroll={false} id="underline-item-3" data-hs-tab="#underline-3" aria-controls="underline-3">
                                  Tab 3
                                </Link>
                              </nav>
                            </div>
                      ...
                      <div className="box">
                          ...
                          <div className="box-body">
                            <div className="sm:border-b-2 border-gray-200 dark:border-white/10">
                              <nav className="-mb-0.5 sm:flex sm:space-x-6 rtl:space-x-reverse" role="tablist">
                                <Link className="w-full sm:w-auto hs-tab-active:font-semibold hs-tab-active:border-primary hs-tab-active:text-primary py-4 px-1 inline-flex items-center gap-2 border-b-[3px] border-transparent text-sm whitespace-nowrap text-defaulttextcolor dark:text-[#8c9097] dark:text-white/50 hover:text-primary" href="#!" scroll={false} id="icon-item-1" data-hs-tab="#icon-1" aria-controls="icon-1">
                                ...
                                <Link className="w-full sm:w-auto hs-tab-active:font-semibold hs-tab-active:border-primary hs-tab-active:text-primary py-4 px-1 inline-flex items-center gap-2 border-b-[3px] border-transparent text-sm whitespace-nowrap text-defaulttextcolor dark:text-[#8c9097] dark:text-white/50 hover:text-primary active" href="#!" scroll={false}  id="icon-item-2" data-hs-tab="#icon-2" aria-controls="icon-2">
                                  <svg className="w-3.5 h-3.5" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                                ...
                                <Link className="w-full sm:w-auto hs-tab-active:font-semibold hs-tab-active:border-primary hs-tab-active:text-primary py-4 px-1 inline-flex items-center gap-2 border-b-[3px] border-transparent text-sm whitespace-nowrap text-defaulttextcolor dark:text-[#8c9097] dark:text-white/50 hover:text-primary" href="#!" scroll={false} id="icon-item-3" data-hs-tab="#icon-3" aria-controls="icon-3">
                                  <svg className="w-3.5 h-3.5" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                      ...
                      <div className="box">
                          ...
                          <div className="box-body">
                            <div className="sm:border-b border-gray-200 dark:border-white/10">
                              <nav className="sm:flex sm:space-x-2 sm:rtl:space-x-reverse" aria-label="Tabs" role="tablist">
                      ...
                      <div className="box">
                          ...
                          <div className="box-body">
                              <div className="sm:flex bg-gray-100 hover:bg-gray-200 rounded-sm transition p-1 dark:bg-black/20 dark:hover:bg-black/20">
                                <nav className="sm:flex sm:space-x-2 sm:rtl:space-x-reverse" role="tablist">
                                  <Link className="w-full sm:w-auto hs-tab-active:bg-white hs-tab-active:text-gray-700 dark:hs-tab-active:bg-light dark:hs-tab-active:text-defaulttextcolor/70 py-2 px-3 inline-flex items-center gap-2 bg-transparent text-sm text-defaulttextcolor hover:text-gray-700 font-medium rounded-sm hover:hover:text-primary dark:text-[#8c9097] dark:text-white/50 dark:hover:text-white active" href="#!" scroll={false}  id="segment-item-1" data-hs-tab="#segment-1" aria-controls="segment-1">
                                    Active
                                  </Link>
                                  <Link className="w-full sm:w-auto hs-tab-active:bg-white hs-tab-active:text-gray-700 dark:hs-tab-active:bg-light dark:hs-tab-active:text-defaulttextcolor/70 py-2 px-3 inline-flex items-center gap-2 bg-transparent text-sm text-defaulttextcolor hover:text-gray-700 font-medium rounded-sm hover:hover:text-primary dark:text-[#8c9097] dark:text-white/50 dark:hover:text-white" href="#!" scroll={false} id="segment-item-2" data-hs-tab="#segment-2" aria-controls="segment-2">
                                    Link
                                  </Link>
                                  <Link className="w-full sm:w-auto hs-tab-active:bg-white hs-tab-active:text-gray-700 dark:hs-tab-active:bg-light dark:hs-tab-active:text-defaulttextcolor/70 py-2 px-3 inline-flex items-center gap-2 bg-transparent text-sm text-defaulttextcolor hover:text-gray-700 font-medium rounded-sm hover:hover:text-primary dark:text-[#8c9097] dark:text-white/50 dark:hover:text-white" href="#!" scroll={false} id="segment-item-3" data-hs-tab="#segment-3" aria-controls="segment-3">
                                    Link
                                  </Link>
                                  <Link className="w-full sm:w-auto hs-tab-active:bg-white hs-tab-active:text-gray-700 dark:hs-tab-active:bg-light dark:hs-tab-active:text-defaulttextcolor/70 py-2 px-3 inline-flex items-center gap-2 bg-transparent text-sm text-defaulttextcolor font-medium rounded-sm pointer-events-none dark:text-white/50 dark:hover:text-white" href="#!" scroll={false} id="segment-item-4" data-hs-tab="#segment-4">
                                    Disabled
                                  </Link>
                                </nav>
                              </div>
                  ...
                  <div className="col-span-12 md:col-span-6 xxl:!col-span-4">
                      <div className="box">
                          ...
                          <div className="box-body">
                            <nav className="sm:flex sm:space-x-2 rtl:space-x-reverse" aria-label="Tabs" role="tablist">
                      ...
                      <div className="box">
                          ...
                          <div className="box-body">
                            <div className="border-b border-gray-200 dark:border-white/10">
                              <nav className="-mb-0.5 flex justify-center space-x-6 rtl:space-x-reverse" aria-label="Tabs" role="tablist">
                  ...
                  <div className="col-span-12 md:col-span-6 xxl:!col-span-4">
                      <div className="box">
                          ...
                          <div className="box-body">
                            <div className="border-b border-gray-200 dark:border-white/10">
                              <nav className="-mb-0.5 flex justify-end space-x-6 rtl:space-x-reverse" aria-label="Tabs" role="tablist">
