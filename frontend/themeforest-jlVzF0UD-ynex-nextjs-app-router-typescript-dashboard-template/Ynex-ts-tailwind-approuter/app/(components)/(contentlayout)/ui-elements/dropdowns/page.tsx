...
const Dropdowns = () => {
    return (
        <div>
                        ...
                        <div className="ti-btn-list flex align-center flex-wrap">
                            <div className="hs-dropdown ti-dropdown me-2">
                                ...
                                <ul className="hs-dropdown-menu ti-dropdown-menu hidden"
                                    ...
                                    <li><Link className="ti-dropdown-item" href="#!" scroll={false}>Another
                                        action</Link></li>
                                    <li><Link className="ti-dropdown-item" href="#!" scroll={false}>Something else
                                        here</Link></li>
                                </ul>
                            </div>
                            <div className="hs-dropdown ti-dropdown">
                                <Link className="ti-btn ti-btn-secondary-full ti-dropdown-toggle !py-2"
                                    href="#!" scroll={false} id="dropdownMenuLink" aria-expanded="false">
                                    Dropdown link<i
                                        className="ri-arrow-down-s-line align-middle ms-1 inline-block"></i>
                                </Link>
                                <ul className="hs-dropdown-menu ti-dropdown-menu hidden"
                        ...
                        <div className="ti-btn-list">
                            {SingleButtons.map((idx) => (
                                <div className="ti-btn-group" key={Math.random()}>
                                    <div className="hs-dropdown ti-dropdown [--placement:bottom-left] rtl:[--placement:bottom-right]">
                                        ...
                                        <ul className="hs-dropdown-menu ti-dropdown-menu hidden"
                                            ...
                                            <li><Link className="ti-dropdown-item" href="#!" scroll={false}>Action</Link>
                                            </li>
                                            <li><Link className="ti-dropdown-item" href="#!" scroll={false}>Another
                                                action</Link></li>
                                            <li><Link className="ti-dropdown-item" href="#!" scroll={false}>Something
                                                else here</Link></li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div className="ti-btn-list">
                            {SingleButtons.map((idx) => (
                                <div className="ti-btn-group !m-0" key={Math.random()}>
                                    <div className="hs-dropdown ti-dropdown [--placement:bottom-left] rtl:[--placement:bottom-right]">
                                        <button
                                            className={`ti-btn ti-btn-${idx.class}-full !rounded-tr-none !rounded-br-none rtl:!rounded-tl-none rtl:!rounded-bl-none  rtl:!rounded-tr-sm rtl:!rounded-br-sm  -me-[4px] !pt-[4.45px]`}
                                        ...
                                        <div className="hs-dropdown ti-dropdown [--placement:bottom-left] rtl:[--placement:bottom-right]">
                                            <button id="hs-split-dropdown" type="button"
                                                className={`ti-btn ti-btn-${idx.class}-full opacity-[0.85] !rounded-tl-none !rounded-bl-none rtl:!rounded-tr-none rtl:!rounded-br-none  rtl:!rounded-tl-sm rtl:!rounded-bl-sm -ms-[4px] !pt-[4.45px] pb-[0.4rem]`}>
                                                <span className="sr-only">Toggle Dropdown</span>
                                                <i className="ri-arrow-down-s-line align-middle inline-block"
                                                ></i>
                                            </button>
                                            <ul className="hs-dropdown-menu ti-dropdown-menu hidden"
                ...
                <div className="xl:col-span-6 col-span-12">
                    <Showcode title="Dropdown Sizing" code={dropdown7}>
                        <div className="ti-btn-group my-1 me-2 ti-dropdown hs-dropdown">
                            ...
                            <ul className="hs-dropdown-menu ti-dropdown-menu hidden">
                                <li><Link className="ti-dropdown-item" href="#!" scroll={false}>Action</Link></li>
                                <li><Link className="ti-dropdown-item" href="#!" scroll={false}>Another action</Link>
                                </li>
                                <li><Link className="ti-dropdown-item" href="#!" scroll={false}>Something else
                                    here</Link></li>
                                <li>
                                ...
                                <li><Link className="ti-dropdown-item" href="#!" scroll={false}>Separated link</Link>
                                </li>
                            </ul>
                        </div>
                        <div className="ti-btn-group my-1 me-2">
                            <div className="hs-dropdown ti-dropdown">
                                <button
                                    className="ti-btn-lg !py-[0.75rem] !px-[1rem] ti-dropdown-toggle ti-btn-light !rounded-tr-none !rounded-br-none rtl:!rounded-tl-none rtl:!rounded-bl-none  rtl:!rounded-tr-sm rtl:!rounded-br-sm  -me-[4px]"
                                ...
                                <div className="hs-dropdown ti-dropdown [--placement:bottom-left]">
                                    <button id="hs-split-dropdown" type="button"
                                        className="ti-btn-lg !py-[0.75rem] !px-[1rem] ti-btn-light hover:!bg-light !rounded-tl-none !rounded-bl-none rtl:!rounded-tr-none rtl:!rounded-br-none  rtl:!rounded-tl-sm rtl:!rounded-bl-sm ti-dropdown-toggle -ms-[4px]">
                                        <span className="sr-only">Toggle Dropdown</span>
                                        <i className="ri-arrow-down-s-line align-middle inline-block"
                                        ></i>
                                    </button>
                        ...
                        <div className="ti-btn-group my-1 me-2">
                            <div className="ti-btn-group my-1 me-2 ti-dropdown hs-dropdown">
                                ...
                                <ul className="hs-dropdown-menu ti-dropdown-menu hidden">
                                    ...
                                    <li><Link className="ti-dropdown-item" href="#!" scroll={false}>Separated
                                        link</Link></li>
                                </ul>
                            </div>
                        </div>
                        <div className="ti-btn-group my-1 me-2">
                            <div className="hs-dropdown ti-dropdown">
                                <button
                                    className="ti-btn !py-1 !px-2 !text-[0.75rem] ti-btn-light !rounded-tr-none !rounded-br-none rtl:!rounded-tl-none rtl:!rounded-bl-none  rtl:!rounded-tr-sm rtl:!rounded-br-sm  -me-[4px]"
                                ...
                                <div className="hs-dropdown ti-dropdown [--placement:bottom-left]">
                                    <button id="hs-split-dropdown" type="button"
                                        className="ti-btn !py-1 !px-2 hover:!bg-light  ti-btn-light opacity-[0.85] !rounded-tl-none !rounded-bl-none rtl:!rounded-tr-none rtl:!rounded-br-none  rtl:!rounded-tl-sm rtl:!rounded-bl-sm ti-dropdown-toggle -ms-[4px]  pb-[0.4rem]">
                                        <span className="sr-only">Toggle Dropdown</span>
                                        <i className="ri-arrow-down-s-line align-middle inline-block"
                                        ></i>
                                    </button>
            ...
            <div className="grid grid-cols-12 gap-6">
                <div className="xl:col-span-3 col-span-12">
                    <Showcode title="Dropup" code={dropdown8}>
                        <div className="hs-dropdown ti-dropdown [--placement:top-left] rtl:[--placement:bottom-right] m-1">
                ...
                <div className="xl:col-span-3 col-span-12">
                    <Showcode title="Active" code={dropdown11}>
                        <div className="hs-dropdown ti-dropdown">
                            ...
                            <ul className="hs-dropdown-menu ti-dropdown-menu hidden">
                                <li><Link className="ti-dropdown-item" href="#!" scroll={false}>Regular link</Link></li>
                                <li><Link className="ti-dropdown-item active" href="#!"
                                    aria-current="true">Active
                                    link</Link>
                                </li>
                                <li><Link className="ti-dropdown-item" href="#!" scroll={false}>Another link</Link></li>
                            </ul>
                        </div>
                    </Showcode>
                </div>
            ...
            <div className="grid grid-cols-12 gap-6">
                            ...
                            <div className="ti-btn-group">
                                <div className="hs-dropdown ti-dropdown">
                                    ...
                                    <ul className="hs-dropdown-menu ti-dropdown-menu hidden"
                                        ...
                                        <li><Link className="ti-dropdown-item" href="#!" scroll={false}>Menu item</Link>
                                        </li>
                                        <li><Link className="ti-dropdown-item" href="#!" scroll={false}>Menu item</Link>
                                        </li>
                                        <li><Link className="ti-dropdown-item" href="#!" scroll={false}>Menu item</Link>
                ...
                <div className="xl:col-span-3 col-span-12">
                    <Showcode title="Dropdowns With Forms" code={dropdown14}>
                        <div className="hs-dropdown ti-dropdown  [--auto-close:inside]">
                            <button className="ti-btn ti-btn-secondary-full ti-dropdown-toggle !py-2" id="hs-dropdown-auto-close-inside" type="button"
                                aria-expanded="false">
                                Dropdown<i className="ri-arrow-down-s-line align-middle inline-block"></i>
                            </button>
                            <div className="hs-dropdown-menu ti-dropdown-menu hidden" aria-labelledby="hs-dropdown-auto-close-inside">
                                ...
                                <Link className="ti-dropdown-item" href="#!" scroll={false}>New around here? Sign
                                    up</Link>
                                <Link className="ti-dropdown-item" href="#!" scroll={false}>Forgot password?</Link>
                            </div>
                        </div>
                    </Showcode>
                </div>
            ...
            <div className="grid grid-cols-12 gap-6">
                <div className="xl:col-span-9 col-span-12">
                    <Showcode title="Alignment Options" code={dropdown15}>
                        <div className="ti-btn-list">
                            <div className='ti-btn-group' >
                                <div className="ti-dropdown hs-dropdown [--placement:bottom-left] rtl:[--placement:bottom-right]">
                            ...
                            <div className='ti-btn-group' >
                                <div className="hs-dropdown ti-dropdown [--placement:right-top] m-1 rtl:[--placement:bottom-right]">
            ...
            <div className="grid grid-cols-12 gap-6">
                <div className="xl:col-span-6 col-span-12">
                    <Showcode title="Custom Dropdown Menus's" code={dropdown17}>
                        <div className="ti-btn-list flex flex-wrap gap-x-2">
                            ...
                            <div className="ti-dropdown hs-dropdown">
                                ...
                                <ul className="hs-dropdown-menu ti-dropdown-menu dropmenu-item-warning hidden">
                                    <li><Link className="ti-dropdown-item active" href="#!" scroll={false}>Active</Link>
                                    </li>
                                    <li><Link className="ti-dropdown-item" href="#!" scroll={false}>Action</Link></li>
                                    <li><Link className="ti-dropdown-item" href="#!" scroll={false}>Another
                                        action</Link></li>
            ...
            <div className="grid grid-cols-12 gap-6">
                ...
                <div className="xl:col-span-3 col-span-12">
                    <Showcode title="Dropdown Dividers" code={dropdown21}>
                        <div className="bd-example">
                            <ul className="dropdown-menu border dark:border-defaultborder/10 shadow-sm">
                                <li><Link className="dropdown-header" href="#!" scroll={false}>Heading</Link></li>
                                <li><Link className="ti-dropdown-item" href="#!" scroll={false}>Action</Link></li>
                                <li><Link className="ti-dropdown-item" href="#!" scroll={false}>Another action</Link>
                                </li>
                                <li><Link className="ti-dropdown-item" href="#!" scroll={false}>Something else
