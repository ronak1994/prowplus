"use client"
import { breadcrumb1, breadcrumb2, breadcrumb3, breadcrumb4, breadcrumb5} from '@/shared/data/prism/uielementsprism'
    ...
    <div>
      ...
      <div className="grid grid-cols-12 gap-x-6">
        <div className="col-span-12">
              <Showcode title="Basic Breadcrumb" code={breadcrumb1}>
        ...
        <div className="col-span-12">
            <Showcode title="Breadcrumb Style-1" code={breadcrumb2}>
              <ol className="flex items-center whitespace-nowrap min-w-0">
                <li className="text-sm">
                  <Link className="flex items-center text-primary hover:text-primary dark:text-primary" href="#!" scroll={false}>
                    Home
        ...
        <div className="col-span-12">
            <Showcode title="Basic Breadcrumb-style-2" code={breadcrumb3}>
              <ol className="flex items-center whitespace-nowrap min-w-0">
        ...
        <div className="col-span-12">
            <Showcode title="Breadcrumb With Icons" code={breadcrumb4}>
              <ol className="flex items-center whitespace-nowrap min-w-0">
                <li className="text-sm">
                  <Link className="flex items-center text-primary hover:text-primary dark:text-primary" href="#!" scroll={false}>
        ...
        <div className="col-span-12">
            <Showcode title="Breadcrumb-style-3" code={breadcrumb5}>
