"use client"
import { blackquote1, blackquote2, blackquote3, blackquote4, blackquote5, blackquote6, blackquote7, blackquote8, blackquote9 } from '@/shared/data/prism/uielementsprism'
...
const Blackquotes = () => {
  return (
    <>
        ...
        <Seo title={"Blockquotes"} />
            <Pageheader currentpage="Blockquotes" activepage="Ui Elements" mainpage="Blockquotes" />
            <div className="grid grid-cols-12 gap-x-6">
                    <div className="col-span-12">
                            <Showcode title="Basic Blockquote" code={blackquote1} customCardBodyClass="">
                    ...
                    <div className="col-span-12">
                            <Showcode title="Small Blockquote" code={blackquote2} customCardBodyClass="">
                                <blockquote className="relative">
                                    <svg className="absolute top-0 ltr:left-0 rtl:right-0 transform -translate-x-6 -translate-y-8 h-16 w-16 text-gray-100 dark:text-white/10"
                                        width="16" height="16" viewBox="0 0 16 16" fill="none"
                                        xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                    ...
                    <div className="col-span-12">
                            <Showcode title="Medium Blockquote" code={blackquote3} customCardBodyClass="">
                                <blockquote className="relative">
                                    <svg className="absolute top-0 ltr:left-0 rtl:right-0 transform -translate-x-6 -translate-y-8 h-16 w-16 text-gray-100 dark:text-white/10"
                                        width="16" height="16" viewBox="0 0 16 16" fill="none"
                                        xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                    ...
                    <div className="col-span-12">
                            <Showcode title="Large Blockquote" code={blackquote4} customCardBodyClass="">
                                <blockquote className="relative">
                                    <svg className="absolute top-0 ltr:left-0 rtl:right-0 transform -translate-x-6 -translate-y-8 h-16 w-16 text-gray-100 dark:text-white/10"
                                        width="16" height="16" viewBox="0 0 16 16" fill="none"
                                        xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                    ...
                    <div className="col-span-12">
                            <Showcode title="Center Aligned Blockquote" code={blackquote5} customCardBodyClass="">
                    ...
                    <div className="col-span-12">
                            <Showcode title="Right Aligned Blockquote" code={blackquote6} customCardBodyClass="">
                    ...
                    <div className="col-span-12">
                            <Showcode title="Naming A Source" code={blackquote7} customCardBodyClass="">
                                <blockquote className="relative">
                                    <svg className="absolute top-0 ltr:left-0 rtl:right-0 transform -translate-x-6 -translate-y-8 h-16 w-16 text-gray-100 dark:text-white/10"
                                        width="16" height="16" viewBox="0 0 16 16" fill="none"
                                        xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                    ...
                    <div className="col-span-12">
                            <Showcode title="Blockquote With Avatar" code={blackquote8} customCardBodyClass="">
                                <blockquote className="relative">
                                    <svg className="absolute top-0 ltr:left-0 rtl:right-0 transform -translate-x-6 -translate-y-8 h-16 w-16 text-gray-100 dark:text-white/10"
                                        width="16" height="16" viewBox="0 0 16 16" fill="none"
                                        xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                    ...
                    <div className="col-span-12">
                            <Showcode title="Left Bordered Blockquote" code={blackquote9} customCardBodyClass="">
                                <blockquote
