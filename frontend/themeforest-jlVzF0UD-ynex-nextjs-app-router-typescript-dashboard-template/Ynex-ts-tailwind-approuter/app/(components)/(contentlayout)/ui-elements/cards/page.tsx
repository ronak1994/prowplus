        ...
        <>
            ...
            <div className="grid grid-cols-12 md:gap-x-6">
                    ...
                    <div className="box">
                        ...
                        <div className="box-body">
                            ...
                            <p className="card-text text-[#8c9097] dark:text-white/50 mb-4">when an unknown printer took a galley of type
                                ...
                                unchanged.</p>
                            <Link href="#!" scroll={false} className="ti-btn ti-btn-primary-full">Read More</Link>
                        </div>
                ...
                <div className="xxl:col-span-3 xl:col-span-6 lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12">
                    ...
                    <div className="box">
                        ...
                        <div className="box-footer">
                            <Link href="#!" scroll={false} className="card-link text-danger m-1">Buy Now</Link>
                            <Link href="#!" scroll={false} className="card-link text-success m-1"><u>Review</u></Link>
                        </div>
                    </div>
                </div>
                <div className="xxl:col-span-3 xl:col-span-6 lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12">
                ...
                <div className="xxl:col-span-3 xl:col-span-6 lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12">
                    <div className="box">
                        ...
                        <div className="box-body">
                            <Link href="#!" scroll={false} className="card-link text-primary me-2">Card link</Link>
                            <Link href="#!" scroll={false} className="card-link text-secondary inline-block">Another
                                link</Link>
                        </div>
                    </div>
                </div>
                            ...
                            <div className="box">
                                <div className="box-body">
                                    <img src="../../assets/images/media/media-25.jpg" className="card-img mb-4 !rounded-md"
                                        alt="..." />
                                    <p className="box-title !font-semibold">Product A</p>
                                    <p className="card-text mb-4">With supporting text below as a natural
                                        lead-in to additional content.</p>
                                    <Link href="#!" scroll={false} className="ti-btn ti-btn-primary-full">Purchase</Link>
                                </div>
                            </div>
                        </div>
                        <div className="xl:col-span-4 col-span-12">
                            <div className="box">
                                <div className="box-body">
                                    <img src="../../assets/images/media/media-26.jpg" className="card-img mb-4 !rounded-md"
                                        alt="..." />
                                    <p className="box-title !font-semibold">Product B</p>
                                    <p className="card-text mb-4">With supporting text below as a natural
                                        lead-in to additional content.</p>
                                    <Link href="#!" scroll={false} className="ti-btn ti-btn-secondary-full">Purchase</Link>
                                </div>
                            </div>
                        </div>
                        <div className="xl:col-span-4 col-span-12">
                            <div className="box">
                                <div className="box-body">
                                    <img src="../../assets/images/media/media-27.jpg" className="card-img mb-4 !rounded-md"
                                        alt="..." />
                                    <p className="box-title !font-semibold">Product-C</p>
                                    <p className="card-text mb-4">With supporting text below as a natural
                                        lead-in to additional content.</p>
                                    <Link href="#!" scroll={false} className="ti-btn ti-btn-light">Purchase</Link>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="xl:col-span-4 col-span-12">
                            <div className="box">
                                <div className="box-body">
                                    ...
                                    <h6 className="box-title !font-medium">Where it come from</h6>
                                    ...
                                    <Link href="#!" scroll={false} className="ti-btn ti-btn-primary-full">Go
                                        somewhere</Link>
                                </div>
                            </div>
                        </div>
                        <div className="xl:col-span-4 col-span-12">
                            <div className="box text-center">
                                <div className="box-body">
                                    ...
                                    <p className="box-title !font-semibold">Why do we use it?</p>
                        ...
                        <div className="xl:col-span-4 col-span-12">
                            <div className="box text-end">
                                <div className="box-body">
                                    ...
                                    <p className="box-title !font-semibold">What is special?</p>
                        ...
                        <div className="box-header">
                            <div className="flex align-center w-full">
                                ...
                                <div className="hs-dropdown ti-dropdown ms-auto my-auto">
                                    <Link aria-label="anchor" href="#!" scroll={false} className="ti-btn ti-btn-icon ti-btn-sm ti-btn-light !mb-0">
                                        <i className="fe fe-more-vertical"></i>
                                    </Link>
                                    <ul className="hs-dropdown-menu ti-dropdown-menu hidden">
                                        <li><Link className="ti-dropdown-item" href="#!" scroll={false}>Week</Link></li>
                                        <li><Link className="ti-dropdown-item" href="#!" scroll={false}>Month</Link></li>
                                        <li><Link className="ti-dropdown-item" href="#!" scroll={false}>Year</Link></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                ...
                <div className="xl:col-span-3 col-span-12">
                    <div className="box text-center">
                        ...
                        <div className="box-body">
                            ...
                            <Link href="#!" scroll={false} className="ti-btn ti-btn-primary-full mt-2 me-2">Read More</Link>
                            <Link href="#!" scroll={false} className="ti-btn ti-btn-outline-secondary mt-2">Close</Link>
                        </div>
                ...
                <div className="xl:col-span-4 col-span-12">
                    <div className="box">
                        <div className="box-header justify-between">
                            ...
                            <button type="button" className="hs-collapse-toggle text-defaulttextcolor dark:text-defaulttextcolor/70 inline-flex items-center gap-x-2 text-sm font-semibold  disabled:opacity-50 disabled:pointer-events-none open" id="hs-basic-collapse" data-hs-collapse="#hs-basic-collapse-heading">
                        ...
                        <div id="hs-basic-collapse-heading" className="hs-collapse open w-full  overflow-hidden  transition-[height] duration-100" aria-labelledby="hs-basic-collapse">
                                <div className="box-body">
                                ...
                                <div className="box-footer"> <button type="button" className="ti-btn ti-btn-primary-full">Read
                                    More</button> </div>
                              </div>
                    </div>
                </div>
                    ...
                    <div className="box" id="dismiss-alert222">
                        <div className="box-header justify-between">
                            ...
                            <button type="button"
                                ...
                                data-hs-remove-element="#dismiss-alert222">
                ...
                <div className="xl:col-span-4 col-span-12">
                    <div className={`box ${isFullscreen ? "box-fullscreen" : ""}`}>
                        <div className="box-header justify-between">
                            ...
                            <Link aria-label="anchor" href="#!" scroll={false} className="terms-fullscreen" onClick={handleFullscreenClick}>
                                    ...
                                    <ul className="nav nav-tabs box-header-tabs ms-1 flex   gap-2 items-center">
                                        <li className="nav-item">
                                            <Link className="nav-link active !py-2 !px-4" aria-current="true"
                                                href="#!" scroll={false}>Active</Link>
                                        </li>
                                        <li className="nav-item">
                                            <Link className="nav-link" href="#!" scroll={false}>Link</Link>
                                        </li>
                                        <li className="nav-item">
                                            <Link href="#!" scroll={false} className="nav-link disabled">Disabled</Link>
                                        </li>
                                    </ul>
                                </div>
                                <div className="box-body">
                            ...
                            <div className="box-body">
                                <div className="flex items-center w-full">
                                    ...
                                    <div className="ms-auto">
                                        <Link aria-label="anchor" href="#!" scroll={false} className={`text-${idx.class}`}><i className="bi bi-three-dots-vertical"></i></Link>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="box border border-primary !rounded-md">
                        <div className="box-body ">
                            <p className="text-[.875rem] font-semibold mb-2 leading-none">Home Page Design
                                <Link aria-label="anchor" href="#!" scroll={false}><i
                    ...
                    <div className="box border border-primary !rounded-md">
                        <div className="box-body">
                            ...
                            <div className="flex flex-wrap gap-2 mb-4">
                                ...
                                <span className="badge bg-tealmain/10 text-teal">Codeignitor</span>
            ...
            <div className="grid grid-cols-12 gap-6">
                <div className="xxl:col-span-3 xl:col-span-12 col-span-12">
                    <div className="box">
                        <Link aria-label="anchor" href="#!" scroll={false} className="card-anchor"></Link>
                        <img src="../../assets/images/media/media-23.jpg" className="card-img-top" alt="..." />
                        <div className="box-body">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                ...
                <div className="grid grid-cols-12 gap-x-6 mb-4 gap-y-3">
                    <div className="xl:col-span-6 lg:col-span-12 col-span-12">
                        ...
                        <div
                            className="grid border rounded-xl shadow-sm divide-y overflow-hidden sm:flex sm:divide-y-0 sm:divide-x dark:border-white/10 dark:divide-white/10">
                            <div className="flex flex-col flex-[1_0_0%] bg-white dark:bg-bodybg">
                                <img className="w-full h-auto rounded-t-xl sm:rounded-se-none"
                                    src="../../assets/images/media/media-27.jpg" alt="Image Description"/>
                            ...
                            <div className="flex flex-col flex-[1_0_0%] bg-white dark:bg-bodybg">
                                <img className="w-full h-auto" src="../../assets/images/media/media-28.jpg"
                            ...
                            <div className="flex flex-col flex-[1_0_0%] bg-white dark:bg-bodybg">
                                <img className="w-full h-auto sm:rounded-se-xl" src="../../assets/images/media/media-29.jpg"
                                    alt="Image Description"/>
                                <div className="p-4 flex-1 md:p-5">
                                    <h3 className="text-lg font-bold text-gray-800 dark:text-white">
                                        Card title
                    ...
                    <div className="xl:col-span-3 lg:col-span-6 col-span-12">
                        ...
                        <a className="flex flex-col group bg-white border shadow-sm rounded-xl overflow-hidden hover:shadow-lg transition dark:bg-bodybg dark:border-white/10"
                            href="#!">
                            <div className="relative pt-[50%] sm:pt-[60%] lg:pt-[80%] rounded-t-xl overflow-hidden">
                                <img className="size-full absolute top-0 start-0 object-cover group-hover:scale-105 transition-transform duration-500 ease-in-out rounded-t-xl"
                                    src="../../assets/images/media/media-30.jpg" alt="Image Description"/>
                            </div>
                            <div className="box-body">
                                <h3 className="text-lg font-bold text-gray-800 dark:text-white">
                                    Card title
                    ...
                    <div className="xl:col-span-3 lg:col-span-6 col-span-12">
                        ...
                        <a className="flex flex-col bg-white border shadow-sm rounded-xl hover:shadow-lg transition dark:bg-bodybg dark:border-white/10"
                            href="#!">
                            <img className="w-full h-auto rounded-t-xl" src="../../assets/images/media/media-30.jpg"
                                alt="Image Description"/>
                            <div className="box-body">
                                <h3 className="text-lg font-bold text-gray-800 dark:text-white">
                                    Card title
