        ...
        <div>
            ...
            <div className="grid grid-cols-12 gap-6">
                <div className="xl:col-span-9 col-span-12">
                    <Showcode title="Basic Toasts" code={toast1}>
            ...
            <div className="grid grid-cols-12 gap-6">
                ...
                <div className="xl:col-span-6 col-span-12">
                    <Showcode title="Light Colored Toasts" code={toast4}>
                        <div className="space-y-3">
                            {ColorToasts.map((idx) => (
                                <div key={Math.random()}>
                                    <div id={`dismiss-toast-light-${idx.id}`} className={`ti-toast bg-${idx.color2}/10 text-sm text-${idx.color2}`} role="alert">
                                        <div className="flex p-4">
                                            Hello, world! This is a toast message.

                                            <div className="ms-auto">
                                                <button type="button"
                                                    className={`inline-flex flex-shrink-0 justify-center items-center h-4 w-4 rounded-sm text-${idx.color2}  focus:outline-none focus:ring-0 focus:ring-offset-0 focus:ring-offset-white/10 focus:ring-gray-600 transition-all text-sm dark:focus:ring-offset-white/10 dark:focus:ring-white/10`} data-hs-remove-element={`#dismiss-toast-light-${idx.id}`}>
                                                    <span className="sr-only">Close</span>
                                                    <svg className="w-3.5 h-3.5" width="16" height="16"
                                                        viewBox="0 0 16 16" fill="none"
                                                        xmlns="http://www.w3.org/2000/svg">
