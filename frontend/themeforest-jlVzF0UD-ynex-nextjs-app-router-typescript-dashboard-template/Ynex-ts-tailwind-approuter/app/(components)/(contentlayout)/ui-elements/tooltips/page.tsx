                    ...
                    <Showcode title="Tooltip Directions" code={tooltip1}>
                        <div className="ti-btn-list">
                            {tooltipdirection.map((idx) => (
                                <div className={`hs-tooltip ti-main-tooltip ${idx.class} me-1`} key={Math.random()}>
                            ...
                            {colortooltip.map((idx) => (
                                <div className={`hs-tooltip ti-main-tooltip ${idx.class} me-1`} key={Math.random()}>
                                    <button type="button" className={`hs-tooltip-toggle ti-btn ti-btn-${idx.color}`}>
                                        {idx.text}
                                        <span
                                            className={`hs-tooltip-content ti-main-tooltip-content py-1 px-2 !bg-${idx.class1} !text-xs !font-medium !text-${idx.class2} dark:!text-white shadow-sm dark:bg-slate-700`}
                                            role="tooltip">
                                            {idx.text}
                                        </span>
                                    </button>
                    ...
                    <Showcode title="Tooltips On Links" code={tooltip3}>
                        <div className="hs-tooltip ti-main-tooltip [--placement:top]">
                            <p className="text-muted mb-0">
                                Hover on the link to view the <Link aria-label="anchor" href="#!" scroll={false}
