            ...
            <div className="grid grid-cols-12 gap-x-6">
                ...
                <div className="xl:col-span-6 col-span-12">
                    <Showcode title="Button Tags" code={buttons11}>
                        <div className="ti-btn-list space-x-2 rtl:space-x-reverse">
                            <Link className="ti-btn ti-btn-primary-full ti-btn-wave" href="#!" scroll={false}>Link</Link>
                        ...
                        <div className="ti-btn-list flex flex-wrap gap-x-2 space-x-2 rtl:space-x-reverse">
                            ...
                            <div className='space-x-2 rtl:space-x-reverse'>
                                <Link href="#!" scroll={false} className="ti-btn ti-btn-primary ti-btn-disabled" aria-disabled="true">Primary
                                    link</Link>
                                <Link href="#!" scroll={false} className="ti-btn ti-btn-secondary ti-btn-disabled ms-2" aria-disabled="true">Link</Link>
                            </div>
                        </div>
                    </Showcode>
                </div>
