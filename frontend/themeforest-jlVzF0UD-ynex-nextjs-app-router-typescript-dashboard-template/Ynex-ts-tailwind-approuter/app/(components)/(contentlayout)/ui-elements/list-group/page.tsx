                    ...
                    <Showcode title="Contextual classes With Hover Styles" code={list8}>
                        <div className="ti-list-group flex flex-col">
                            {ContextualButtons1.map((idx) => (
                                <Link href="#!" scroll={false} className={`w-full ti-list-group-item ${idx.class}`} key={Math.random()}>{idx.text}</Link>
                            ))}
                        </div>
                    </Showcode>
                </div>
                    ...
                    <Showcode title="List With Checkboxes" code={list13}>
                        <ul className="ti-list-group">
                            <li className="ti-list-group-item">
                                <input className="form-check-input me-1 font-semibold" type="checkbox" defaultValue=""
                ...
                <div className="xl:col-span-4 col-span-12">
                    <Showcode title="List With Radios" code={list14}>
                        <ul className="ti-list-group list-none">
                            <li className="ti-list-group-item">
                                <input className="form-check-input me-1" type="radio" defaultValue=""
