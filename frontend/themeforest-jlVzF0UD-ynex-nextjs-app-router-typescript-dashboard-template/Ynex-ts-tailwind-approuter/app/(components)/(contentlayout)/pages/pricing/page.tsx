                ...
                <div className="xl:col-span-12 col-span-12">
                    ...
                    <div className="flex justify-center !mb-6">
                        <nav className="bg-primary/10 p-4 rounded-md mb-4" aria-label="Tabs" role="tablist">
                            <Link href="#!" scroll={false} className="hs-tab-active:bg-primary hs-tab-active:text-white cursor-pointer text-primary py-2 px-4  text-sm font-medium text-center rounded-sm hover:text-primary active" id="pricing-item" data-hs-tab="#pricing-monthly1-pane" aria-controls="pricing-monthly1-pane">
                                Monthly
                            </Link>
                            <Link href="#!" scroll={false} className="hs-tab-active:bg-primary hs-tab-active:text-white cursor-pointer text-primary py-2 px-4 text-sm font-medium text-center  rounded-sm hover:text-primary " id="pricing-yearly1-item" data-hs-tab="#pricing-yearly1-pane" aria-controls="pricing-yearly1-pane">
                                Yearly
                            </Link>
                        </nav>
                    </div>
                                            ...
                                            <div className="!p-6">
                                                ...
                                                <ul className="list-none mb-0">
                                                    <li className="flex items-center mb-4">
                                                        ...
                                                        <span>
                                                            <strong className="me-1 inline-flex">2 Free</strong>Websites
                                                        </span>
                                                    </li>
                                                    <li className="flex items-center mb-4">
                                                        <span className="me-2">
                                                        ...
                                                        <span>
                                                            <strong className="me-1 inline-flex">1 GB</strong>Hard disk storage
                                                        </span>
                                                    </li>
                                                    <li className="flex items-center mb-4">
                                                        <span className="me-2">
                                                        ...
                                                        <span>
                                                            <strong className="me-1 inline-flex">1 Year</strong>Email support
                                                        </span>
                                                    </li>
                                                    <li className="flex items-center mb-4">
                                                        <span className="me-2">
                                                        ...
                                                        <span>
                                                            <strong className="me-1 inline-flex">2</strong>Licenses
                                                        </span>
                                                    </li>
                                                    <li className="flex items-center mb-4">
                                                        <span className="me-2">
                                            ...
                                            <div className="!p-6">
                                                ...
                                                <ul className="list-none mb-0">
                                                    <li className="flex items-center mb-4">
                                                        ...
                                                        <span>
                                                            <strong className="me-1 inline-flex">5 Free</strong>Websites
                                                        </span>
                                                    </li>
                                                    <li className="flex items-center mb-4">
                                                        <span className="me-2">
                                                        ...
                                                        <span>
                                                            <strong className="me-1 inline-flex">5 GB</strong>Hard disk storage
                                                        </span>
                                                    </li>
                                                    <li className="flex items-center mb-4">
                                                        <span className="me-2">
                                                        ...
                                                        <span>
                                                            <strong className="me-1 inline-flex">2 Years</strong>Email support
                                                        </span>
                                                    </li>
                                                    <li className="flex items-center mb-4">
                                                        <span className="me-2">
                                                        ...
                                                        <span>
                                                            <strong className="me-1 inline-flex">5</strong>Licenses
                                                        </span>
                                                    </li>
                                                    <li className="flex items-center mb-4">
                                                        <span className="me-2">
                                            ...
                                            <div className="!p-6">
                                                ...
                                                <ul className="list-none mb-0">
                                                    <li className="flex items-center mb-4">
                                                        ...
                                                        <span>
                                                            <strong className="me-1 inline-flex">10 Free</strong>Websites
                                                        </span>
                                                    </li>
                                                    <li className="flex items-center mb-4">
                                                        <span className="me-2">
                                                        ...
                                                        <span>
                                                            <strong className="me-1 inline-flex">20 GB</strong>Hard disk storage
                                                        </span>
                                                    </li>
                                                    <li className="flex items-center mb-4">
                                                        <span className="me-2">
                                                        ...
                                                        <span>
                                                            <strong className="me-1 inline-flex">3 Years</strong>Email support
                                                        </span>
                                                    </li>
                                                    <li className="flex items-center mb-4">
                                                        <span className="me-2">
                                                        ...
                                                        <span>
                                                            <strong className="me-1 inline-flex">15</strong>Licenses
                                                        </span>
                                                    </li>
                                                    <li className="flex items-center mb-4">
                                                        <span className="me-2">
                                            ...
                                            <div className="!p-6">
                                                ...
                                                <ul className="list-none mb-0">
                                                    <li className="flex items-center mb-4">
                                                        ...
                                                        <span>
                                                            <strong className="me-1 inline-flex">20 Free</strong>Websites
                                                        </span>
                                                    </li>
                                                    <li className="flex items-center mb-4">
                                                        <span className="me-2">
                                                        ...
                                                        <span>
                                                            <strong className="me-1 inline-flex">30 GB</strong>Hard disk storage
                                                        </span>
                                                    </li>
                                                    <li className="flex items-center mb-4">
                                                        <span className="me-2">
                                                        ...
                                                        <span>
                                                            <strong className="me-1 inline-flex">5 Year</strong>Email support
                                                        </span>
                                                    </li>
                                                    <li className="flex items-center mb-4">
                                                        <span className="me-2">
                                                        ...
                                                        <span>
                                                            <strong className="me-1 inline-flex">50</strong>Licenses
                                                        </span>
                                                    </li>
                                                    <li className="flex items-center mb-4">
                                                        <span className="me-2">
                ...
                <div className="xxl:col-span-8 xl:col-span-12 col-span-12">
                    <div className="container">
                        ...
                        <div className="flex justify-center mb-4">
                            <nav className="bg-primary/10 p-4 rounded-md mb-4" aria-label="Tabs" role="tablist">
                                <Link href="#!" scroll={false} className="hs-tab-active:bg-primary hs-tab-active:text-white cursor-pointer text-primary py-2 px-4  text-sm font-medium text-center rounded-sm hover:text-primary active" id="pricing-item1" data-hs-tab="#pricing-monthly-pane" aria-controls="pricing-monthly-pane">
                                    Monthly
                                </Link>
                                <Link href="#!" scroll={false} className="hs-tab-active:bg-primary hs-tab-active:text-white cursor-pointer text-primary py-2 px-4 text-sm font-medium text-center  rounded-sm hover:text-primary " id="pricing-yearly1-item1" data-hs-tab="#pricing-yearly-pane" aria-controls="pricing-yearly-pane">
                                    Yearly
                                </Link>
                            </nav>
                        </div>
