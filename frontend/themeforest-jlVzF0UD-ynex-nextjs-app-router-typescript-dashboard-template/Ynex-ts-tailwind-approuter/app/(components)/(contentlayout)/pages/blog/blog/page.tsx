                        ...
                        <div className="grid grid-cols-12 gap-x-6">
                            <div className="xxl:col-span-6 xl:col-span-6 lg:col-span-6 md:col-span-6 col-span-12">
                                <div className="box">
                                    ...
                                    <div className="box-body">
                                        <Link href="/pages/blog/blog-details/" className="font-semibold text-[0.875rem] text-dark mb-1">Touring excites in winter !</Link>
                                        ...
                                        <Link href="#!" scroll={false} className="ti-btn ti-btn-primary !font-medium !mb-0">Read More</Link>
                                    </div>
                            ...
                            <div className="xxl:col-span-6 xl:col-span-6 lg:col-span-6 md:col-span-6 col-span-12">
                                <div className="box">
                                    ...
                                    <div className="box-body">
                                        <Link href="/pages/blog/blog-details/" className="font-semibold text-[0.875rem] text-dark mb-1"> Boat manufacutrers are in debt !</Link>
                                ...
                                <div className="grid grid-cols-12 gap-x-6">
                                    <div className="xxl:col-span-6 xl:col-span-6 lg:col-span-6 md:col-span-6 col-span-12">
                                        <div className="box">
                                            ...
                                            <div className="box-body">
                                                <Link href="/pages/blog/blog-details/" className="font-semibold text-[0.875rem] text-dark mb-1">Features of new car !</Link>
                                                <p className="card-text text-[#8c9097] dark:text-white/50 mb-3">The holographic principle, theorized to be a property of quantum gravity, postulates that the description.</p>
                                                <Link href="#!" scroll={false} className="ti-btn ti-btn-primary !font-medium !mb-0">Read More</Link>
                                            </div>
                                            <div className="box-footer">
                                    ...
                                    <div className="xxl:col-span-6 xl:col-span-6 lg:col-span-6 md:col-span-6 col-span-12">
                                        <div className="box">
                                            ...
                                            <div className="box-body">
                                                <Link href="/pages/blog/blog-details/" className="font-semibold text-[0.875rem] text-dark mb-1">Beautiful beach on a sunny day !</Link>
                                                <p className="card-text text-[#8c9097] dark:text-white/50 mb-3">The holographic principle, theorized to be a property of quantum gravity, postulates that the description.</p>
                                                <Link href="#!" scroll={false} className="ti-btn ti-btn-primary !font-medium !mb-0">Read More</Link>
                                            </div>
                                            <div className="box-footer">
                                        ...
                                        <ul className="list-group">
                                            <li className="list-group-item">
                                                <div className="flex flex-wrap items-center">
                                                    ...
                                                    <div className="flex-grow">
                                                        <Link href="#!" scroll={false} className="text-[0.875rem] font-semibold mb-0">Samantha Jack</Link>
                                            ...
                                            <li className="list-group-item">
                                                <div className="flex flex-wrap items-center">
                                                    ...
                                                    <div className="flex-grow">
                                                        <Link href="#!" scroll={false} className="text-[0.875rem] font-semibold mb-0">Kirsten Sam</Link>
                                                        <p className="mb-1 popular-blog-content text-truncate">
                                            ...
                                            <li className="list-group-item">
                                                <div className="flex flex-wrap items-center">
                                                    ...
                                                    <div className="flex-grow">
                                                        <Link href="#!" scroll={false} className="text-[0.875rem] font-semibold mb-0">Jessica Karon</Link>
                                                        <p className="mb-1 popular-blog-content text-truncate">
                                            ...
                                            <li className="list-group-item">
                                                <div className="flex flex-wrap items-center">
                                                    ...
                                                    <div className="flex-grow">
                                                        <Link href="#!" scroll={false} className="text-[0.875rem] font-semibold mb-0">Broad Stuart</Link>
                                                        <p className="mb-1 popular-blog-content text-truncate">
                            ...
                            {Populartopics1.map((idx) => (
                                <div className="xxl:col-span-3 xl:col-span-6 lg:col-span-6 md:col-span-6 col-span-12" key={Math.random()}>
                                    <div className="box">
                                        ...
                                        <div className="box-body">
                                            <Link href="/pages/blog/blog-details/" className="font-semibold text-[0.875rem] text-dark mb-1">{idx.title}</Link>
                    ...
                    <nav aria-label="Page navigation">
                        <ul className="pagination mb-0 flex flex-row rounded-sm text-[1rem]">
                            <li className="page-item disabled">
                                <Link className="page-link !py-[0.375rem] !px-[0.75rem]" href="#!" scroll={false}>
                                    Prev
                                </Link>
                            </li>
                            ...
                            <li className="page-item ">
                                <Link aria-label="anchor" className="page-link !py-[0.375rem] !px-[0.75rem]" href="#!" scroll={false}>
                                    <i className="bi bi-three-dots"></i>
                                </Link>
                            </li>
                            <li className="page-item "><Link className="page-link !py-[0.375rem] !px-[0.75rem]" href="#!" scroll={false}>17</Link></li>
                            <li className="page-item">
