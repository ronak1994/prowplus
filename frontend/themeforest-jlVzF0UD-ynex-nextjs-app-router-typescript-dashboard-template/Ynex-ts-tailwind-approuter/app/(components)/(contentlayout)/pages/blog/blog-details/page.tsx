                                ...
                                <ul className="list-group !rounded-md">
                                    <li className="list-group-item">
                                        <div className="flex gap-4 flex-wrap items-center">
                                            ...
                                            <div className="flex-grow">
                                                <Link href="#!" scroll={false} className="text-[0.875rem] font-semibold mb-0">Animals</Link>
                                    ...
                                    <li className="list-group-item">
                                        <div className="flex gap-4 flex-wrap items-center">
                                            ...
                                            <div className="flex-grow">
                                                <Link href="#!" scroll={false} className="text-[0.875rem] font-semibold mb-0">Travel</Link>
                                                <p className="mb-1 popular-blog-content text-truncate">
                                    ...
                                    <li className="list-group-item">
                                        <div className="flex gap-4 flex-wrap items-center">
                                            ...
                                            <div className="flex-grow">
                                                <Link href="#!" scroll={false} className="text-[0.875rem] font-semibold mb-0">Interior</Link>
                                                <p className="mb-1 popular-blog-content text-truncate">
                                    ...
                                    <li className="list-group-item">
                                        <div className="flex gap-4 flex-wrap items-center">
                                            ...
                                            <div className="flex-grow">
                                                <Link href="#!" scroll={false} className="text-[0.875rem] font-semibold mb-0">Nature</Link>
                                                <p className="mb-1 popular-blog-content text-truncate">
