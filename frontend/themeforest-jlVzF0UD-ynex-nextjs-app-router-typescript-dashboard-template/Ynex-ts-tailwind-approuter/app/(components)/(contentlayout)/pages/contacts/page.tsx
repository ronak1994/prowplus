        ...
        <div>
                                    ...
                                    <div className="flex sm:mt-0 mt-2 items-center">
                                        ...
                                        <div className="hs-dropdown ti-dropdown ms-2">
                                            ...
                                            <ul className="hs-dropdown-menu ti-dropdown-menu hidden">
                                                ...
                                                <li><Link className="ti-dropdown-item !py-2 !px-[0.9375rem] !text-[0.8125rem] !font-medium block" href="#!" scroll={false}>Copy All</Link></li>
                                                <li><Link className="ti-dropdown-item !py-2 !px-[0.9375rem] !text-[0.8125rem] !font-medium block" href="#!" scroll={false}>Move To</Link></li>
                                            </ul>
                                        </div>
                        ...
                        <div className="box-body contact-action">
                            ...
                            <div className="flex items-center justify-center gap-2 contact-hover-buttons">
                                ...
                                <div className="hs-dropdown ti-dropdwon contact-hover-dropdown">
                                    ...
                                    <ul className="hs-dropdown-menu ti-dropdown-menu hidden">
                                        <li><Link className="ti-dropdown-item flex !gap-x-0 !px-[0.9375rem] !text-[0.8125rem] !font-medium" href="#!" scroll={false}><i className="ri-share-line me-2 align-middle inline-block"></i>Share</Link></li>
                                        <li><Link className="ti-dropdown-item flex !gap-x-0" href="#!" scroll={false}><i className="ri-phone-line me-2 align-middle inline-block"></i>Call</Link></li>
                                        <li><Link className="ti-dropdown-item flex !gap-x-0" href="#!" scroll={false}><i className="ri-chat-2-line me-2 align-middle inline-block"></i>Message</Link></li>
                                        <li><Link className="ti-dropdown-item flex !gap-x-0" href="#!" scroll={false}><i className="ri-video-chat-line me-2 align-middle inline-block"></i>Video Call</Link></li>
                                        <li><Link className="ti-dropdown-item flex !gap-x-0" href="#!" scroll={false}><i className="ri-delete-bin-5-line me-2 align-middle inline-block"></i>Delete</Link></li>
                                        <li><Link className="ti-dropdown-item flex !gap-x-0" href="#!" scroll={false}><i className="ri ri-heart-3-line me-2 align-middle inline-block"></i>Favourite</Link></li>
                                    </ul>
                                </div>
            ...
            <nav aria-label="Page navigation" className="mb-4">
                <ul className="ti-pagination !justify-end py-[0.375rem] px-3 text-[1rem] flex flex-row">
                    <li className="page-item disabled"><Link className="page-link py-[0.375rem] px-3" href="#!" scroll={false}>Previous</Link></li>
                    <li className="page-item"><Link className="page-link py-[0.375rem] px-3" href="#!" scroll={false}>1</Link></li>
                    <li className="page-item"><Link className="page-link py-[0.375rem] px-3" href="#!" scroll={false}>2</Link></li>
                    <li className="page-item"><Link className="page-link py-[0.375rem] px-3" href="#!" scroll={false}>Next</Link></li>
                </ul>
            </nav>
        </div>
    )
