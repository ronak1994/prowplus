                            ...
                            <div className="box-body !p-0">
                                <nav className="w-full mx-auto px-4 xxl:flex sm:items-center xxl:justify-between navbar navbar-expand-xxl bg-white dark:bg-bodybg !py-2" aria-label="Global">
                                    <div className="flex items-center justify-between">
                                        <Link href="/dashboards/crm/" className="header-logo me-6">
                                            ...
                                            <ul className="navbar-nav me-auto lg:mb-0 xxl:items-center xxl:flex flex-grow mt-2 xxl:mt-0 items-center flex-wrap">
                                                <li className="nav-item mb-2 xxl:mb-0">
                                                    <Link className="nav-link whitespace-nowrap text-defaulttextcolor dark:text-defaulttextcolor/70 active hover:!text-primary" aria-current="page"
                                                        href="#!" scroll={false}>Men</Link>
                                                </li>
                                                <li className="nav-item mb-2 xxl:mb-0">
                                                    <Link className="nav-link whitespace-nowrap text-defaulttextcolor dark:text-defaulttextcolor/70 hover:!text-primary" href="#!" scroll={false}>Women</Link>
                                                </li>
                                                <li className="nav-item mb-2 xxl:mb-0 hs-dropdown ti-dropdown">
                                                    <Link className="nav-link whitespace-nowrap text-defaulttextcolor dark:text-defaulttextcolor/70 dropdown-toggle" href="#!" scroll={false}
                                                        id="navbarDropdown"
                                                        aria-expanded="false">
                                                        Kids<i
                                                    ...
                                                    <ul className="hs-dropdown-menu ti-dropdown-menu hidden"
                                                        ...
                                                        <li><Link className="ti-dropdown-item !py-2 !px-[0.9375rem] !text-[0.8125rem] !font-medium block"
                                                            href="#!" scroll={false}>Another action</Link>
                                                        </li>
                                                        <li>
                                                            <hr className="dropdown-divider" />
                                                        </li>
                                                        <li><Link className="ti-dropdown-item !py-2 !px-[0.9375rem] !text-[0.8125rem] !font-medium block"
                                                            href="#!" scroll={false}>Something else
                                                            here</Link></li>
                                                    </ul>
                                                </li>
                                                <li className="nav-item mb-2 xxl:mb-0">
                                                    <Link href="#!" scroll={false} className="nav-link whitespace-nowrap text-defaulttextcolor dark:text-defaulttextcolor/70 hover:!text-primary">Today Deals</Link>
                                                </li>
                                                <li className="nav-item mb-2 xxl:mb-0">
                                                    <Link href="#!" scroll={false} className="nav-link whitespace-nowrap text-defaulttextcolor dark:text-defaulttextcolor/70 hover:!text-primary">Electronics</Link>
                                                </li>
                                                <li className="nav-item mb-2 xxl:mb-0">
                                                    <Link href="#!" scroll={false} className="nav-link whitespace-nowrap text-defaulttextcolor dark:text-defaulttextcolor/70 hover:!text-primary">Home &amp; Kitchen</Link>
                                                </li>
                                                <li className="nav-item mb-2 xxl:mb-0">
                                                    <Link href="#!" scroll={false} className="nav-link whitespace-nowrap text-defaulttextcolor dark:text-defaulttextcolor/70 hover:!text-primary">Fashion</Link>
                                                </li>
                                                <li className="nav-item mb-2 xxl:mb-0">
                                                    <Link href="#!" scroll={false} className="nav-link whitespace-nowrap text-defaulttextcolor dark:text-defaulttextcolor/70 hover:!text-primary"><i
                                                ...
                                                <li className="nav-item xxl:mb-0 mb-2 xxl:ms-0 !ms-4">
                                                    <div className="btn-group xxl:flex block hs-dropdown ti-dropdown">
                                                        ...
                                                        <ul className="hs-dropdown-menu ti-dropdown-menu hidden">
                                                            <li><Link className="ti-dropdown-item !py-2 !px-[0.9375rem] !text-[0.8125rem] !font-medium block"
                                                                href="#!" scroll={false}>Featured</Link></li>
                                                            <li><Link className="ti-dropdown-item !py-2 !px-[0.9375rem] !text-[0.8125rem] !font-medium block"
                                                                href="#!" scroll={false}>Price: High to Low</Link></li>
                                                            <li><Link className="ti-dropdown-item active !py-2 !px-[0.9375rem] !text-[0.8125rem] !font-medium block"
                                                                href="#!" scroll={false}>Price: Low to High</Link></li>
                                                            <li><Link className="ti-dropdown-item !py-2 !px-[0.9375rem] !text-[0.8125rem] !font-medium block"
                                                                href="#!" scroll={false}>Newest</Link></li>
                                                            <li><Link className="ti-dropdown-item !py-2 !px-[0.9375rem] !text-[0.8125rem] !font-medium block"
                                                                href="#!" scroll={false}>Ratings</Link></li>
                                                        </ul>
                                                    </div>
                                                </li>
                                                <li className="nav-item xxl:mb-0 mb-2 xxl:ms-4 !ms-4">
                                                    <div className="inline-flex">
                                                        <button type="button"
                                                            className="ti-btn !py-[0.45rem] !px-3 bg-primary text-white !rounded-e-none !mb-0">IV</button>
                                                        <button type="button"
                                                            className="ti-btn !py-[0.45rem] !px-3 bg-primary text-white !rounded-none !mb-0">III</button>
                                                        <button type="button"
                                                            className="ti-btn !py-[0.45rem] !px-3 bg-primary text-white !rounded-s-none !mb-0">II</button>
                                                    </div>
                                                </li>
                                            </ul>
                        ...
                        <div className="box products-navigation-card">
                                ...
                                <div className="p-4 border-b dark:border-defaultborder/10">
                                    ...
                                    <div className="px-2 py-4 pb-0">
                                        ...
                                        <Link className="ecommerce-more-link text-success hs-collapse-toggle inline-flex items-center gap-x-2"
                                            href="#!" scroll={false} id="hs-show-hide-categories"
                            ...
                            <div className="p-4 border-b dark:border-defaultborder/10">
                                ...
                                <div className="px-2 py-4 pb-0">
                                    ...
                                    <Link className="ecommerce-more-link text-success hs-collapse-toggle inline-flex items-center gap-x-2"
                                        href="#!" scroll={false} id="hs-show-hide-brands"
                            ...
                            <div className="p-4">
                                ...
                                <div className="px-2 py-3 pb-0">
                                    ...
                                    <Link className="ecommerce-more-link text-success hs-collapse-toggle inline-flex items-center gap-x-2"
                                        href="#!" scroll={false} id="hs-show-hide-sizes"
                                    ...
                                    <div className="box product-card">
                                        <div className="box-body">
                                            ...
                                            <div className="product-icons">
                                                <Link aria-label="anchor" href="/pages/ecommerce/wishlist/" className="wishlist"><i
                                                ...
                                                <Link aria-label="anchor" href={`/pages/ecommerce/product-details?id=${idx.id}`}className="view"><i
