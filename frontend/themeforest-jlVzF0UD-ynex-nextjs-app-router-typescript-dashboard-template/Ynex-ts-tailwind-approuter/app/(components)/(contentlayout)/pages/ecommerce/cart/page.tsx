                                            ...
                                            <tr className="border border-inherit border-solid dark:border-defaultborder/10">
                                                ...
                                                <td className="product-quantity-container">
                                                    <div className="input-group dark:border-defaultborder/10 rounded-md !flex-nowrap">
                                                        ...
                                                        <input type="text" className="form-control form-control-sm text-center !w-[50px] !px-0" aria-label="quantity" defaultValue={idx.quantity} />
                    ...
                    <div className="box !hidden" id="cart-empty-cart">
                        ...
                        <div className="box-body flex items-center justify-center">
                            <div className="cart-empty text-center">
                                ...
                                <Link href="#!" scroll={false} className="ti-btn bg-primary text-white !font-medium m-4" data-abc="true">continue shopping <i className="bi bi-arrow-right ms-1"></i></Link>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="box">
                        <div className="p-4 border-b dark:border-defaultborder/10 block">
                            <div className="alert alert-primary text-center" role="alert">
                                <span className="text-defaulttextcolor">Sale Ends in</span> <span className="font-semibold text-[0.875rem] text-primary ms-1">18 hours : 32 minutes</span>
                            </div>
                        </div>
                        <div className="box-body !p-0">
                            ...
                            <div className="p-4 border-b border-dashed dark:border-defaultborder/10">
                                <div className="input-group">
                                    <input type="text" className="form-control form-control-sm !rounded-s-sm !border-s  !border-e-0 dark:border-defaultborder/10" placeholder="Coupon Code" aria-label="coupon-code" aria-describedby="coupons" />
                                    <button type="button" className="ti-btn !bg-primary !text-white !font-medium !rounded-s-none !mb-0" id="coupons">Apply</button>
                                </div>
                                <Link href="#!" scroll={false} className="text-[0.75rem] text-success">10% off on first purchase</Link>
                            </div>
                            <div className="p-4 border-b border-dashed dark:border-defaultborder/10">
