                                        ...
                                        <div className="xxl:col-span-12 xl:col-span-6 lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12 md:mb-[3rem] mb-4">
                                            <Swiper
                                                ...
                                                <SwiperSlide id="img-container">
                                                    <img className={defaultData && defaultData.preview != "../../../assets/images/ecommerce/png/15.png" ? "img-fluid mx-auto d-block" : ""} src={defaultData && defaultData.preview} alt="img" />
                                                </SwiperSlide>
                                            </Swiper>
                                            <Swiper onSwiper={setThumbsSwiper} autoplay={{ delay: 2500, disableOnInteraction: false, }} spaceBetween={10} slidesPerView={4} freeMode={true} watchSlidesProgress={true}
                                                ...
                                                {defaultData &&
											defaultData.images.map((ele:any) => {
                                                return (
                                                <SwiperSlide className="rtl:me-0" key={Math.random() + ele} onClick={() => { setdefaultData({ ...defaultData, preview: ele.img });}}>
                                                    <img className="img-fluid" src={ele.img} alt="img"  />
                                                </SwiperSlide>
                                                );
											})}
                                            </Swiper>
                                ...
                                <div className="xxl:col-span-9 xl:col-span-12 col-span-12">
                                    <div className="md:grid grid-cols-12 gap-x-[3rem]">
                                        <div className="xl:col-span-8 col-span-12 xxl:mt-0 mt-4">
                                            <p className="text-[1.125rem] font-semibold mb-0">{defaultData && defaultData.title}{defaultData && defaultData.description}</p>
                                            <p className="text-[1.125rem] mb-4">
                                                ...
                                                <span className="font-semibold text-[#8c9097] dark:text-white/50 ms-1">4.3<Link className="text-info" href="#!" scroll={false}>(2.4k Reviews)</Link></span>
                                            </p>
                                            <div className="grid grid-cols-12 mb-6">
                                                <div className="xxl:col-span-3 xl:col-span-12 col-span-12">
                                                    <p className="mb-1 lh-1 text-[0.6875rem] text-success font-semibold">Special Offer</p>
                                                    <p className="mb-1"><span className="h3  font-semibold"><sup className="text-[0.875rem]"></sup>{defaultData && defaultData.offerprice}<sup className="text-[0.875rem]">.00</sup></span><span className="ms-3 badge bg-danger/10 text-danger">50% Off</span></p>
                                                    <p className="mb-0 text-[#8c9097] dark:text-white/50 text-[0.75rem]">M.R.P-<s>{defaultData && defaultData.newpr}</s></p>
                                                </div>
                                                <div className="xxl:col-span-4 xl:col-span-6 lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12 mml:mt-0 mt-4">
                                                    ...
                                                    <div className="inline-flex" role="group" aria-label="Basic radio toggle button group">
                                                        ...
                                                        <label className="ti-btn !py-[0.45rem] !px-3 ti-btn-light !border-e-0 !text-defaulttextcolor dark:!text-defaulttextcolor/70 dark:!border-defaultborder/10 !text-[0.75rem] !font-medium !rounded-e-none hover:!bg-light hover:!text-defaulttextcolor" htmlFor="type1">GPS</label>
                                                        <input type="radio" className="btn-check" name="select-type" id="type2" />
                                                        <label className="ti-btn !py-[0.45rem] !px-3 ti-btn-outline-light !text-defaulttextcolor dark:!text-defaulttextcolor/70 dark:!border-defaultborder/10 !text-[0.75rem] !rounded-s-none hover:!bg-light hover:!text-defaulttextcolor" htmlFor="type2">GPS+Cellular</label>
                                                    </div>
                                                </div>
                                                <div className="xxl:col-span-5 xl:col-span-6 lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12 xxl:mt-0 mt-4">
                                                    ...
                                                    <div className="inline-flex " role="group" aria-label="Basic radio toggle button group">
                                                        ...
                                                        <label className="ti-btn !py-[0.45rem] !px-3 ti-btn-light !border-e-0 !text-defaulttextcolor dark:!text-defaulttextcolor/70 dark:!border-defaultborder/10 !text-[0.75rem] !font-medium !rounded-e-none hover:!bg-light hover:!text-defaulttextcolor" htmlFor="strap1">Leather</label>
                                                        <input type="radio" className="btn-check " name="strap-material" id="strap2" />
                                                        <label className="ti-btn !py-[0.45rem] !px-3 ti-btn-outline-light !border-e-0 !text-defaulttextcolor dark:!text-defaulttextcolor/70 dark:!border-defaultborder/10 !text-[0.75rem] !font-medium !rounded-none hover:!bg-light hover:!text-defaulttextcolor" htmlFor="strap2">Stainless steel</label>
                                                        <input type="radio" className="btn-check" name="strap-material" id="strap3" />
                                                        <label className="ti-btn !py-[0.45rem] !px-3 ti-btn-outline-light !text-defaulttextcolor dark:!text-defaulttextcolor/70 dark:!border-defaultborder/10 !text-[0.75rem] !font-medium  !rounded-s-none hover:!bg-light hover:!text-defaulttextcolor" htmlFor="strap3">Synthetic</label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="mb-4">
                                                ...
                                                <div className="grid grid-cols-12 gap-x-6">
                                                    <div className="xxl:col-span-6 xl:col-span-6 lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12">
                                                        ...
                                                        <p className="mb-0 flex">
                                                            <Link aria-label="anchor" className="color-1 product-colors selected" href="#!" scroll={false}>
                                                                <i className="ri-checkbox-blank-circle-fill"></i>
                                                            </Link>
                                                            <Link aria-label="anchor" className="color-2 product-colors" href="#!" scroll={false}>
                                                                <i className="ri-checkbox-blank-circle-fill"></i>
                                                            </Link>
                                                            <Link aria-label="anchor" className="color-3 product-colors" href="#!" scroll={false}>
                                                                <i className="ri-checkbox-blank-circle-fill"></i>
                                                            </Link>
                                                            <Link aria-label="anchor" className="color-4 product-colors" href="#!" scroll={false}>
                                                                <i className="ri-checkbox-blank-circle-fill"></i>
                                                            </Link>
                                                            <Link aria-label="anchor" className="color-5 product-colors" href="#!" scroll={false}>
                                                                <i className="ri-checkbox-blank-circle-fill"></i>
                                                            </Link>
                                                        </p>
                                                    </div>
                                                    <div className="xxl:col-span-6 xl:col-span-6 lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12 md:mt-0 mt-4">
                                                        ...
                                                        <p className="mb-0 flex">
                                                            <Link className="color-1 product-sizes selected" href="#!" scroll={false}>
                                                                44
                                                            </Link>
                                                            <Link className="color-2 product-sizes" href="#!" scroll={false}>
                                                                40
                                                            </Link>
                                                            <Link className="color-3 product-sizes" href="#!" scroll={false}>
                                                                38
                                                            </Link>
                                                        </p>
                                                    </div>
                                            ...
                                            <div className="mb-4">
                                                <div className="grid grid-cols-12 gap-0 justify-center">
                                                    <div className="xxl:col-span-4 xl:col-span-4 lg:col-span-4 md:col-span-4 sm:col-span-4 col-span-12 mx-3">
                                                    ...
                                                    <div className="xxl:col-span-4 xl:col-span-12 lg:col-span-12 md:col-span-12 sm:col-span-12 col-span-12">
                                                        ...
                                                        <div className="flex items-center mb-4">
                                                            ...
                                                            <div className="progress progress-xs flex-grow">
                                                                <div className="progress-bar !bg-success rounded-md w-[55%]" role="progressbar" aria-valuenow={55} aria-valuemin={0} aria-valuemax={100}>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div className="flex items-center mb-4">
                                                            ...
                                                            <i className="ri-star-fill text-[.625rem] me-2 "></i>
                                                            <div className="progress progress-xs flex-grow">
                                                                <div className="progress-bar rounded-md !bg-success w-[22%]" role="progressbar" aria-valuenow={22} aria-valuemin={0} aria-valuemax={100}>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div className="flex items-center mb-4">
                                                            ...
                                                            <i className="ri-star-fill text-[.625rem] me-2 "></i>
                                                            <div className="progress progress-xs flex-grow">
                                                                <div className="progress-bar rounded-s-md !bg-success w-[8%]" role="progressbar" aria-valuenow={8} aria-valuemin={0} aria-valuemax={100}>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div className="flex items-center mb-4">
                                                            ...
                                                            <div className="progress progress-xs flex-grow">
                                                                <div className="progress-bar rounded-md !bg-warning w-[9%]" role="progressbar" aria-valuenow={9} aria-valuemin={0} aria-valuemax={100}>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div className="flex items-center">
                                                            ...
                                                            <i className="ri-star-fill text-[.625rem] me-2"></i>
                                                            <div className="progress progress-xs flex-grow">
                                                                <div className="progress-bar rounded-md !bg-danger w-[6%]" role="progressbar" aria-valuenow={6} aria-valuemin={0} aria-valuemax={100}>
                                                                </div>
                                                            </div>
                                            ...
                                            <div className="mb-[3rem]">
                                                <div className="offer-promotion dark:border-defaultborder/10 mb-6">
                                                    <div className="xxl:flex flex lg:block sm:flex flex-wrap justify-between items-center">
                                                        <div className="text-warning xxxl:mb-0 mb-2">Use Code <span className="promotion-code font-semibold">FIRBUY</span><Link className="text-[.625rem] text-warning ms-1" href="#!" scroll={false}>T&amp;C.</Link></div>
                                                    ...
                                                    <ul className="list-group">
                                                        ...
                                                        <li className="list-group-item">
                                                            <div className="text-[0.75rem] text-default">
                                                                <span className="text-success me-1 font-semibold">Bank Offer:</span><span className="flex-grow">5% off upto 500 on min purchase of $999<Link href="#!" scroll={false} className="text-primary ms-1">View.</Link></span>
                                                            </div>
                                                        </li>
                                                        <li className="list-group-item">
                                                            <div className="text-[0.75rem] text-default">
                                                                <span className="text-success me-1 font-semibold">Emi:</span><span className="flex-grow">No cost emi on selected bank card on min purchase of $1,499<Link href="#!" scroll={false} className="text-primary ms-1">View.</Link></span>
                                                            </div>
                                                        </li>
                                                        <li className="list-group-item !p-0 hs-collapse hidden w-full !border-0 overflow-hidden transition-[height] duration-300" id="hs-show-hide-collapse-heading" aria-labelledby="hs-show-hide-collapse">
                                                            <ul className="list-group" id="offers-more">
                                                                <li className="list-group-item border-0 border-b">
                                                                    <div className="text-[0.75rem] text-defaulttextcolor">
                                                                        <span className="text-success me-1 font-semibold">Free Delivery:</span><span className="flex-grow">Free delivery on first order<Link href="#!" scroll={false} className="text-primary ms-1">View.</Link></span>
                                                                    </div>
                                                                </li>
                                                                <li className="list-group-item border-0 !border-b-0">
                                                                    <div className="text-[0.75rem] text-default">
                                                                        <span className="text-success me-1 font-semibold">Promotion:</span><span className="flex-grow">Offer upto 30% on grosery on purchase of this item<Link href="#!" scroll={false} className="text-primary ms-1">T&amp;C.</Link></span>
                                                                    </div>
                                                                </li>
                                                            </ul>
                                                        </li>
                                                        ...
                                                        <li className="list-group-item border-t-0">
                                                            <Link className="text-success text-[0.75rem] hs-collapse-toggle inline-flex items-center gap-x-2" href="#!" scroll={false} id="hs-show-hide-collapse" data-hs-collapse="#hs-show-hide-collapse-heading"><u>More Offers</u>
                                                            </Link>
                                                        </li>
                                                    </ul>
                                                </div>
                                                <div className="mb-4">
                                                    ...
                                                    <p className="text-[0.75rem] text-[#8c9097] dark:text-white/50">Min 7 days return and exchange policy. Return Policies may vary based on products and promotions. For full details on our Returns Policies, please <Link href="#!" scroll={false} className="text-primary">click here</Link>․</p>
                                                </div>
                                                <div className="alert alert-light mb-6 text-[0.75rem] text-[#8c9097] dark:text-white/50" role="alert">
                                                    <Link aria-label="anchor" href="#!" scroll={false}><i className="ri-map-pin-line me-1 align-middle text-primary text-[.9375rem] inline-block"></i></Link>Select location to find out estimated delivery date
                                                </div>
                                                <div className="grid gap-2">
                                                    <Link href="/pages/ecommerce/cart/" className="ti-btn bg-primary !font-medium text-white">Add To Cart</Link>
                                                    <Link href="/pages/ecommerce/checkout/" className="ti-btn bg-success !font-medium text-white">Buy Now</Link>
                                                    <Link href="/pages/ecommerce/wishlist/" className="ti-btn bg-light !font-medium">Add To Wishlist</Link>
                                                </div>
                                            </div>
                                            <div className="text-center">
                                                <Link aria-label="anchor" href="#!" scroll={false}>
