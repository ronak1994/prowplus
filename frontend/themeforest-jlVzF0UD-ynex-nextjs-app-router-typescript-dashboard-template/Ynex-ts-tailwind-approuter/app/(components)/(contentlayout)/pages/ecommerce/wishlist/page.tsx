        ...
        <Fragment>
                        ...
                        <div className="box product-card">
                            <div className="box-body">
                                ...
                                <div className="product-icons">
                                    <Link aria-label="anchor" onClick={() => Confirmalert(idx.id)} href="#!" scroll={false} className="wishlist btn-delete"><i className="ri-close-line"></i></Link>
                                </div>
            ...
            <nav aria-label="Page navigation" className="">
                <ul className="ti-pagination flex ltr:float-right rtl:float-left mb-4 rounded-sm text-[1rem]">
                    ...
                    <li className="page-item"><Link className="page-link !py-[0.375rem] !px-[0.75rem]" href="#!" scroll={false}>1</Link></li>
                    <li className="page-item "><Link className="page-link !py-[0.375rem] !px-[0.75rem]" href="#!" scroll={false}>2</Link></li>
                    <li className="page-item "><Link className="page-link !py-[0.375rem] !px-[0.75rem]" href="#!" scroll={false}>3</Link></li>
