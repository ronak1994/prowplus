                                                ...
                                                <div className="flex items-center">
                                                    ...
                                                    <div>
                                                        <div className="mb-1 text-[0.875rem] font-semibold">
                                                            <Link href="#!" scroll={false}>Orange Watch Series 4</Link>
                                                        </div>
                                                        <div className="mb-1">
                                        ...
                                        <tr className="border border-inherit border-solid dark:border-defaultborder/10">
                                            <td>
                                                <div className="flex items-center">
                                                    ...
                                                    <div>
                                                        <div className="mb-1 text-[0.875rem] font-semibold">
                                                            <Link href="#!" scroll={false}>DapZem &amp; Co Sweat Shirt</Link>
                                                        </div>
                                                        <div className="mb-1">
                                        ...
                                        <tr className="border border-inherit border-solid dark:border-defaultborder/10">
                                            <td>
                                                <div className="flex items-center">
                                                    ...
                                                    <div>
                                                        <div className="mb-1 text-[0.875rem] font-semibold">
                                                            <Link href="#!" scroll={false}>Denim Corporation Sweat Shirt</Link>
                                                        </div>
                                                        <div className="mb-1">
                                                            <span className="me-1">Size:</span><span className="text-[#8c9097] dark:text-white/50">Large</span>
                                                        </div>
