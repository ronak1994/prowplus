                                                ...
                                                <div className="flex items-center">
                                                    ...
                                                    <div className="hs-dropdown ti-dropdown ms-2">
                                                        ...
                                                        <ul className="hs-dropdown-menu ti-dropdown-menu hidden">
                                                            <li><Link className="ti-dropdown-item !py-2 !px-[0.9375rem] !text-[0.8125rem] !font-medium block" href="#!" scroll={false}>Delete Team</Link></li>
                                                            <li><Link className="ti-dropdown-item !py-2 !px-[0.9375rem] !text-[0.8125rem] !font-medium block" href="#!" scroll={false}>Edit</Link></li>
                                                            <li><Link className="ti-dropdown-item !py-2 !px-[0.9375rem] !text-[0.8125rem] !font-medium block" href="#!" scroll={false}>Add Member</Link></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div className="xxl:col-span-4 xl:col-span-6 lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12" key={Math.random()}>
                                    <div className="box team-member-card">
                                        <div className="teammember-cover-image">
                                            ...
                                            <Link aria-label="anchor" href="#!" scroll={false} className="team-member-star text-warning">
                                            ...
                                            <div className="flex flex-wrap align-item-center sm:mt-0 mt-[3rem] justify-between border-b border-dashed dark:border-defaultborder/10 p-4">
                                                ...
                                                <div className="hs-dropdown ti-dropdown">
                                                    ...
                                                    <ul className="ti-dropdown-menu hs-dropdown-menu hidden">
                                                        ...
                                                        <li><Link className="ti-dropdown-item !py-2 !px-[0.9375rem] !text-[0.8125rem] !font-medium block" href="#!" scroll={false}>Edit</Link></li>
                                                        <li><Link className="ti-dropdown-item !py-2 !px-[0.9375rem] !text-[0.8125rem] !font-medium block" href="#!" scroll={false}>Remove</Link></li>
                                                    </ul>
                                                </div>
                                            </div>
                    ...
                    <div className="team-groups">
                        <div className="box">
                            <div className="box-header  !justify-between">
                                ...
                                <div>
                                    <button type="button" className="hs-dropdown-toggle ti-btn ti-btn-primary !text-[0.75rem] !py-1 !px-2" data-hs-overlay="#hs-vertically-centered-modal1">
                                        ...
                                        <div className="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out min-h-[calc(100%-3.5rem)] flex items-center">
                                            <div className="ti-modal-content w-full">
                                                <div className="ti-modal-header">
                                                    ...
                                                    <button type="button" className="hs-dropdown-toggle ti-modal-close-btn" data-hs-overlay="#hs-vertically-centered-modal1">
                                                ...
                                                <div className="ti-modal-footer">
                                                    <button type="button" className="hs-dropdown-toggle ti-btn ti-btn-light" data-hs-overlay="#hs-vertically-centered-modal1">
                                                        Cancel
                                                    </button>
