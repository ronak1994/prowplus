...
const Reviews = () => {
 ...
 const Reviewslist = [
        ...
        { id: 9, src: "../../assets/images/faces/7.jpg", name: 'Julia Sams', title: 'CHIEF SECRETARY BHOL', class: 'fill', text: '2 month ago' },
    ];
                        ...
                        <div className="xxl:col-span-4 xl:col-span-6 lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12" key={Math.random()}>
                            <div className="box">
                                <div className="box-body">
                                    ...
                                    <div className="mb-4">
                                        <span className="text-[#8c9097] dark:text-white/50">- Lorem ipsum dolor sit amet consectetur adipisicing elit. Earum autem quaerat distinctio  -- <Link href="#!" scroll={false} className="font-semibold text-[.6875rem] text-primary" >Read More</Link></span>
                                    </div>
                                    <div className="flex items-center justify-between">
                                        <div className="flex items-center">
                                            ...
                                            <span className="text-warning block ms-1">
                                                ...
                                                <i className="ri-star-fill me-1"></i>
                                                <i className="ri-star-fill me-1"></i>
                                                <i className={`ri-star-${idx.class} me-1`}></i>
                                            </span>
                                        </div>
