                    ...
                    <div className="box">
                        <div className="box-body !p-0">
                            <div className="p-4 grid border-b border-dashed dark:border-defaultborder/10">
                                <Link href="#!" scroll={false} className="hs-dropdown-toggle py-2  px-3 ti-btn bg-primary text-white !font-medium w-full !mb-0" data-hs-overlay="#todo-compose"><i className="ri-add-circle-line !text-[1rem]"></i>Create New Task
                                </Link>
                                                ...
                                                <div className="grid grid-cols-12 gap-2">
                                                    ...
                                                    <div className="xl:col-span-6 col-span-12">
                                                        ...
                                                        <div className="inline-flex w-full">
                                                            ...
                                                            selected={startDate} 
                                                            placeholderText='Choose date and time'   onChange={(date) => setStartDate(date as Date)} />
                                    ...
                                    <div className="md:flex px-4 py-6 items-center justify-between">
                                        ...
                                        <div className="mt-2 md:mt-0">
                                            <nav className="-mb-0.5 sm:flex sm:space-x-6 rtl:space-x-reverse flex-wrap" role='tablist'>
                                                <Link className="w-full flex sm:w-auto active hs-tab-active:font-semibold  hs-tab-active:text-primary hs-tab-active:bg-primary/10 rounded-md py-2 px-3 text-sm" href="#!" scroll={false} id="alltasks-item" data-hs-tab="#all-tasks" aria-controls="all-tasks">
                                                    All Tasks
                                                </Link>
                                                <Link className="w-full flex sm:w-auto hs-tab-active:font-semibold  hs-tab-active:text-primary hs-tab-active:bg-primary/10 rounded-md  py-2 px-3  text-sm" href="#!" scroll={false} id="pending-item" data-hs-tab="#pending" aria-controls="pending">
                                                    Pending
                                                </Link>
                                                <Link className="w-full flex sm:w-auto hs-tab-active:font-semibold  hs-tab-active:text-primary hs-tab-active:bg-primary/10 rounded-md  py-2 px-3  text-sm" href="#!" scroll={false} id="in-progress-item" data-hs-tab="#in-progress" aria-controls="in-progress">
                                                    In Progress
                                                </Link>
                                                <Link className="w-full flex sm:w-auto hs-tab-active:font-semibold  hs-tab-active:text-primary hs-tab-active:bg-primary/10 rounded-md  py-2 px-3 text-sm" href="#!" scroll={false} id="completed-item" data-hs-tab="#completed" aria-controls="completed">
                                                    Completed
                                                </Link>
                                            </nav>
                                        </div>
                                        <div className="mt-2 md:mt-0">
                                            <div className="hs-dropdown ti-dropdown">
                                                ...
                                                <ul className="hs-dropdown-menu ti-dropdown-menu hidden">
                                                    <li><Link className="ti-dropdown-item !py-2 !px-[0.9375rem] !text-[0.8125rem] !font-medium block" href="#!" scroll={false}>Select All</Link></li>
                                                    <li><Link className="ti-dropdown-item !py-2 !px-[0.9375rem] !text-[0.8125rem] !font-medium block" href="#!" scroll={false}>Share All</Link></li>
                                                    <li><Link className="ti-dropdown-item !py-2 !px-[0.9375rem] !text-[0.8125rem] !font-medium block" href="#!" scroll={false}>Delete All</Link></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div className="xl:col-span-4 col-span-12 task-card">
                                            <div className="box task-pending-card">
                                                <div className="box-body">
                                                    <div className="flex justify-between flex-wrap gap-2">
                                                        <div>
                                                            <p className="font-semibold mb-4 flex items-center"><Link aria-label="anchor" href="#!" scroll={false}><i className="ri-star-s-fill text-[1rem] opacity-[0.5] me-1 text-[#8c9097] dark:text-white/50"></i></Link>New Project Blueprint</p>
                                            ...
                                            <div className="box task-inprogress-card">
                                                <div className="box-body">
                                                    <div className="flex justify-between flex-wrap gap-2">
                                                        <div>
                                                            <p className="font-semibold mb-4 flex items-center"><Link aria-label="anchor" href="#!" scroll={false}><i className="ri-star-s-fill text-[1rem] me-1 text-warning"></i></Link>Designing New Authentication Pages</p>
                                                    ...
                                                    <div className="flex justify-between flex-wrap gap-2">
                                                        <div>
                                                            <p className="font-semibold mb-4 flex items-center">
                                                                <Link aria-label="anchor" href="#!" scroll={false}><i className="ri-star-s-fill text-[1rem] opacity-[0.5] me-1 text-[#8c9097] dark:text-white/50"></i></Link>Developing New Events in Plugin</p>
                                        ...
                                        <div className="xl:col-span-4 col-span-12 task-card">
                                            <div className="box task-inprogress-card">
                                                <div className="box-body">
                                                    <div className="flex justify-between flex-wrap gap-2">
                                                        <div>
                                                            <p className="font-semibold mb-4 flex items-center"><Link aria-label="anchor" href="#!" scroll={false}><i className="ri-star-s-fill text-[1rem] me-1 text-warning"></i></Link>Design New Landing Pages </p>
                                            ...
                                            <div className="box task-completed-card">
                                                <div className="box-body">
                                                    <div className="flex justify-between flex-wrap gap-2">
                                                        <div>
                                                            <p className="font-semibold mb-4 flex items-center"><Link aria-label="anchor" href="#!" scroll={false}><i className="ri-star-s-fill text-[1rem] opacity-[0.5] me-1 text-[#8c9097] dark:text-white/50"></i></Link>New Plugin Development</p>
                                            ...
                                            <div className="box task-completed-card">
                                                <div className="box-body">
                                                    <div className="flex justify-between flex-wrap gap-2">
                                                        <div>
                                                            <p className="font-semibold mb-4 flex items-center"><Link aria-label="anchor" href="#!" scroll={false}><i className="ri-star-s-fill text-[1rem] opacity-[0.5] me-1 text-[#8c9097] dark:text-white/50"></i></Link>Documentation For New Template</p>
                                        ...
                                        <div className="xl:col-span-4 col-span-12 task-card">
                                            <div className="box task-pending-card">
                                                <div className="box-body">
                                                    <div className="flex justify-between flex-wrap gap-2">
                                                        <div>
                                                            <p className="font-semibold mb-4 flex items-center">
                                                                <Link aria-label="anchor" href="#!" scroll={false}><i className="ri-star-s-fill text-[1rem] me-1 text-warning"></i></Link>Updating Old Ui</p>
                                            ...
                                            <div className="box task-completed-card">
                                                <div className="box-body">
                                                    <div className="flex justify-between flex-wrap gap-2">
                                                        <div>
                                                            <p className="font-semibold mb-4 flex items-center"><Link aria-label="anchor" href="#!" scroll={false}><i className="ri-star-s-fill text-[1rem] opacity-[0.5] me-1 text-[#8c9097] dark:text-white/50"></i></Link>Designing Of New Ecommerce Pages</p>
                                            ...
                                            <div className="box task-inprogress-card">
                                                <div className="box-body">
                                                    <div className="flex justify-between flex-wrap gap-2">
                                                        <div>
                                                            <p className="font-semibold mb-4 flex items-center"><Link aria-label="anchor" href="#!" scroll={false}><i className="ri-star-s-fill text-[1rem] me-1 text-warning"></i></Link>Improving Ui Of Updated Templates</p>
