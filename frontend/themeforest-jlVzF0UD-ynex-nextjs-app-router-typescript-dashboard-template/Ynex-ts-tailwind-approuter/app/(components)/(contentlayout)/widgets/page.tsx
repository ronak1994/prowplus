...
"use client"
import { WorldMap } from '@/shared/data/widgets/widgetsdata'
                            ...
                            <div className="flex items-start">
                                ...
                                <div className="flex-grow">
                                    ...
                                    <div className="flex flex-wrap items-center justify-between">
                                        ...
                                        <div id="btcCoin">
                                            <ReactApexChart options={Widgetsdata.Bitcoin.options} series={Widgetsdata.Bitcoin.series} type="line" height={20} width={100} />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start">
                                ...
                                <div className="flex-grow">
                                    ...
                                    <div className="flex flex-wrap items-center justify-between">
                                        ...
                                        <div id="ethCoin">
                                            <ReactApexChart options={Widgetsdata.Ethereum.options} series={Widgetsdata.Ethereum.series} type="line" height={20} width={100} />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start">
                                ...
                                <div className="flex-grow">
                                    ...
                                    <div className="flex flex-wrap items-center justify-between">
                                        ...
                                        <div id="dshCoin">
                                            <ReactApexChart options={Widgetsdata.Dash.options} series={Widgetsdata.Dash.series} type="line" height={20} width={100} />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start">
                                ...
                                <div className="flex-grow">
                                    ...
                                    <div className="flex flex-wrap items-center justify-between">
                                        ...
                                        <div id="glmCoin">
                                            <ReactApexChart options={Widgetsdata.Golem.options} series={Widgetsdata.Golem.series} type="line" height={20} width={100} />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="box custom-box box-bg-primary">
                                <div className="box-body">
                                    <div className="flex items-start mb-2">
                                        ...
                                        <div className="ms-2">
                                            <span className="avatar avatar-md bg-secondary shadow-sm text-[1.125rem] text-white">
                        ...
                        <div className="xl:col-span-6 col-span-12">
                            <div className="box custom-box overflow-hidden">
                                <div className="box-body !p-0">
                                    ...
                                    <div id="totalRevenue">
                                        <ReactApexChart options={Widgetsdata.TotalRevenue.options} series={Widgetsdata.TotalRevenue.series} type="area" width={"100%"} height={180} />
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="box custom-box">
                                <div className="box-body">
                                    <div className="flex items-center mb-4">
                                        ...
                                        <div>
                                            <Link href="#!" scroll={false} className="ti-btn ti-btn-icon ti-btn-primary !rounded-full btn-wave mb-0" aria-label="View All"><i className="bi bi-chevron-right rtl:rotate-180"></i></Link>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-center justify-between">
                                        <div className="avatar-list-stacked">
                                            <Link href="#!" scroll={false} className="avatar avatar-sm rounded-circle overflow-hidden" aria-label="Mis x matched"><img src="../assets/images/faces/2.jpg" alt="img" className="w-full" /></Link>
                                            <Link href="#!" scroll={false} className="avatar avatar-sm rounded-circle overflow-hidden" aria-label="Barbel Bob"><img src="../assets/images/faces/12.jpg" alt="img" className="w-full" /></Link>
                                            <Link href="#!" scroll={false} className="avatar avatar-sm rounded-circle overflow-hidden" aria-label="Phan Rel"><img src="../assets/images/faces/20.jpg" alt="img" className="w-full" /></Link>
                                            <Link href="#!" scroll={false} className="avatar avatar-sm rounded-circle overflow-hidden bg-primary text-white" >+4</Link>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="box-body">
                                    <div className="flex items-center">
                                        <div className="flex-grow">
                                            ...
                                            <p className="mb-0 text-[.6875rem]"><Link href="#!" scroll={false} className="text-success underline">View All</Link></p>
                                        </div>
                                        <div className="ms-2">
                                            <span className="avatar !bg-info !text-white !rounded-full text-[1.25rem]"><i className="bi bi-people-fill text-white"></i></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="xl:col-span-12 col-span-12">
                            <div className="box custom-box box-bg-primary">
                                <div className="box-header !bg-white/20 !border-b-0 justify-between">
                                    ...
                                    <div>
                                        <button aria-label="button" type="button" className="ti-btn ti-btn-sm !bg-primary !mb-0 rtl:rotate-180"><i className="ti ti-chevron-right rtl:rotate-180"></i></button>
                                    </div>
                                </div>
                                <div className="box-body">
                                ...
                                <div className="box-body !p-0">
                                    <div className="p-4">
                                        <div className="flex flex-wrap mb-1">
                                            <Link aria-label="anchor" href="#!" scroll={false} className="pe-2">
                                        ...
                                        <div className="flex items-center">
                                            <Link href="#!" scroll={false} className="flex-grow ti-btn !py-1 !px-2 !text-[0.75rem] ti-btn-light me-2">Short</Link>
                                            <Link href="#!" scroll={false} className="flex-grow ti-btn !py-1 !px-2 !text-[0.75rem] ti-btn-primary">Buy</Link>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="box-body">
                            <div className="flex items-start justify-between mb-6">
                                ...
                                <div className="hs-dropdown ti-dropdown">
                                    <Link aria-label="anchor" href="#!" scroll={false} className="ti-btn ti-btn-icon ti-btn-sm ti-btn-light"><i className="ti ti-dots"></i></Link>
                                    <ul className="hs-dropdown-menu ti-dropdown-menu hidden">
                                        <li><Link href="#!" scroll={false} className="ti-dropdown-item">Action</Link></li>
                                        <li><Link href="#!" scroll={false} className="ti-dropdown-item">Another Action</Link></li>
                                        <li><Link href="#!" scroll={false} className="ti-dropdown-item">Something Else Here</Link></li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center">
                                <div className="flex-grow">
                                    <div className="progress progress-xs">
                                        <div className="progress-bar bg-primary w-[14%]" role="progressbar" aria-valuenow={15} aria-valuemin={0} aria-valuemax={100}></div>
                                    </div>
                                </div>
                                <div className="ms-3">
                    ...
                    <div className="box custom-box">
                        <div className="box-body">
                            ...
                            <div className="flex items-center">
                                <div className="flex-grow">
                                    <div className="progress progress-xs">
                                        <div className="progress-bar !bg-secondary w-[55%]" role="progressbar" aria-valuenow={55} aria-valuemin={0} aria-valuemax={100}></div>
                                    </div>
                                </div>
                                <div className="ms-3">
                    ...
                    <div className="box custom-box">
                        <div className="box-body">
                            ...
                            <div className="flex items-center">
                                <div className="flex-grow">
                                    <div className="progress progress-xs">
                                        <div className="progress-bar !bg-success w-[24%]" role="progressbar" aria-valuenow={24} aria-valuemin={0} aria-valuemax={100}></div>
                                    </div>
                                </div>
                                <div className="ms-3">
                    ...
                    <div className="box custom-box">
                        <div className="box-body">
                            ...
                            <div className="flex items-center">
                                <div className="flex-grow">
                                    <div className="progress progress-xs">
                                        <div className="progress-bar !bg-indigo w-[67%]"  role="progressbar" aria-valuenow={67} aria-valuemin={0} aria-valuemax={100}></div>
                                    </div>
                                </div>
                                <div className="ms-3">
                                    ...
                                    <div className="flex flex-wrap items-start p-6">
                                        <div className="me-4 leading-none">
                                            <span className="avatar avatar-md !rounded-full !bg-primary shadow-sm">
                                                <i className="ti ti-package text-[1.125rem] text-white"></i>
                                            </span>
                                        </div>
                                        <div className="flex-grow">
                                    ...
                                    <div className="flex flex-wrap items-start p-6">
                                        <div className="me-3 leading-none">
                                            <span className="avatar avatar-md !rounded-full bg-secondary shadow-sm">
                                                <i className="ti ti-rocket text-[1.125rem] text-white"></i>
                                            </span>
                                        </div>
                                        <div className="flex-grow">
                                    ...
                                    <div className="flex flex-wrap items-start p-6">
                                        <div className="me-3 leading-none">
                                            <span className="avatar avatar-md !rounded-full bg-success shadow-sm">
                                                <i className="ti ti-wallet text-[1.125rem] text-white"></i>
                                            </span>
                                        </div>
                                        <div className="flex-grow">
                                    ...
                                    <div className="flex flex-wrap items-start p-6">
                                        <div className="me-3 leading-none">
                                            <span className="avatar avatar-md !rounded-full bg-warning shadow-sm">
                                                <i className="ti ti-packge-import text-[1.125rem] text-white"></i>
                                            </span>
                                        </div>
                                        <div className="flex-grow">
                        ...
                        <div className="box-body">
                            <div className="text-center">
                                <span className="avatar avatar-md bg-primary shadow-sm !rounded-full mb-2">
                                    <i className="ri-briefcase-2-line text-[1rem] text-white"></i>
                                </span>
                        ...
                        <div className="box-body">
                            <div className="text-center">
                                <span className="avatar avatar-md bg-secondary shadow-sm !rounded-full mb-2">
                                    <i className="ri-bill-line text-[1rem] text-white"></i>
                                </span>
                        ...
                        <div className="box-body">
                            <div className="text-center">
                                <span className="avatar avatar-md bg-success shadow-sm !rounded-full mb-2">
                                    <i className="ri-wallet-2-line text-[1rem] text-white"></i>
                                </span>
                        ...
                        <div className="box-body">
                            <div className="text-center">
                                <span className="avatar avatar-md bg-info shadow-sm !rounded-full mb-2">
                                    <i className="ri-line-chart-line text-[1rem] text-white"></i>
                                </span>
                        ...
                        <div className="box-body">
                            <div className="text-center">
                                <span className="avatar avatar-md bg-warning shadow-sm !rounded-full mb-2">
                                    <i className="ri-money-dollar-box-line text-[1rem] text-white"></i>
                                </span>
                                ...
                                <li className="timeline-widget-list">
                                    <div className="flex items-start">
                                        ...
                                        <div className="flex flex-wrap flex-grow items-center justify-between">
                                            ...
                                            <div className="hs-dropdown ti-dropdown">
                                                <Link aria-label="anchor" href="#!" scroll={false} className="p-2 text-[1rem] text-[#8c9097] dark:text-white/50">
                                ...
                                <table className="table table-bordered table-hover whitespace-nowrap min-w-full">
                                    ...
                                    <tbody>
                                        <tr className="border border-defaultborder ">
                                            ...
                                            <td>
                                                <div className="progress progress-xs">
                                                    <div className="progress-bar bg-primary w-[34%]" role="progressbar" aria-valuenow={34} aria-valuemin={0} aria-valuemax={100}>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr className="border border-defaultborder ">
                                            ...
                                            <td>
                                                <div className="progress progress-xs">
                                                    <div className="progress-bar bg-primary w-[58%]" role="progressbar" aria-valuenow={58} aria-valuemin={0} aria-valuemax={100}>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr className="border border-defaultborder ">
                                            ...
                                            <td>
                                                <div className="progress progress-xs">
                                                    <div className="progress-bar bg-primary w-[62%]" role="progressbar" aria-valuenow={62} aria-valuemin={0} aria-valuemax={100}>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr className="border border-defaultborder ">
                                            ...
                                            <td>
                                                <div className="progress progress-xs">
                                                    <div className="progress-bar bg-primary w-[71%]" role="progressbar" aria-valuenow={71} aria-valuemin={0} aria-valuemax={100}>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr className="border border-defaultborder ">
                                            ...
                                            <td>
                                                <div className="progress progress-xs">
                                                    <div className="progress-bar bg-primary w-[48%]" role="progressbar" aria-valuenow={48} aria-valuemin={0} aria-valuemax={100}>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr className="border border-defaultborder ">
                                            ...
                                            <td>
                                                <div className="progress progress-xs">
                                                    <div className="progress-bar bg-primary w-[28%]" role="progressbar" aria-valuenow={28} aria-valuemin={0} aria-valuemax={100}>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                ...
                <div className="xl:col-span-6 col-span-12">
                    <div className="box custom-box">
                        <div className="box-header justify-between">
                            ...
                            <div className="hs-dropdown ti-dropdown">
                                <Link href="#!" scroll={false} className="p-2 text-[0.75rem] text-[#8c9097] dark:text-white/50">
                                    View All<i className="ri-arrow-down-s-line align-middle ms-1"></i>
                                </Link>
                                <ul className="hs-dropdown-menu ti-dropdown-menu hidden" role="menu">
                                    <li><Link className="ti-dropdown-item" href="#!" scroll={false}>Download</Link></li>
                                    <li><Link className="ti-dropdown-item" href="#!" scroll={false}>Import</Link></li>
                                    <li><Link className="ti-dropdown-item" href="#!" scroll={false}>Export</Link></li>
                                </ul>
                            </div>
                        </div>
                        <div className="box-body">
                                        ...
                                        <tr className="border border-defaultborder">
                                            ...
                                            <td>
                                                <div className="avatar-list-stacked">
                                                    ...
                                                    <Link className="avatar avatar-xs bg-primary !rounded-full text-white" href="#!" scroll={false}>
                                                        +2
                                                    </Link>
                                                </div>
                                            </td>
            ...
            <div className="grid grid-cols-12 gap-6">
                <div className="xl:col-span-4 col-span-12">
                    <div className="box custom-box">
                        ...
                        <div className="box-body">
                            <div id="views">
                                <ReactApexChart options={Widgetsdata.Applicants.options} series={Widgetsdata.Applicants.series} type="line" width={"100%"} height={350} />
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="box custom-box">
                        ...
                        <div className="box-body">
                            <div id="sessionsByDevice">
                                <ReactApexChart options={Widgetsdata.Sessions.options} series={Widgetsdata.Sessions.series} type="bubble" width={"100%"} height={350} />
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="box custom-box">
                        <div className="box-header">
                            ...
                            <div className="ms-auto hs-dropdown ti-dropdown">
                                <Link href="#!" scroll={false} className="ti-btn !py-1 !px-2 !text-[0.75rem] ti-btn-primary dropdown-toggle" aria-expanded="false">
                                    Details<i className="ri-arrow-down-s-line align-middle inline-block"></i>
                                </Link>
                                <ul className="hs-dropdown-menu ti-dropdown-menu hidden">
                                    <li><Link className="ti-dropdown-item" href="#!" scroll={false}>Action</Link></li>
                                    <li><Link className="ti-dropdown-item" href="#!" scroll={false}>Another action</Link></li>
                        ...
                        <div className="box-body pb-4">
                            ...
                            <div id="report">
                                <ReactApexChart options={Widgetsdata.Targetreport.options} series={Widgetsdata.Targetreport.series} type="bar" width={"100%"} height={235} />
                            </div>
                        </div>
                    </div>
                </div>
