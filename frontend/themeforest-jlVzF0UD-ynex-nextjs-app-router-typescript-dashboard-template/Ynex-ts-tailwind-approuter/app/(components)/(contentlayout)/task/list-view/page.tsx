...
import * as Listdata from '@/shared/data/apps/crypto/transactiondata'
                    ...
                    <div className="box">
                        <div className="box-body !p-0">
                            ...
                            <div className="p-6 pb-2">
                                ...
                                <ReactApexChart options={Listdata.TransactionsStatistics.options} series={Listdata.TransactionsStatistics.series} type="bar" width={"100%"} height={210} />
                                </div>
                            </div>
                        </div>
                    </div>
