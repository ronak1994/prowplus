              ...
              <form className="ti-validation">
                <div className="grid lg:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <DatePicker selected={startDate}  className="ti-form-input" showIcon onChange={(date) => setStartDate(date as Date)} />
                  </div>
                  <div className="space-y-2">
                ...
                <div className="my-5 flex items-center">
                  <input className="form-check-input" type="checkbox" id="invalidCheck1" defaultValue="" required />
                  <label htmlFor="hs-checkbox-group-1" className="!inline text-sm text-gray-500 ms-3 dark:text-[#8c9097] dark:text-white/50">I agree with the <Link href="/pages/terms&conditions/" className="text-primary hover:underline ms-1">terms and conditions</Link></label>
                </div>
            ...
            <div className="box-body">
              <form className="ti-custom-validation" noValidate>
                <div className="grid lg:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    <label className="ti-form-label dark:text-defaulttextcolor/70 mb-0">Date Of Birth</label>
                    <DatePicker className="ti-form-input" showIcon selected={startDate1} onChange={(date) => setStartDate1(date as Date)} />
                ...
                <div className="my-5 flex items-center">
                  <input className="form-check-input" type="checkbox" id="invalidCheck2" defaultValue="" required />
                  <span className="checkboxError text-red-500 text-xs hidden">error</span>
                  <label htmlFor="hs-checkbox-group-12" className="!inline text-sm text-gray-500 ms-3 dark:text-[#8c9097] dark:text-white/50">I agree with the <Link href="/pages/terms&conditions/" className="text-primary hover:underline">terms and conditions</Link></label>
                </div>
