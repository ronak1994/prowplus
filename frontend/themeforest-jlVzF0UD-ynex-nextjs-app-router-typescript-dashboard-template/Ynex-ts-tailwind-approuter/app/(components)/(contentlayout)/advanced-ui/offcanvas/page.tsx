"use client"
import { offcanvas1, offcanvas2, offcanvas3, offcanvas4, offcanvas5, offcanvas6 } from '@/shared/data/prism/advance-uiprism'
            ...
            <Pageheader currentpage="Offcanvas" activepage=" Advanced Ui" mainpage="Offcanvas" />
                    ...
                    <div className="grid grid-cols-12 gap-6">
                        <div className="xl:col-span-4 col-span-12">
                                <Showcode title="Live Demo" code={offcanvas1} customCardClass="custom-box">
                        ...
                        <div className="xl:col-span-4 col-span-12">
                                ...
                                <Showcode title="Enable body scrolling" code={offcanvas2} customCardClass="custom-box">
                    ...
                    <div className="grid grid-cols-12 gap-6">
                        <div className="xl:col-span-6 col-span-12">
                                <Showcode title="Enable Body scrolling and backdrop" code={offcanvas4} customCardClass="custom-box">
                        ...
                        <div className="xl:col-span-6 col-span-12">
                                <Showcode title="Custom Backdrop color" code={offcanvas5} customCardClass="custom-box">
                        ...
                        <div className="xl:col-span-12 col-span-12">
                                <Showcode title="Placement" code={offcanvas6} customCardClass="custom-box">
                                    ...
                                    <button type="button" className="ti-btn ti-btn-primary-full me-2" data-hs-overlay="#hs-overlay-bottom">
