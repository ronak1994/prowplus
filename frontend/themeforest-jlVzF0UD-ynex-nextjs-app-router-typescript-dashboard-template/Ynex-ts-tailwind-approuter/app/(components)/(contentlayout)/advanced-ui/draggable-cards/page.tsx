            ...
            <div className="grid grid-cols-12 gap-6">
                <div className="xl:col-span-6 col-span-12" id="draggable-left" ref={leftContainerRef} onMouseEnter={OnDivChange}>
                    <div className="box custom-box box-bg-primary">
                        <Link aria-label="anchor" href="#!" scroll={false} className="box-anchor"></Link>
                    ...
                    <div className="box box-data">
                        ...
                        <div className="box-body deals-content" onClick={handleBoxClick}>
                ...
                <div className="xl:col-span-6 col-span-12" id="draggable-right" ref={rightContainerRef} onMouseEnter={OnDivChange}>
                    ...
                    <div className="box custom-box">
                        <div className="box-header justify-between">
                            ...
                            <Link aria-label="anchor" className="hs-collapse-toggle inline-flex items-center gap-x-2 " href="#!" scroll={false} id="hs-show-hide-collapse" data-hs-collapse="#hs-show-hide-collapse-heading">
                        ...
                        <div id="hs-show-hide-collapse-heading" className="hs-collapse show w-full overflow-hidden  transition-[height] duration-300" aria-labelledby="hs-show-hide-collapse">
                            <div className="box-body deals-content">
                                <h6 className="box-text font-semibold">Collapsible card</h6>
                    ...
                    <div className="box custom-box" id="dismiss-alert33">
                        <div className="box-header justify-between">
                            <div className="box-title">
