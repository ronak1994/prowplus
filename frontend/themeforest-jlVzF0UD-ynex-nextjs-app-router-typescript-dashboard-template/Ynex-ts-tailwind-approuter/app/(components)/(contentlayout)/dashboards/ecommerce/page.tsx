"use client"
import { Countries,  ProductsOverview, Recentorders } from '@/shared/data/dashboards/ecommercedata'
                            ...
                            <div className="box overflow-hidden">
                                <div className="ecommerce-sale-image">
                                    ...
                                    <div className="card-img-overlay  p-6 text-white">
                                        ...
                                        <p className="ecommerce-bankoffer-details mb-4">Bank Offer 10% off on Aches Bank Credit Cards, up to $10. On orders of $500 and above <Link href="#!" scroll={false} className="underline text-white">T&amp;C</Link></p>
                                ...
                                <div className="box-body">
                                    <Link href="#!" scroll={false} className="text-primary text-[0.9375rem] font-semibold">Biggest sale is back.</Link>
                                    <p className="mb-6">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Labore harum accusamus eum dolorum sapiente. Saepe</p>
                                    <button type="button" className="tibtn ti-btn-primary-full ti-btn-wave !py-[0.55rem] !px-[0.95rem] gap-2 rounded-[0.35rem] text-[0.85rem] font-medium !shadow-none me-3">Notify Me</button>
                            ...
                            <div className="box">
                                <div className="box-header justify-between">
                                    ...
                                    <div className="hs-dropdown ti-dropdown">
                                        <Link aria-label="anchor" href="#!" scroll={false} className="flex items-center justify-center w-[1.75rem] h-[1.75rem] !text-defaulttextcolor !text-[0.8rem] !py-1 !px-2 rounded-sm bg-light border-light shadow-none !font-medium"
                                            aria-expanded="false"><i className="fe fe-more-vertical text-[0.8rem]"></i>
                                        </Link>
                                        <ul className="hs-dropdown-menu ti-dropdown-menu hidden">
                                            <li><Link className="ti-dropdown-item !py-2 !px-[0.9375rem] !text-[0.8125rem] !font-medium block" href="#!" scroll={false}>Action</Link></li>
                                            <li><Link className="ti-dropdown-item !py-2 !px-[0.9375rem] !text-[0.8125rem] !font-medium block" href="#!" scroll={false}>Another action</Link></li>
                                            <li><Link className="ti-dropdown-item !py-2 !px-[0.9375rem] !text-[0.8125rem] !font-medium block" href="#!" scroll={false}>Something else here</Link></li>
                                        </ul>
                                    </div>
                                </div>
                                <div className="box-body">
                        ...
                        <div className="xl:col-span-12 col-span-12">
                            <div className="box">
                                ...
                                <div className="box-body">
                                    ...
                                    <div id="earnings">
                                        <ReactApexChart options={Ecommercedata.Earning.options} series={Ecommercedata.Earning.series} type="bar" width={"100%"} height={200} />
                                    </div>
                                </div>
                            </div>
                        </div>
