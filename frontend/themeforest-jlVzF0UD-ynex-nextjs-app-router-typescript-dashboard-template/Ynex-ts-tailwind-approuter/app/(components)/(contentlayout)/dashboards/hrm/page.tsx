                    ...
                    <div className="box">
                        ...
                        <div className="box-body">
                            <div id="performanceReport">
                                <ReactApexChart options={Hrmdata.Performancebycategory.options} series={Hrmdata.Performancebycategory.series} type="bar" width={"100%"} height={310} />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="xxl:col-span-3 xl:col-span-6 lg:col-span-6 md:col-span-12 col-span-12">
                    <div className="box">
                        ...
                        <div className="box-body !p-6">
                            <div id="jobs-summary">
                                <ReactApexChart options={Hrmdata.JobsSummary.options} series={Hrmdata.JobsSummary.series} type="donut" width={"100%"} height={247} />
                            </div>
                        </div>
                                        ...
                                        <div className="flex flex-wrap flex-grow items-start justify-between">
                                            ...
                                            <div>
                                                <div className="hs-dropdown ti-dropdown">
                                                    <Link aria-label="anchor" href="#!" scroll={false} className="text-[1rem] text-[#8c9097] dark:text-white/50">
                                ...
                                <table className="table whitespace-nowrap min-w-full">
                                    ...
                                    <tbody>
                                        <tr className="border-t border-defaultborder dark:border-defaultborder/10">
                                            ...
                                            <td>
                                                <div className="hs-dropdown ti-dropdown">
                                                    <Link aria-label="anchor" href="#!" scroll={false} className="ti-btn ti-btn-outline-light text-white !py-1 !px-2 !text-[0.75rem] !m-0 !gap-0 !font-medium">
                                                        Active <i className="ri-arrow-down-s-line align-middle ms-1 inline-block"></i>
                                                    </Link>
                                                    <ul className="hs-dropdown-menu ti-dropdown-menu hidden">
                                                        <li><Link className="ti-dropdown-item !py-2 !px-[0.9375rem] !text-[0.8125rem] !font-medium block"
                                                            href="#!" scroll={false}>Active</Link></li>
                                                        <li><Link className="ti-dropdown-item !py-2 !px-[0.9375rem] !text-[0.8125rem] !font-medium block"
                                                            href="#!" scroll={false}>In Active</Link></li>
                                                    </ul>
                                                </div>
                                            </td>
                                            <td>
