"use client"
import { Courselist,  Payouts } from '@/shared/data/dashboards/coursedata'
import Pageheader from '@/shared/layout-components/page-header/pageheader'
import Seo from '@/shared/layout-components/seo/seo'
import Link from 'next/link'
import React, { Fragment } from 'react'
import * as Coursedata from "@/shared/data/dashboards/coursedata";
                            ...
                            <div className="box">
                                ...
                                <div className="box-body">
                                    <div id="courses-earnings">
                                        <ReactApexChart options={Coursedata.Earningsreport.options} series={Coursedata.Earningsreport.series} type="bar" width={"100%"} height={340} />
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div className="flex flex-wrap items-start gap-2">
                                        <div className="me-1">
                                            <span className="avatar avatar-lg bg-primary">
                                                <i className="ti ti-wallet text-[1.25rem] text-white custom-lg-icon"></i>
                                            </span>
                                        </div>
                                        <div className="flex-grow">
                                            ...
                                            <Link href="#!" scroll={false} className="text-primary text-[0.75rem]">View All<i className="ti ti-arrow-narrow-right ms-2 font-semibold inline-block"></i></Link>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div className="flex flex-wrap gap-2 items-start">
                                        <div className="me-1">
                                            <span className="avatar avatar-lg bg-secondary text-white">
                                                <i className="ti ti-users text-[1.25rem] custom-lg-icon"></i>
                                            </span>
                                        </div>
                                        <div className="flex-grow">
                                            ...
                                            <Link href="#!" scroll={false} className="text-secondary text-[0.75rem]">View All<i className="ti ti-arrow-narrow-right ms-2 font-semibold inline-block"></i></Link>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div className="flex flex-wrap gap-2 items-start">
                                        <div className="me-1">
                                            <span className="avatar avatar-lg bg-warning text-white">
                                                <i className="ti ti-id text-[1.25rem] custom-lg-icon"></i>
                                            </span>
                                        </div>
                                        <div className="flex-grow">
                                            ...
                                            <Link href="#!" scroll={false} className="text-warning text-[0.75rem]">View All<i className="ti ti-arrow-narrow-right ms-2 font-semibold inline-block"></i></Link>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div className="flex flex-wrap gap-2 items-start">
                                        <div className="me-1">
                                            <span className="avatar avatar-lg bg-danger text-white">
                                                <i className="ti ti-gift text-[1.25rem] custom-lg-icon"></i>
                                            </span>
                                        </div>
                                        <div className="flex-grow">
                                            ...
                                            <Link href="#!" scroll={false} className="text-danger text-[0.75rem]">View All<i className="ti ti-arrow-narrow-right ms-2 font-semibold inline-block"></i></Link>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="box">
                        ...
                        <div className="box-body">
                            <div id="course-payouts">
                                <ReactApexChart options={Coursedata.Payouts.options} series={Coursedata.Payouts.series} type="line" width={"100%"} height={260} />
                            </div>
                        </div>
                    </div>
                </div>
