                    ...
                    <div className="box">
                        <div className="box-body">
                            ...
                            <p className="mb-0 text-[#8c9097] dark:text-white/50 text-[0.6875rem] opacity-[0.7]">Top offers on USD-27,981
                                <span className="text-success font-semibold ms-1 inline-block">(+29.09%)</span></p>
                            <div id="nft-balance-chart" className="px-4 py-6">
                                <ReactApexChart options={Nftdata.Totalbalance.options} series={Nftdata.Totalbalance.series} type="line" width={"100%"} height={40} />
                            </div>
            ...
            <div className="grid grid-cols-12 gap-x-6">
                <div className="xxl:col-span-3 xl:col-span-12 lg:col-span-12 col-span-12">
                    <div className="box">
                        ...
                        <div className="box-body !p-0 max-h-[28.5rem] overflow-auto" id="top-collector">
                            <div className="table-responsive">

                                <table className="table ti-custom-table-hover whitespace-nowrap min-w-full">
                                    <tbody>
                                            ...
                                            <tr className={`border !border-x-0 border-defaultborder dark:border-defaultborder/10 ${idx.class}`} key={Math.random()}>
                                                ...
                                                <td>
                                                    <div className="progress progress-xs progress-animate !w-[3.125rem] nft-collector-progress">
                                                        <div className={`progress-bar bg-primary-gradient ${idx.progress}`} aria-valuenow={75} aria-valuemin={0} aria-valuemax={100} area-aria-orientation='' role="progressbar"></div>
                                                    </div>
                                                </td>
                                                <td>
                    ...
                    <div className="box">
                        ...
                        <div className="box-body !p-0">
                            ...
                            <div id="nft-statistics" className="p-3">
                                <ReactApexChart options={Nftdata.NFTStatistics.options} series={Nftdata.NFTStatistics.series} type="line" width={"100%"} height={336} />
                            </div>
                        </div>
                    </div>
                </div>
                <div className="xxl:col-span-3 xl:col-span-4 lg:col-span-5 md:col-span-12 sm:col-span-12 col-span-12">
                    ...
                    autoplay={{ delay: 2500, disableOnInteraction: false, }}
                                        ...
                                        <div className="flex items-center flex-grow">
                                            ...
                                            <div>
                                                <p className="mb-0 font-semibold"><Link
                                                    href="#!" scroll={false}>Simon Cowell</Link></p>
                                ...
                                <div className="box-footer">
                                    <div className="flex items-center">
                                        <div className="flex items-center flex-grow">
                                            ...
                                            <div>
                                                <p className="mb-0 font-semibold"><Link href="#!" scroll={false}>Melissa
                                                    Smith</Link></p>
                        ...
                        <SwiperSlide className="rtl:dir-rtl">
                            <div className="box custom-box collections-data">
                                <div className="box-body">
                                    <div className="grid grid-cols-12 gap-2">
                                        <div className="col-span-6">
                                ...
                                <div className="box-footer">
                                    <div className="flex items-center">
                                        <div className="flex items-center flex-grow">
                                            ...
                                            <div>
                                                <p className="mb-0 font-semibold"><Link href="#!" scroll={false}>Json
                                                    Talor</Link></p>
                                            ...
                                            <tr className="border border-inherit border-solid hover:bg-gray-100 dark:hover:bg-light dark:border-defaultborder/10" key={Math.random()}>
                                                <td className=''>
                                                    <div className="flex items-center">
                                                        ...
                                                        <div>
                                                            <p className="mb-0 font-semibold"><Link href="#!" scroll={false} title="nft_name">{idx.name}</Link></p>
                                                            <Link href="#!" scroll={false} className="text-[0.75rem] text-[#8c9097] dark:text-white/50 font-normal" title="creator_name">{idx.mail}</Link>
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td>
                                                    <div className="flex items-center">
                                                        ...
                                                        <div>
                                                            <p className="mb-0 font-semibold"><Link href="#!" scroll={false} title="nft_name">{idx.volume}</Link></p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <div className="flex items-center">
                                                        <img src="../../assets/images/crypto-currencies/regular/Ethereum.svg" alt="" className="avatar avatar-xs avatar-rounded me-2 leading-none" />
                                                        <div>
                                                            <p className="mb-0 font-semibold"><Link href="#!" scroll={false} title="nft_name">{idx.price}</Link></p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>{idx.items}</td>
                                            ...
                                            <div className="flex flex-wrapitems-center justify-between">
                                                <div className="flex items-center">
                                                    ...
                                                    <div>
                                                        ...
                                                        <span className="text-[#8c9097] dark:text-white/50 text-[0.75rem]">{idx.mail}<span className={`ms-2 text-${idx.color} text-[0.6875rem] inline-flex`}>{idx.icon}{idx.value}</span></span>
                                                    </div>
                                                </div>
                                                <div>
