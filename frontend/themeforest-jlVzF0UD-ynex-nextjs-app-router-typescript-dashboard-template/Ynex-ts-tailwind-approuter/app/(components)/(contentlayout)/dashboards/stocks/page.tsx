                            ...
                            <div className="md:flex block flex-wrap items-center justify-between">
                                <div className="flex-grow">
                                    <nav className="nav nav-pills nav-style-3 flex md:mb-0 mb-4" aria-label="Tabs" role="tablist">
                                        <Link href="#!" scroll={false} className="nav-link text-defaulttextcolor !py-[0.35rem] !px-4 text-sm !font-medium text-center rounded-md hover:text-primary active" id="portfolio-item" data-hs-tab="#Stocksportfolio" aria-controls="Stocksportfolio">
                                            Portfolio
                                        </Link>
                                        <Link href="#!" scroll={false} className="nav-link text-defaulttextcolor !py-[0.35rem] !px-4 text-sm !font-medium text-center rounded-md hover:text-primary" id="market-item" data-hs-tab="#Stocksmarket" aria-controls="Stocksmarket">
                                            Market
                                        </Link>
                                    </nav>
                                </div>
                                            ...
                                            <div className="flex gap-3 flex-wrap items-start justify-between">
                                                ...
                                                <div>
                                                    <div id="total-invested">
                                                        <ReactApexChart options={Stocksdata.TotalInvested.options} series={Stocksdata.TotalInvested.series} type="line" height={40} width={100} />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div className="flex gap-3 flex-wrap items-start justify-between">
                                                ...
                                                <div>
                                                    <div id="total-investments">
                                                        <ReactApexChart options={Stocksdata.NumberofInvested.options} series={Stocksdata.NumberofInvested.series} type="line" height={40} width={100} />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div className="flex gap-3 flex-wrap items-start justify-between">
                                                ...
                                                <div>
                                                    <div id="portfolio-value">
                                                        <ReactApexChart options={Stocksdata.Portfoliovalue.options} series={Stocksdata.Portfoliovalue.series} type="line" height={40} width={100} />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="box">
                                        <div className="box-body">
                                            <div className="flex gap-3 flex-wrap items-start justify-between">
                                                ...
                                                <div>
                                                    <div id="returns-rate">
                                                        <ReactApexChart options={Stocksdata.Returnsrate.options} series={Stocksdata.Returnsrate.series} type="line" height={40} width={100} />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="box">
                                        ...
                                        <div className="box-body">
                                            ...
                                            <div id="totalInvestmentsStats">
                                                <ReactApexChart options={Stocksdata.Totalinvestments.options} series={Stocksdata.Totalinvestments.series} type="area" width={"100%"} height={320} />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div className="box">
                                        <div className="box-header justify-between">
                                            ...
                                            <div className="hs-dropdown ti-dropdown">
                                                ...
                                                <ul className="hs-dropdown-menu ti-dropdown-menu hidden" role="menu">
                                                    <li><Link className="ti-dropdown-item !py-2 !px-[0.9375rem] !text-[0.8125rem] !font-medium block"
                                                        href="#!" scroll={false}>Buy</Link></li>
                                                    <li><Link className="ti-dropdown-item !py-2 !px-[0.9375rem] !text-[0.8125rem] !font-medium block"
                                                        href="#!" scroll={false}>Sell</Link></li>
                                                </ul>
                                            </div>
                                        </div>
                                        <div className="box-body">
                                                        ...
                                                        <div className="flex flex-wrap items-center justify-between">
                                                            ...
                                                            <div className="flex text-end">
                                                                <div>
                                                                    ...
                                                                    <span className="block"><Link href="#!" scroll={false} className="text-primary font-semibold">+ Compare</Link></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div id="stocks-marketcap">
                                                            <ReactApexChart options={Stocksdata.MarketCap.options} series={Stocksdata.MarketCap.series} type="candlestick" width={"100%"} height={350} />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="xl:col-span-5 col-span-12">
                                                    <div className="p-4 xl:!ps-0 overflow-x-auto">
                                                        <div className="table-responsive mb-[3rem]">
                                                            <table className="table whitespace-nowrap table-borderless text-[#8c9097] dark:text-white/70 min-w-full">
                                                                <tbody>
                                                        ...
                                                        <div>
                                                            ...
                                                            <div className="grid grid-cols-12 gap-x-6">
                                                                <div className="xl:col-span-6  col-span-12">
                                                                    <div className="table-responsive">
                                                                        <table className="table whitespace-nowrap table-sm text-center table-borderless text-[#8c9097] dark:text-white/70 min-w-full">
                                                                ...
                                                                <div className="xl:col-span-6  col-span-12">
                                                                    ...
                                                                    <div className="flex gap-3">
                                                                        <button type="button" className="flex-grow ti-btn ti-btn-sm bg-primary text-white">Buy</button>
                                                                        <button type="button" className="flex-grow ti-btn ti-btn-sm bg-secondary text-white me-3">Sell</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
