"use client"
import { Recentactivity, Selectdata1, Selectdata2, } from '@/shared/data/dashboards/cryptodata'
                                ...
                                <div className="box-body">
                                    <div className="flex items-center mb-5">
                                        ...
                                        <div className="ms-auto">
                                            <div id="btc-chart">
                                                <ReactApexChart options={Cryptodata.CryptoBTC.options} series={Cryptodata.CryptoBTC.series} type="line" height={40} width={120} />
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div className="box">
                                <div className="box-body">
                                    <div className="flex items-center mb-5">
                                        ...
                                        <div className="ms-auto">
                                            <div id="eth-chart">
                                                <ReactApexChart options={Cryptodata.CryptoETH.options} series={Cryptodata.CryptoETH.series} type="line" height={40} width={120} />
                                            </div>
                                        </div>
                                    </div>
                                    <div className="flex items-end">
                            ...
                            <div className="box">
                                <div className="box-body">
                                    <div className="flex items-center mb-5">
                                        ...
                                        <div className="ms-auto">
                                            <div id="dash-chart">
                                                <ReactApexChart options={Cryptodata.Cryptodash.options} series={Cryptodata.Cryptodash.series} type="line" height={40} width={120} />
                                            </div>
                                        </div>
                                    </div>
                                    <div className="flex items-end">
                            ...
                            <div className="box">
                                ...
                                <div className="box-body !p-0">
                                    ...
                                    <div id="crypto" className="p-4">
                                        <ReactApexChart options={Cryptodata.Statistics.options} series={Cryptodata.Statistics.series} type="candlestick" width={"100%"} height={258} />
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="box">
                                ...
                                <div className="box-body crypto-data">
                                    <nav className="tab-style-1 sm:flex bg-light p-[0.65rem] rounded-sm mb-4" aria-label="Tabs" role="tablist">
                                        <Link href="#!" scroll={false} className="hs-tab-active:bg-primary hs-tab-active:text-white text-defaulttextcolor py-[0.35rem] px-4 flex-grow  text-sm font-medium text-center rounded-md hover:text-primary active" id="buy-crypto" data-hs-tab="#buy-crypto2" >
                                            Buy
                                        </Link>
                                        <Link href="#!" scroll={false} className="hs-tab-active:bg-primary hs-tab-active:text-white text-defaulttextcolor py-[0.35rem] px-4 text-sm flex-grow font-medium text-center  rounded-md hover:text-primary " id="sell-crypto" data-hs-tab="#sell-crypto2" >
                                            Sell
                                        </Link>
                                    </nav>
                        ...
                        <div className="box-body !p-0">
                            <ul className="border-0">
                                <li className="py-[0.8rem] px-[1.25rem] border-b dark:border-defaultborder/10">
                                    <Link href="#!" scroll={false} className=" flex-column items-start">
                                ...
                                <li className="py-[0.8rem] px-[1.25rem]">
                                    <Link href="#!" scroll={false} className=" flex-column items-start border-0">
                                        <div className="flex w-full justify-between items-center">
                                            ...
                                            <tr className="border border-inherit border-solid hover:bg-gray-100 dark:border-defaultborder/10 dark:hover:bg-light">
                                                ...
                                                <td>
                                                    <div id="bitcoin-price-graph">
                                                        <ReactApexChart options={Cryptodata.Cryptobitcoin.options} series={Cryptodata.Cryptobitcoin.series} type="line" height={20} width={120} />
                                                    </div>
                                                </td>
                                                <td>
                                                    14,674,311,168
                                            ...
                                            <tr className="border border-inherit border-solid hover:bg-gray-100 dark:border-defaultborder/10 dark:hover:bg-light">
                                                ...
                                                <td>
                                                    <div id="etherium-price-graph">
                                                        <ReactApexChart options={Cryptodata.Cryptoetherium.options} series={Cryptodata.Cryptoetherium.series} type="line" height={20} width={120} />
                                                    </div>
                                                </td>
                                                <td>
                                                    $4,758,554,801
                                            ...
                                            <tr className="border border-inherit border-solid hover:bg-gray-100 dark:border-defaultborder/10 dark:hover:bg-light">
                                                ...
                                                <td>
                                                    <div id="dash-price-graph">
                                                        <ReactApexChart options={Cryptodata.Cryptodash1.options} series={Cryptodata.Cryptodash1.series} type="line" height={20} width={120} />
                                                    </div>
                                                </td>
                                                <td>
                                                    $52,626,563
                                            ...
                                            <tr className="border border-inherit border-solid hover:bg-gray-100 dark:border-defaultborder/10 dark:hover:bg-light">
                                                ...
                                                <td>
                                                    <div id="ripple-price-graph">
                                                        <ReactApexChart options={Cryptodata.Cryptoripple.options} series={Cryptodata.Cryptoripple.series} type="line" height={20} width={120} />
                                                    </div>
                                                </td>
                                                <td>
                                                    $511,598,941
                                            ...
                                            <tr className="border border-inherit border-solid hover:bg-gray-100 dark:border-defaultborder/10 dark:hover:bg-light">
                                                ...
                                                <td>
                                                    <div id="iota-price-graph">
                                                        <ReactApexChart options={Cryptodata.Cryptoiota.options} series={Cryptodata.Cryptoiota.series} type="line" height={20} width={120} />
                                                    </div>
                                                </td>
                                                <td>
                                                    $5,524,385
                                            ...
                                            <tr className="border border-inherit border-solid hover:bg-gray-100 dark:border-defaultborder/10 dark:hover:bg-light">
                                                ...
                                                <td>
                                                    <div id="neo-price-graph">
                                                        <ReactApexChart options={Cryptodata.Cryptoneo.options} series={Cryptodata.Cryptoneo.series} type="line" height={20} width={120} />
                                                    </div>
                                                </td>
                                                <td>
                                                    $12,904,320
