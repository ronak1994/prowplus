...
import * as Personaldata from "@/shared/data/dashboards/personaldata";
                                ...
                                <div className="xl:col-span-6 lg:col-span-6 md:col-span-6 col-span-12">
                                    <div className="box overflow-hidden">
                                        <div className="box-body !p-0">
                                            ...
                                            <div id="waterTrack">
                                                <ReactApexChart options={Personaldata.Watertracking.options} series={Personaldata.Watertracking.series} type="area" width={"100%"} height={115} />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div className="xl:col-span-6 lg:col-span-6 md:col-span-6 col-span-12">
                                    <div className="box overflow-hidden">
                                        <div className="box-body !p-0">
                                            ...
                                            <div id="sleepTrack">
                                                <ReactApexChart options={Personaldata.Sleeptracking.options} series={Personaldata.Sleeptracking.series} type="area" width={"100%"} height={115} />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div className="flex flex-wrap items-center">
                                        ...
                                        <div className="px-6 py-4 flex-grow border-dashed dark:border-defaultborder/10">
                                            <div className="flex items-center justify-between">
                                                ...
                                                <div className="ms-2">
                                                    <span className="avatar bg-light !text-purple"><i className="ri-twitter-x-line text-[1rem]"></i></span>
                                                </div>
                                            </div>
                                            <p className="mb-2 text-[1.5rem] font-semibold">2.1K</p>
                                            <div className="flex-between">
                                        ...
                                        <div className="box-body">
                                            <div className="flex justify-between mb-6">
                                                <div className="me-1">
                                                    ...
                                                    <Link href="#!" scroll={false} className="text-[0.75rem] text-primary opacity-[8]">Change<i className="bi bi-box-arrow-up-right text-[0.6875rem] ms-1"></i></Link>
                                                </div>
                                ...
                                <div className="xl:col-span-12 col-span-12">
                                    <div className="box">
                                        <div className="box-header justify-between">
                                            ...
                                            <Link href="#!" scroll={false} className="text-primary">View History<i className="bi bi-box-arrow-up-right text-[0.6875rem] ms-2"></i></Link>
                                        </div>
                                        <div className="box-body">
                                            <div className="avatar-list-stacked mb-6">
                                                ...
                                                <Link aria-label="anchor" className="avatar bg-light !text-defaulttextcolor avatar-rounded" href="#!" scroll={false}>
                                        ...
                                        <div className="box-body">
                                            <div className="grid grid-cols-12 md:gap-y-0 gap-y-4">
                                                <div className="xxl:col-span-2 xl:col-span-2 lg:col-span-2 md:col-span-2 col-span-4 text-center">
                                                    <Link aria-label="anchor" href="#!" scroll={false} className="ti-btn ti-btn-info !border-0 !px-6 !py-4 leading-none rounded">
                                                        <i className="bi bi-cash-coin text-[1.375rem]"></i>
                                                    </Link>
                                                    <Link href="#!" scroll={false} className="block pt-2 text-[#8c9097] dark:text-white/50 font-semibold">Bills</Link>
                                                </div>
                                                <div className="xxl:col-span-2 xl:col-span-2 lg:col-span-2 md:col-span-2 col-span-4 text-center">
                                                    <Link aria-label="anchor" href="#!" scroll={false} className="ti-btn ti-btn-primary !border-0 !px-6 !py-4 leading-none rounded">
                                                        <i className="bi bi-shop-window text-[1.375rem]"></i>
                                                    </Link>
                                                    <Link href="#!" scroll={false} className="block pt-2 text-[#8c9097] dark:text-white/50 font-semibold">Shopping</Link>
                                                </div>
                                                <div className="xxl:col-span-2 xl:col-span-2 lg:col-span-2 md:col-span-2 col-span-4 text-center">
                                                    <Link aria-label="anchor" href="#!" scroll={false} className="ti-btn ti-btn-warning !border-0 !px-6 !py-4 leading-none rounded">
                                                        <i className="bi bi-compass text-[1.375rem]"></i>
                                                    </Link>
                                                    <Link href="#!" scroll={false} className="block pt-2 text-[#8c9097] dark:text-white/50 font-semibold">Travel</Link>
                                                </div>
                                                <div className="xxl:col-span-2 xl:col-span-2 lg:col-span-2 md:col-span-2 col-span-4 text-center">
                                                    <Link aria-label="anchor" href="#!" scroll={false} className="ti-btn ti-btn-secondary !border-0 !px-6 !py-4 leading-none rounded">
                                                        <i className="bi bi-gift text-[1.375rem]"></i>
                                                    </Link>
                                                    <Link href="#!" scroll={false} className="block pt-2 text-[#8c9097] dark:text-white/50 font-semibold">Food</Link>
                                                </div>
                                                <div className="xxl:col-span-2 xl:col-span-2 lg:col-span-2 md:col-span-2 col-span-4 text-center">
                                                    <Link aria-label="anchor" href="#!" scroll={false} className="ti-btn ti-btn-danger !border-0 !px-6 !py-4 leading-none rounded">
                                                        <i className="bi bi-currency-bitcoin text-[1.375rem]"></i>
                                                    </Link>
                                                    <Link href="#!" scroll={false} className="block pt-2 text-[#8c9097] dark:text-white/50 font-semibold">Stocks</Link>
                                                </div>
                                                <div className="xxl:col-span-2 xl:col-span-2 lg:col-span-2 md:col-span-2 col-span-4 text-center">
                                                    <Link aria-label="anchor" href="#!" scroll={false} className="ti-btn ti-btn-light !border-0 !px-6 !py-4 leading-none rounded">
                                                        <i className="bi bi-three-dots text-[1.375rem]"></i>
                                                    </Link>
                                                    <Link href="#!" scroll={false} className="block pt-2 text-[#8c9097] dark:text-white/50 font-semibold">Others</Link>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="box-body">
                                    <div className="flex items-start justify-between mb-6">
                                        <div>
                                            ...
                                            <span className="block text-[0.75rem] text-[#8c9097] dark:text-white/50">67% Completed - <Link href="#!" scroll={false} className="text-center text-primary">Click Here<i className="bi bi-box-arrow-up-right text-[0.625rem] ms-2 align-middle"></i></Link></span>
                                        </div>
                                        <div>
                                    ...
                                    <div className=" text-center">
                                        <Link href="/pages/profile/" className="ti-btn ti-btn-primary !me-[0.65rem] !font-medium !py-1 !px-2 !text-[0.75rem]">
                                            Edit Profile
                                        </Link>
                                        <Link href="/pages/profile/" className="ti-btn bg-primary text-white !py-1 !px-2 !text-[0.75rem]">
                                            View Profile
                                        </Link>
                                    </div>
                                </div>
                                    ...
                                    <ul className="list-none personal-favourite-contacts mb-0">
                                        <li>
                                            <div className="flex items-center">
                                                ...
                                                <div>
                                                    <Link aria-label="anchor" href="#!" scroll={false} className="text-danger me-3"><i className="bi bi-heart-fill"></i></Link>
                                                    <div className="hs-dropdown ti-dropdown">
                                                        <Link aria-label="anchor" href="#!" scroll={false}
