              ...
              <div className="box">
                  <div className="box-body !p-[3rem]">
                      ...
                      <div className="grid grid-cols-12 gap-y-4">
                          <div className="xl:col-span-12 col-span-12 mb-2">
                              ...
                              <div className="input-group">
                                  <input type={(passwordshow1) ? 'text' : "password"} className="form-control form-control-lg !border-s !rounded-s-md" id="lockscreen-password" placeholder="password"/>
                      ...
                      <div className="text-center">
                          <p className="text-[.75rem] text-[#8c9097] dark:text-white/50 mt-4 mb-0">Try unlock with different methods <Link className="text-success" href="#!" scroll={false}><u>Finger print</u></Link> / <Link className="text-success" href="#!" scroll={false}><u>Face Id</u></Link></p>
                      </div>
                  </div>
              </div>
            </div>
