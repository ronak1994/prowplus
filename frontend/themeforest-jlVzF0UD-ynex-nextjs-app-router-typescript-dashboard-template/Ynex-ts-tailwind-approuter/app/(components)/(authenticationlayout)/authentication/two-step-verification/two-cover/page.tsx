                    ...
                    <div className="xl:col-span-12 col-span-12">
                        ...
                        <div className="form-check mt-2 mb-0 !ps-0">
                            ...
                            <label className="form-check-label" htmlFor="defaultCheck1">
                                Did not recieve a code ?<Link href="/pages/email/mail-app/" className="text-primary ms-2 inline-block">Resend</Link>
                            </label>
                        </div>
                    </div>
                    <div className="xl:col-span-12 col-span-12 grid">
                        <Link href="/dashboards/crm/" className="ti-btn ti-btn-lg bg-primary text-white !font-medium dark:border-defaultborder/10">Verify</Link>
                    </div>
                </div>
