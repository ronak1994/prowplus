          ...
          <div className="flex justify-center items-center h-full">
            <div className="p-[3rem]">
                ...
                <div className="btn-list">
                    ...
                    <button aria-label="button" type="button" className="ti-btn ti-btn-icon ti-btn-light"><i className="ri-twitter-x-line"></i></button>
                </div>
                ...
                <div className="grid grid-cols-12 gap-y-4">
                    ...
                    <div className="xl:col-span-12 col-span-12">
                        ...
                        <div className="input-group">
                            <input type={(passwordshow1) ? 'text' : "password"} className="form-control  !border-s form-control-lg !rounded-e-none" id="signup-password" placeholder="password"/>
                    ...
                    <div className="xl:col-span-12 col-span-12">
                        ...
                        <div className="input-group">
                            <input type={(passwordshow2) ? 'text' : "password"} className="form-control  !border-s form-control-lg !rounded-e-none" id="signup-confirmpassword" placeholder="confirm password"/>
                        ...
                        <div className="form-check mt-4 flex !ps-0 ">
                            ...
                            <label className="form-check-label text-[#8c9097] dark:text-white/50 font-normal " htmlFor="defaultCheck1">
                                By creating a account you agree to our <Link href="/pages/terms&conditions/" className="text-success"><u className='mx-1'>&nbsp;Terms &amp; Conditions</u></Link>&nbsp; and&nbsp; <Link href="#!" scroll={false} className="text-success"><u className='mx-1'>Privacy Policy</u></Link>
                            </label>
                        </div>
                    </div>
                ...
                <div className="text-center">
                    <p className="text-[0.75rem] text-[#8c9097] dark:text-white/50 mt-4">Already have an account? <Link href="/authentication/sign-in/signin-cover/" className="text-primary">Sign In</Link></p>
                </div>
            </div>
          </div>
      </div>
