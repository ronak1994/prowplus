                        ...
                        <div className="box-body !p-[3rem]">
                                ...
                                <div className="xl:col-span-12 col-span-12 mb-2">
                                    ...
                                    <div className="mt-4">
                                        <div className="form-check !flex !ps-0">
                                            <input className="form-check-input me-1" type="checkbox" defaultValue="" id="defaultCheck1"/>
                                            <label className="ps-2 form-check-label text-[#8c9097] dark:text-white/50 font-normal block text-break text-wrap" htmlFor="defaultCheck1">
                                                By creating a account you agree to our <Link href="/pages/terms&conditions/"
                            ...
                            <div className="text-center">
                                <p className="text-[0.75rem] text-[#8c9097] dark:text-white/50 mt-4">Already have an account? <Link
                                        href="/authentication/sign-in/signin-basic/" className="text-primary">Sign In</Link></p>
                            </div>
