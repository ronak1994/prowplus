                ...
                <div className='xxl:col-span-6 xl:col-span-6 lg:col-span-6 md:col-span-6 sm:col-span-8 col-span-12'>
                    <div className="p-[3rem]">
                        ...
                        <div className="btn-list">
                            ...
                            <button type="button" aria-label="button" className="ti-btn ti-btn-icon ti-btn-light"><i className="ri-twitter-x-line"></i></button>
                        </div>
                        ...
                        <div className="grid grid-cols-12 gap-y-4">
                            ...
                            <div className="xl:col-span-12 col-span-12 grid">
                                <Link href="/authentication/sign-in/signin-cover/" className="ti-btn ti-btn-lg bg-primary text-white !font-medium dark:border-defaultborder/10">Create</Link>
                            </div>
                        </div>
