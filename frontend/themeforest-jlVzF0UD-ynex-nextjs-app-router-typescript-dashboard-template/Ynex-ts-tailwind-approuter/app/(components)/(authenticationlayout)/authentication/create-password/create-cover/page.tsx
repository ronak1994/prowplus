              ...
              <div className="xxl:col-span-6 xl:col-span-6 lg:col-span-6 md:col-span-6 sm:col-span-8 col-span-12">
                <div className="p-[3rem]">
                  ...
                  <div className="btn-list">
                    ...
                    <button aria-label="button" type="button" className="ti-btn ti-btn-icon ti-btn-info"><i className="ri-twitter-x-line"></i></button>
                  </div>
                  ...
                  <div className="text-center">
                    <p className="text-[0.75rem] text-[#8c9097] dark:text-white/50 mt-4">Back to home ? <Link href="/dashboards/crm/"
