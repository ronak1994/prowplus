                    ...
                    <div className="box-body !p-[3rem]">
                        ...
                        <div className="grid grid-cols-12 gap-y-4">
                            ...
                            <div className="xl:col-span-12 col-span-12 mb-2">
                                <label htmlFor="signin-password" className="form-label text-default block">Password<Link href="/authentication/reset-password/reset-basic/" className="ltr:float-right rtl:float-left text-danger">Forget password ?</Link></label>
                                <div className="input-group">
                                    <input type={(passwordshow1) ? 'text' : "password"} className="form-control form-control-lg !border-s !rounded-s-md" id="signin-password" placeholder="password"/>
                            ...
                            <div className="xl:col-span-12 col-span-12 grid mt-2">
                                <Link href="/dashboards/crm/" className="ti-btn ti-btn-primary !bg-primary !text-white !font-medium">Sign In</Link>
                            </div>
                        </div>
                        <div className="text-center">
                            <p className="text-[0.75rem] text-[#8c9097] dark:text-white/50 mt-4">Dont have an account? <Link href="/authentication/sign-up/signup-basic/" className="text-primary">Sign Up</Link></p>
                        </div>
