      ...
      <div className="ti-modal-content !border !border-defaultborder dark:!border-defaultborder/10 !rounded-[0.5rem]">
        <div className="ti-modal-body">
          ...
          <div className="mt-5">
            ...
            {allData.map((idx) => (
            <span  key={Math.random()}  className="search-tags text-[0.75rem] !py-[0rem] !px-[0.55rem] dark:border-defaultborder/10 me-2" ><i className={`fe fe-${idx.icon} me-2`}></i>{idx.class}<a
