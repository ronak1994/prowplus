...
export const Basicscatter : spark3= {
    series: [{
        name: "SAMPLE A",
        data: [
...
export const Datetimescatter : spark3= {
    series: [{
        name: 'TEAM 1',
...
export const Imagefillescatter : spark3= {
    series: [{
        name: 'Messenger',
        data: [
            [16.4, 5.4],
    ...
    options: {
        ...
        fill: {
            ...
            opacity: 1,
            image: {
                src: ["../../../assets/images/faces/1.jpg", "../../../assets/images/faces/1.jpg"],
                width: 40,
                height: 40
            }
        },
