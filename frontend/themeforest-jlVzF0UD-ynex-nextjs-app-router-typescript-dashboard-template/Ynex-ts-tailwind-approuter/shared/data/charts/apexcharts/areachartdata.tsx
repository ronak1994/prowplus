...
export class Githubdata extends Component<{}, spark3> {
    ...
    render() {
        return (
            <div id="wrapper">
                <div id="chart-months">
                    <ReactApexChart options={this.state.options} series={this.state.series} type="area" width={"100%"} height={130} />
                </div>
                ...
                <div>
                    <ReactApexChart options={this.state.optionsYears} series={this.state.seriesYears} type="area" width={"100%"} height={140} />
                </div>
            </div>
...
//Stacked
const generateDayWiseTimeSeries = function (baseval: number, count: number, yrange:any) {
    let i = 0;
    const series = [];
    while (i < count) {
        const x = baseval;
            ...
            <div id="chart">
                ...
                <div>
                    <div id="area-datetime">
                        <ReactApexChart options={this.state.options} series={this.state.series} type="area" width={"100%"} height={320} />
                    </div>
                </div>
            </div>
        );
