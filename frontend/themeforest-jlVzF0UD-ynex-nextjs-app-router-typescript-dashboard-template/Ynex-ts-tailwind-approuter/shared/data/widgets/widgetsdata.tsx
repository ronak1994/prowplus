...
export const Applicants: spark3= {
  series: [{
    name: 'Job Applied',
    type: 'line',
...
export const Targetreport: spark3= {
  series: [{
  ...
  export function MapData({ setTooltipContent }:any) {
    ...
    const handleZoomIn = () => {
      ...
      setPosition((pos: { zoom: number; }) => ({ ...pos, zoom: pos.zoom * 2 }));
    };
    ...
    const handleMoveEnd = (position: SetStateAction<{ coordinates: number[]; zoom: number; }>) => {
    ...
    return (
      ...
      <div>
        <div className="controls">
            ...
            <button className='me-2' onClick={handleZoomOut}>
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="3">
                <line x1="5" y1="12" x2="19" y2="12" />
              </svg>
            </button>
        </div>
        <ComposableMap className='!w-full !h-[229px]' data-tip="" projectionConfig={{ scale: 200 }}>
