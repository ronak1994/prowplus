...
export const Europemap = () => {
    const roundedTransform = (x: number, y: number): string=> {
        return `translate(${Math.round(x)}, ${Math.round(y)})`;
    };

    const [subjectX, subjectY] = [2.3522, 48.8566]; // Example subject coordinates
        ...
        <>
            ...
            >
                ...
                <Annotation
                    ...
                    transform={roundedTransform(subjectX, subjectY)}
                >
                    <text x="-8" textAnchor="end" alignmentBaseline="middle" fill="#F53" fontSize="40">
                        {"Paris"}
                    </text>
                </Annotation>
            </ComposableMap>
