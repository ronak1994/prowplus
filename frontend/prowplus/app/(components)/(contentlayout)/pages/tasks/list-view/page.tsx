    ...
    useEffect(() => {
        if (typeof window !== "undefined") {
            ...
            import('preline').then((module) => {
                if (module.HSOverlay) {
                    const taskModal = document.querySelector('#add-task-list');
                ...
                <div className="xl:col-span-9 col-span-12">
                    <div className="box">
                        <div className="box-header justify-between">
                            ...
                            <div className="flex">
                                <Link href="#!" scroll={false} className="hs-dropdown-toggle ti-btn ti-btn-primary me-2 ti-btn-sm" data-hs-overlay="#add-task-list">
                                    <i className="ri-add-line font-semibold align-middle"></i> Create Task
                                </Link>
                                <div id="add-task-list" className="hs-overlay hidden ti-modal">
                                    <div className="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out min-h-[calc(100%-3.5rem)] flex items-center">
                                        <div className="ti-modal-content">
                                            <div className="ti-modal-header">
                                                ...
                                                <button type="button" className="hs-dropdown-toggle ti-modal-close-btn" data-hs-overlay="#add-task-list">
                                                ...
                                                />
                                                    ...
                                                    <div className="xl:col-span-12 col-span-12">
                                                        <label className="form-label">Assigned To</label>
                                                          <Select isMulti id="choices-multiple-remove-button1" name="choices-multiple-remove-button1" options={Selectdata} className=""
                                                    menuPlacement='auto' classNamePrefix="Select2" placeholder=""
                                                />
                                                    </div>
                                                </div>
                                            ...
                                            <div className="ti-modal-footer">
                                                <button type="button" className="hs-dropdown-toggle ti-btn ti-btn-light" data-hs-overlay="#add-task-list">
                                                    Cancel
                                                </button>
                                ...
                                <div className="hs-dropdown ti-dropdown ms-2">
                                    ...
                                    <ul className="hs-dropdown-menu ti-dropdown-menu hidden">
                                        <li><Link className="ti-dropdown-item !py-2 !px-[0.9375rem] !text-[0.8125rem] !font-medium block" href="#!" scroll={false}>New Tasks</Link></li>
                                        <li><Link className="ti-dropdown-item !py-2 !px-[0.9375rem] !text-[0.8125rem] !font-medium block" href="#!" scroll={false}>Pending Tasks</Link></li>
                                        <li><Link className="ti-dropdown-item !py-2 !px-[0.9375rem] !text-[0.8125rem] !font-medium block" href="#!" scroll={false}>Completed Tasks</Link></li>
                                        <li><Link className="ti-dropdown-item !py-2 !px-[0.9375rem] !text-[0.8125rem] !font-medium block" href="#!" scroll={false}>Inprogress Tasks</Link></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="table-responsive">
                                <table className="table whitespace-nowrap table-bordered min-w-full">
                                    <thead>
                                        <tr>
                                            <th scope="col">
                                                <input className="form-check-input check-all" type="checkbox" id="all-tasks" defaultValue="" aria-label="..."/>
                                            </th>
                                    ...
                                    <tbody>
                                        <tr className="border border-defaultborder task-list">
                                            <td className="task-checkbox"><input className="form-check-input" type="checkbox" defaultValue="" aria-label="..." /></td>
                                            <td>
                                            ...
                                            <td>
                                                <div className="avatar-list-stacked">
                                                    ...
                                                    <Link className="avatar avatar-sm bg-primary avatar-rounded text-white" href="#!" scroll={false}>
                                                        +2
                                                    </Link>
                                                </div>
                                            </td>
                                            <td>
                                                <div className="hs-tooltip ti-main-tooltip">
                                                    <button type="button" className="hs-tooltip-toggle ti-btn ti-btn-primary me-2 ti-btn-sm">
                                        ...
                                        <tr className="border border-defaultborder task-list">
                                            <td className="task-checkbox"><input className="form-check-input" type="checkbox" defaultValue="" aria-label="..." defaultChecked /></td>
                                            <td>
                                        ...
                                        <tr className="border border-defaultborder task-list">
                                            ...
                                            <td>
                                                <div className="hs-tooltip ti-main-tooltip">
                                                    <button type="button" className="hs-tooltip-toggle ti-btn me-2 ti-btn-primary me-2 ti-btn-sm">
                                                        <i className="ri-edit-line"></i>
                                                        <span
                                                            className="hs-tooltip-content  ti-main-tooltip-content py-1 px-2 !bg-black !text-xs !font-medium !text-white shadow-sm "
                                                            role="tooltip">
                        ...
                        <div className="box-footer">
                            <nav aria-label="Page navigation">
                                <ul className="ti-pagination justify-end mb-0">
                                    <li className="page-item disabled"><Link className="page-link px-3 py-[0.375rem]" href="#!" scroll={false}>Prev</Link></li>
                        ...
                        <div className="box-body !p-0">
                            ...
                            <div className="p-6 pb-2">
                                ...
                                <div id="task-list-stats">
                                    <ReactApexChart
                                        options={taskStatistics.options}
                                        series={taskStatistics.series}
                                        type="bar"
                                        width={"100%"}
                                        height={210}
                                    />
