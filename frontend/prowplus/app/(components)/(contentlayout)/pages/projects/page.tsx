                        ...
                        <div className="box-body p-4">
                            <div className="flex items-center justify-between flex-wrap gap-4">
                                <div className="flex flex-wrap gap-1 newproject">
                                    <Link href="/pages/projects/create-project/" className="ti-btn ti-btn-primary-full me-2 !mb-0"><i className="ri-add-line me-1 font-semibold align-middle"></i>New Project</Link>
            ...
            <div className="grid grid-cols-12 gap-x-6">
                    ...
                    <div className="box custom-box">
                        <div className="box-header items-center !justify-start flex-wrap !flex">
                            ...
                            <div className="flex-grow">
                                <Link href="/pages/projects/project-overview" scroll={false} className="font-semibold text-[.875rem] block text-truncate project-list-title">Design &amp; Developing New Project</Link>
                            ...
                            <div className="hs-dropdown ti-dropdown">
                                <Link aria-label="anchor" href="#!" scroll={false} className="ti-btn ti-btn-sm ti-btn-light !mb-0" aria-expanded="false">
                                    <i className="fe fe-more-vertical"></i>
                                </Link>
                                <ul className="hs-dropdown-menu ti-dropdown-menu hidden">
                                    <li><Link className="ti-dropdown-item" href="#!" scroll={false}><i className="ri-eye-line align-middle me-1 inline-flex"></i>View</Link></li>
                                    <li><Link className="ti-dropdown-item" href="#!" scroll={false}><i className="ri-edit-line align-middle me-1 inline-flex"></i>Edit</Link></li>
                                    <li><Link className="ti-dropdown-item" href="#!" scroll={false}><i className="ri-delete-bin-line me-1 align-middle inline-flex"></i>Delete</Link></li>
                                </ul>
                            </div>
                        </div>
                ...
                <div className="xxl:col-span-3 xl:col-span-4 md:col-span-6 col-span-12">
                    <div className="box custom-box">
                        <div className="box-header items-center !justify-start flex-wrap !flex">
                            ...
                            <div className="flex-grow">
                                <Link href="#!" scroll={false} className="font-semibold text-[.875rem] block !truncate project-list-title">Content Management System (CMS) Integration</Link>
                ...
                <div className="xxl:col-span-3 xl:col-span-4 md:col-span-6 col-span-12">
                    <div className="box custom-box">
                        <div className="box-header items-center !justify-start flex-wrap !flex">
                            ...
                            <div className="flex-grow">
                                <Link href="#!" scroll={false} className="font-semibold text-[.875rem] block text-truncate project-list-title">Task Scheduler and Automation</Link>
                ...
                <div className="xxl:col-span-3 xl:col-span-4 md:col-span-6 col-span-12">
                    <div className="box custom-box">
                        <div className="box-header items-center !justify-start flex-wrap !flex">
                            ...
                            <div className="flex-grow">
                                <Link href="#!" scroll={false} className="font-semibold text-[.875rem] block text-truncate project-list-title">Advanced Search and Filtering</Link>
                ...
                <div className="xxl:col-span-3 xl:col-span-4 md:col-span-6 col-span-12">
                    <div className="box custom-box">
                        <div className="box-header items-center !justify-start flex-wrap !flex">
                            ...
                            <div className="flex-grow">
                                <Link href="#!" scroll={false} className="font-semibold text-[.875rem] block text-truncate project-list-title">Data Export and Reporting</Link>
                ...
                <div className="xxl:col-span-3 xl:col-span-4 md:col-span-6 col-span-12">
                    <div className="box custom-box">
                        <div className="box-header items-center !justify-start flex-wrap !flex">
                            ...
                            <div className="flex-grow">
                                <Link href="#!" scroll={false} className="font-semibold text-[.875rem] block text-truncate project-list-title">Activity Log and Audit Trail</Link>
                ...
                <div className="xxl:col-span-3 xl:col-span-4 md:col-span-6 col-span-12">
                    <div className="box custom-box">
                        <div className="box-header items-center !justify-start flex-wrap !flex">
                            ...
                            <div className="flex-grow">
                                <Link href="#!" scroll={false} className="font-semibold text-[.875rem] block text-truncate project-list-title">Role-Based Access Control (RBAC) Implementation</Link>
                ...
                <div className="xxl:col-span-3 xl:col-span-4 md:col-span-6 col-span-12">
                    <div className="box custom-box">
                        <div className="box-header items-center !justify-start flex-wrap !flex">
                            <div className="me-2">
                                <span className="avatar avatar-rounded p-1 bg-tealmain/10">
                                    <img src="../../../assets/images/company-logos/6.png" alt="" />
                                </span>
                            </div>
                            <div className="flex-grow">
                                <Link href="#!" scroll={false} className="font-semibold text-[.875rem] block text-truncate project-list-title">Customizable Themes and Layouts</Link>
