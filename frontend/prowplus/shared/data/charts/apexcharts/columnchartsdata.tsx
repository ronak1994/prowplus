...
export const Basicolumn : spark3= {
    series: [{
        name: 'Net Profit',
...
export const Columnwithlabels : spark3= {
    series: [{
        name: 'Inflation',
...
export const Stackedcolumn :spark3= {
    series: [{
        name: 'PRODUCT A',
...
export const Stacked100column :spark3= {
    series: [{
        name: 'PRODUCT A',
...
export const Negativecolumn :spark3= {
    series: [{
        name: 'Cash Flow',
...
export const Rangecolumn :spark3= {
    series: [{
        data: [{
            x: 'Team A',
            y: [1, 5]
...
const chart: ApexCharts | null = null;
export class Loaded extends Component<{}, spark3> {
        ...
        return (
            <div id="wrap">
                ...
                <div id="chart-quarter">
                    <ReactApexChart options={this.state.optionsQuarter} series={this.state.seriesQuarter} type="bar" width={"100%"} height={320} />
                </div>
            </div>
...
export const Distributed : spark3 = {
    series: [{
