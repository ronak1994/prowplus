...
export const Linechartwithlabels : spark3={
    series: [
        {
            name: "High - 2013",
...
export const Zoomabletime :spark3= {
...
export const Annotations : spark3= {
            series: [{
...
export class Brushchart extends Component<{}, spark3> {
    ...
    render() {
        return (
            <div id="wrapper">
                <div id="brush-chart1">
                    <ReactApexChart options={this.state.options} series={this.state.series} type="line" width={"100%"} height={230} />
                </div>
                <div id="brush-chart">
                    <ReactApexChart options={this.state.optionsLine} series={this.state.seriesLine} type="area" width={"100%"} height={130} />
                </div>
            </div>
...
export const Gradientline : spark3= {
    series: [{
        name: 'Sales',
...
export const Missingnullvalues : spark3= {
    series: [{
        name: 'Peter',
