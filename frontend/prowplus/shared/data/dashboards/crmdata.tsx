...
export const Revenueanalytics: spark3={
    series: [
        {
            type: 'line',
            name: 'Profit',
...
export const Sourcedata: spark3= {
    series: [32, 27, 25, 16],
    options: {
