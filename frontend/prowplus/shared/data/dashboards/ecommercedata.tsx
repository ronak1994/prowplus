...
export const Earning: spark3= {
  ...
  export const Recentorders = [
    { id: 1, src:"../../assets/images/ecommerce/jpg/1.jpg", product: 'Smart Phone', price: '199.99', text: 'Mobiles', class: 'mb-4' },
    { id: 2, src:"../../assets/images/ecommerce/jpg/2.jpg", product: 'White Headphones', price: '79.49', text: 'Music', class: 'mb-4' },
    { id: 3, src:"../../assets/images/ecommerce/jpg/3.jpg", product: 'Stop Watch', price: '49.29', text: 'Electronics', class: 'mb-4' },
    { id: 4, src:"../../assets/images/ecommerce/jpg/4.jpg", product: 'Kikon Camera', price: '1,699.00', text: 'Electronics', class: 'mb-4' },
    { id: 5, src:"../../assets/images/ecommerce/jpg/5.jpg", product: 'Photo Frame', price: '29.99', text: 'Furniture', class: 'mb-4' },
