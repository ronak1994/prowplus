        ...
        <div>
            ...
            <nav className="btn-group steps basicsteps">
                {steps.map((step: any, index: any) => (
                    <Button key={Math.random()} onClick={() => props.onChange(index)} className={getClsNavBtn(index === currentIndex)}  disabled={index === currentIndex}> 
                        {step.props.title}
                    </Button>
                ))}
            </nav>
            ...
            <div className=" p-3 flex justify-between border-t border-dashed border-defaultborder dark:border-defaultborder/10">
                <Button
                     ...
                     disabled={currentIndex === 0} // Disable back button in the first step
                >
                    Back
                </Button>
                <Button
                     ...
                     disabled={currentIndex === steps.length - 1} // Disable next button in the last step
                >
                    Next
                </Button>
            </div>
...
function Button({ visible, disabled, ...props }: any) {
    return (

        <button
        className={visible ? `ti-btn ti-btn-primary-full text-white` : "invisible"}
            {...props}
        />
    ...
    render() {
        ...
        return (
            <Wizard step={this.state.step} onChange={this.handleStep}>
                <Step title={<><i className="ri-truck-line basicstep-icon"></i> Shipping</>}>
                    <div className="p-6">
                        ...
                        <div className="text-[0.9375rem] font-semibold sm:flex block items-center justify-between mb-4">
                            ...
                            <div className="sm:mt-0 mt-2">
                                <Link href="#!" scroll={false} className="ti-btn bg-primary text-white !py-1 !px-2 !text-[0.75rem]" data-hs-overlay="#modal-new-address"><i className="ri-add-line  align-middle text-[0.875rem] font-semibold inline-block"></i>Add New Address
                                </Link>
                ...
                <Step title={<><i className="ri-user-3-line basicstep-icon"></i> PersonalDetails </>}>
                <div className="p-4">
                ...
                <Step title={<><i className="ri-bank-card-line basicstep-icon"></i> Payment  </>}>
                ...
                <Step title={<><i className="ri-checkbox-circle-line basicstep-icon"></i> Confirmation  </>}>
                <div className="p-[3rem] checkout-payment-success my-3">
                                            ...
                                            <div className="mb-6">
                                                <p className="mb-1 text-[0.875rem]">You can track your order with Order Id <b>SPK#1FR</b> from <Link className="link-success" href="#!" scroll={false}><u className="text-success">Track Order</u></Link></p>
                                                <p className="text-[#8c9097] dark:text-white/50">Thankyou for shopping with us.</p>
                                            </div>
                                            <Link href="/pages/ecommerce/products/" className="ti-btn bg-success text-white !font-medium">Continue Shopping<i className="bi bi-cart ms-2"></i></Link>
                                        </div>
                </Step>
            </Wizard>
        );
